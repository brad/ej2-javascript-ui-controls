...
@function rgbaChangeChange($hex, $alpha: 1) {
  $r: str-slice($hex, 1, 2);
  $g: str-slice($hex, 3, 4);
  $b: str-slice($hex, 5, 6);
...
$surface1: linear-gradient(0deg, rgbaChange($primary, $opacity5), rgbaChange($primary, $opacity5)), rgbaChange($surface) !default;
$surface2: linear-gradient(0deg, rgbaChange($primary, $opacity8), rgbaChange($primary, $opacity8)), rgbaChange($surface) !default;
$surface3: linear-gradient(0deg, rgbaChange($primary, $opacity11), rgbaChange($primary, $opacity11)), rgbaChange($surface) !default;
$surface4: linear-gradient(0deg, rgbaChange($primary, $opacity12), rgbaChange($primary, $opacity12)), rgbaChange($surface) !default;
$surface5: linear-gradient(0deg, rgbaChange($primary, $opacity14), rgbaChange($primary, $opacity14)), rgbaChange($surface) !default;
$surface6: linear-gradient(0deg, rgbaChange($primary, $opacity16), rgbaChange($primary, $opacity16)), rgbaChange($surface) !default;

//shadow
$level1: 0 1px 3px 1px rgbaChange(0, 0, 0, .15), 0 1px 2px 0 rgbaChange(0, 0, 0, .3);
$level2: 0 2px 6px 2px rgbaChange(0, 0, 0, .15), 0 1px 2px 0 rgbaChange(0, 0, 0, .3);
$level3: 0 1px 3px 0 rgbaChange(0, 0, 0, .3), 0 4px 8px 3px rgbaChange(0, 0, 0, .15);
$level4: 0 2px 3px 0 rgbaChange(0, 0, 0, .3), 0 6px 10px 4px rgbaChange(0, 0, 0, .15);
$level5: 0 4px 4px 0 rgbaChange(0, 0, 0, .3), 0 8px 12px 6px rgbaChange(0, 0, 0, .15);
...
$content-bg-color-hover: rgbaChange($on-surface, $opacity5) !default;
$content-bg-color-pressed: rgbaChange($on-surface, $opacity8) !default;
$content-bg-color-focus: rgbaChange($on-surface, $opacity4) !default;
...
$flyout-bg-color-hover: rgbaChange($on-surface, $opacity5) !default;
$flyout-bg-color-pressed: rgbaChange($on-surface, $opacity8) !default;
$flyout-bg-color-selected: rgbaChange($primary-container, .65) !default;
$flyout-bg-color-focus: rgbaChange($on-surface, $opacity4) !default;
$overlay-bg-color: rgbaChange($scrim, .5) !default;
$table-bg-color-hover: rgbaChange($on-surface, $opacity5) !default;
$table-bg-color-pressed: rgbaChange($on-surface, $opacity8) !default;
$table-bg-color-selected: rgbaChange($primary-container, .65) !default;
...
$content-text-color-disabled: rgbaChange($on-surface, .38) !default;
...
$flyout-text-color-disabled: rgbaChange($on-surface, .38) !default;
...
$icon-color-disabled: rgbaChange($on-surface-variant, .38) !default;

// border-color
$border-light: $outline-variant !default;
$border: $outline !default;
$border-alt: $on-surface-variant !default;
$border-dark: rgbaChange($on-surface, .38) !default;
...
// shadow
$shadow: 0 .8px 16px rgbaChange($black, .15) !default;
...
$shadow-inner: inset 0 1px 2px rgbaChange($black, .075) !default;
$shadow-none: 0 0 rgbaChange($black, 0) !default;

$shadow-focus-ring1: 0 0 0 1px #000000, 0 0 0 3px #ffffff !default;
$shadow-focus-ring2: 0 0 0 1px rgbaChange($black, .95) !default;
$primary-shadow-focus: 0 0 0 4px rgbaChange($primary, .5) !default;
$secondary-shadow-focus: 0 0 0 4px rgbaChange($secondary, .5) !default;
$success-shadow-focus: 0 0 0 4px rgbaChange($success, .5) !default;
$danger-shadow-focus: 0 0 0 4px rgbaChange($danger, .5) !default;
$info-shadow-focus: 0 0 0 4px rgbaChange($info, .5) !default;
$warning-shadow-focus: 0 0 0 4px rgbaChange($warning, .5) !default;
...
$secondary-border-color: linear-gradient(0deg, rgbaChange($primary, $opacity5), rgbaChange($primary, $opacity5)) !default;
$secondary-text-color: $on-surface !default;
$secondary-bg-color-hover: linear-gradient(0deg, rgbaChange($secondary-text-color, $opacity8), rgbaChange($secondary-text-color, $opacity8)), rgbaChange($content-bg-color) !default;
$secondary-border-color-hover: linear-gradient(0deg, rgbaChange($secondary-text-color, $opacity8), rgbaChange($secondary-text-color, $opacity8)) !default;
$secondary-text-color-hover: $secondary-text-color !default;
$secondary-bg-color-pressed:linear-gradient(0deg, rgbaChange($secondary-text-color, $opacity12), rgbaChange($secondary-text-color, $opacity12)), rgbaChange($content-bg-color) !default;
$secondary-border-color-pressed: linear-gradient(0deg, rgbaChange($secondary-text-color, $opacity12), rgbaChange($secondary-text-color, $opacity12)) !default;
...
$secondary-bg-color-disabled: rgbaChange($secondary, .12) !default;
$secondary-border-color-disabled: rgbaChange($secondary, 0) !default;
$secondary-text-color-disabled: rgbaChange($on-surface, .38) !default;
...
$primary-bg-color-hover: linear-gradient(0deg, rgbaChange($primary-text, $opacity8), rgbaChange($primary-text, $opacity8)), rgbaChange($primary-bg-color) !default;
$primary-border-color-hover: $primary-bg-color-hover !default;
$primary-text-hover: $primary-text !default;
$primary-bg-color-pressed: linear-gradient(0deg, rgbaChange($primary-text, $opacity12), rgbaChange($primary-text, $opacity12)), rgbaChange($primary-bg-color) !default;
...
$primary-bg-color-disabled: rgbaChange($secondary, .12) !default;
$primary-border-color-disabled: rgbaChange($secondary, 0) !default;
$primary-text-disabled: rgbaChange($on-surface, .38) !default;
...
$success-bg-color-hover: linear-gradient(0deg, rgbaChange($success-text, $opacity8), rgbaChange($success-text, $opacity8)), rgbaChange($success-bg-color) !default;
$success-border-color-hover: $success-bg-color-hover !default;
$success-text-hover: $success-text !default;
$success-bg-color-pressed: linear-gradient(0deg, rgbaChange($success-text, $opacity12), rgbaChange($success-text, $opacity12)), rgbaChange($success-bg-color) !default;
...
$success-bg-color-disabled: rgbaChange($secondary, .12) !default;
$success-border-color-disabled: $success-bg-color-disabled !default;
$success-text-disabled: rgbaChange($on-surface, .38) !default;

// Warning-button
$warning-bg-color: $warning !default;
$warning-border-color: $warning !default;
$warning-text: $black !default;
$warning-bg-color-hover: linear-gradient(0deg, rgbaChange($warning-text, $opacity8), rgbaChange($warning-text, $opacity8)), rgbaChange($warning-bg-color) !default;
$warning-border-color-hover: $warning-bg-color-hover !default;
$warning-text-hover: $warning-text !default;
$warning-bg-color-pressed: linear-gradient(0deg, rgbaChange($warning-text, $opacity12), rgbaChange($warning-text, $opacity12)), rgbaChange($warning-bg-color) !default;
...
$warning-bg-color-disabled: rgbaChange($secondary, .12) !default;
$warning-border-color-disabled: $warning-bg-color-disabled !default;
$warning-text-disabled: rgbaChange($on-surface, .38) !default;

// danger-button
$danger-bg-color: $danger !default;
$danger-border-color: $danger !default;
$danger-text: $black !default;
$danger-bg-color-hover: linear-gradient(0deg, rgbaChange($danger-text, $opacity8), rgbaChange($danger-text, $opacity8)), rgbaChange($danger-bg-color) !default;
$danger-border-color-hover: $danger-bg-color-hover !default;
$danger-text-hover: $danger-text !default;
$danger-bg-color-pressed: linear-gradient(0deg, rgbaChange($danger-text, $opacity12), rgbaChange($danger-text, $opacity12)), rgbaChange($danger-bg-color) !default;
...
$danger-bg-color-disabled: rgbaChange($secondary, .12) !default;
$danger-border-color-disabled: $danger-bg-color-disabled !default;
$danger-text-disabled: rgbaChange($on-surface, .38) !default;

// Info-button
$info-text: $black !default;
$info-bg-color: $info !default;
$info-border-color: $info-bg-color !default;
$info-bg-color-hover: linear-gradient(0deg, rgbaChange($info-text, $opacity8), rgbaChange($info-text, $opacity8)), rgbaChange($info-bg-color) !default;
$info-border-color-hover: $info-bg-color-hover !default;
$info-text-hover: $info-text !default;
$info-bg-color-pressed: linear-gradient(0deg, rgbaChange($info-text, $opacity12), rgbaChange($info-text, $opacity12)), rgbaChange($info-bg-color) !default;
...
$info-bg-color-disabled: rgbaChange($secondary, .12) !default;
$info-border-color-disabled: $info-bg-color-disabled !default;
$info-text-disabled: rgbaChange($on-surface, .38) !default;
...
$diagram-palette-hover-background: rgbaChange($surface, .05) !default;
$diagram-palette-selection-background: rgbaChange($surface, .12) !default;
...
//Message Default
$msg-color: rgbaChange($on-surface) !default;
$msg-bg-color: $content-bg-color-alt1 !default;
$msg-border-color: linear-gradient(0deg, rgbaChange($primary, $opacity5), rgbaChange($primary, $opacity5)) !default;
$msg-color-alt1: rgbaChange($on-surface) !default;
$msg-bg-color-alt1: $transparent !default;
$msg-border-color-alt1: rgbaChange($outline) !default;
$msg-color-alt2: rgbaChange($inverse-on-surface) !default;
$msg-bg-color-alt2: rgbaChange($inverse-surface) !default;
$msg-border-color-alt2: rgbaChange($inverse-surface) !default;

$msg-icon-color: rgbaChange($on-surface-variant) !default;
$msg-icon-color-alt1: rgbaChange($on-surface-variant) !default;
$msg-icon-color-alt2: rgbaChange($inverse-on-surface) !default;

$msg-close-icon-color: rgbaChange($icon-color) !default;
$msg-close-icon-color-alt1: rgbaChange($icon-color) !default;
$msg-close-icon-color-alt2: rgbaChange($inverse-on-surface) !default;

//Message success
$msg-success-color: rgbaChange($on-success-container) !default;
$msg-success-bg-color: rgbaChange($success-container) !default;
$msg-success-border-color: rgbaChange($success-container) !default;
$msg-success-color-alt1: rgbaChange($on-success-container) !default;
$msg-success-bg-color-alt1: $transparent !default;
$msg-success-border-color-alt1: rgbaChange($success) !default;
$msg-success-color-alt2: rgbaChange($on-success) !default;
$msg-success-bg-color-alt2: rgbaChange($success) !default;
$msg-success-border-color-alt2: rgbaChange($success) !default;

$msg-success-icon-color: rgbaChange($success) !default;
$msg-success-icon-color-alt1: rgbaChange($on-success-container) !default;
$msg-success-icon-color-alt2: rgbaChange($on-success) !default;

$msg-success-close-icon-color: rgbaChange($icon-color) !default;
$msg-success-close-icon-color-alt1: rgbaChange($icon-color) !default;
$msg-success-close-icon-color-alt2: rgbaChange($on-success) !default;

//Message danger
$msg-danger-color: rgbaChange($on-error-container) !default;
$msg-danger-bg-color: rgbaChange($error-container) !default;
$msg-danger-border-color: rgbaChange($error-container) !default;
$msg-danger-color-alt1: rgbaChange($on-error-container) !default;
$msg-danger-bg-color-alt1: $transparent !default;
$msg-danger-border-color-alt1: rgbaChange($error) !default;
$msg-danger-color-alt2: rgbaChange($on-error) !default;
$msg-danger-bg-color-alt2: rgbaChange($error) !default;
$msg-danger-border-color-alt2: rgbaChange($error) !default;

$msg-danger-icon-color: rgbaChange($error) !default;
$msg-danger-icon-color-alt1: rgbaChange($on-error-container) !default;
$msg-danger-icon-color-alt2: rgbaChange($on-error) !default;

$msg-danger-close-icon-color: rgbaChange($icon-color) !default;
$msg-danger-close-icon-color-alt1: rgbaChange($icon-color) !default;
$msg-danger-close-icon-color-alt2: rgbaChange($on-error) !default;

//Message warning
$msg-warning-color: rgbaChange($on-warning-container) !default;
$msg-warning-bg-color: rgbaChange($warning-container) !default;
$msg-warning-border-color: rgbaChange($warning-container) !default;
$msg-warning-color-alt1: rgbaChange($on-warning-container) !default;
$msg-warning-bg-color-alt1: $transparent !default;
$msg-warning-border-color-alt1: rgbaChange($warning) !default;
$msg-warning-color-alt2: rgbaChange($on-warning) !default;
$msg-warning-bg-color-alt2: rgbaChange($warning) !default;
$msg-warning-border-color-alt2: rgbaChange($warning) !default;

$msg-warning-icon-color: rgbaChange($warning) !default;
$msg-warning-icon-color-alt1: rgbaChange($on-warning-container) !default;
$msg-warning-icon-color-alt2: rgbaChange($on-warning) !default;

$msg-warning-close-icon-color: rgbaChange($icon-color) !default;
$msg-warning-close-icon-color-alt1: rgbaChange($icon-color) !default;
$msg-warning-close-icon-color-alt2: rgbaChange($on-warning) !default;

//Message Info
$msg-info-color: rgbaChange($on-info-container) !default;
$msg-info-bg-color: rgbaChange($info-container) !default;
$msg-info-border-color: rgbaChange($info-container) !default;
$msg-info-color-alt1: rgbaChange($on-info-container) !default;
$msg-info-bg-color-alt1: $transparent !default;
$msg-info-border-color-alt1: rgbaChange($info) !default;
$msg-info-color-alt2: rgbaChange($on-info) !default;
$msg-info-bg-color-alt2: rgbaChange($info) !default;
$msg-info-border-color-alt2: rgbaChange($info) !default;

$msg-info-icon-color: rgbaChange($info) !default;
$msg-info-icon-color-alt1: rgbaChange($on-info-container) !default;
$msg-info-icon-color-alt2: rgbaChange($on-info) !default;

$msg-info-close-icon-color: rgbaChange($icon-color) !default;
$msg-info-close-icon-color-alt1: rgbaChange($icon-color) !default;
$msg-info-close-icon-color-alt2: rgbaChange($on-info) !default;

//Appbar
//Light
$appbar-bg-color-alt1: $content-bg-color-alt2 !default;
$appbar-color-alt1: rgbaChange($content-text-color) !default;
$appbar-border-color-alt1: linear-gradient(0deg, rgbaChange($primary, $opacity8), rgbaChange($primary, $opacity8)) !default;
$appbar-hover-bg-color-alt1: rgbaChange(0, 0, 0, .05) !default;

//Dark
$appbar-bg-color-alt2: rgbaChange($inverse-surface) !default;
$appbar-color-alt2: rgbaChange($inverse-on-surface) !default;
$appbar-border-color-alt2: rgbaChange($inverse-surface) !default;
$appbar-hover-bg-color-alt2: rgbaChange(255, 255, 255, .08) !default;

//shadow
$appbar-bottom-shadow: 0 1.6px 3.6px rgbaChange(0, 0, 0, .13), 0 .3px .9px rgbaChange(0, 0, 0, .1) !default;
$appbar-top-shadow: 0 -1.6px 3.6px rgbaChange(0, 0, 0, .13), 0 -.3px .9px rgbaChange(0, 0, 0, .1) !default;

//rating
$rating-selected-color: $primary !default;
$rating-unrated-color: $content-bg-color-alt3 !default;
$rating-selected-disabled-color: rgbaChange($on-surface, .24) !default;
$rating-unrated-disabled-color: rgbaChange($on-surface, .08) !default;
$rating-selected-hover-color: darken-color(rgbaChange($primary), 5%) !default;
$rating-unrated-hover-color: darken-color(rgbaChange($primary), 10%) !default;
$rating-pressed-color: darken-color(rgbaChange($primary), 10%) !default;

//skeleton
$skeleton-wave-color: rgbaChange(73, 69, 79, 1) !default;

//spreadsheet
$splitbtn-right-border: linear-gradient(to right, rgbaChange($content-bg-color, 1) 25%, rgbaChange($border-light, 1) 75%) 1 !default;
$splitbtn-right-border-rtl: linear-gradient(to left, rgbaChange($content-bg-color, 1) 25%, rgbaChange($border-light, 1) 75%) 1 !default;
$splitbtn-right-border-vertical: linear-gradient(to bottom, rgbaChange($content-bg-color, 1) 25%, rgbaChange($border-light, 1) 75%) 1 !default;

//gantt
$gantt-taskbar-color: linear-gradient(0deg, rgbaChange($primary, .75), rgbaChange($primary, .75)), rgbaChange($content-bg-color) !default;
