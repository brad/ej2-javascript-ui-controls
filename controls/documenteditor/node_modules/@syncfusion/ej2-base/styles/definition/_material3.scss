...
$flyout-bg-color: linear-gradient(0deg, rgbaChange($content-bg-color, 1), rgbaChange($content-bg-color, 1)), rgbaChange($content-bg-color) !default;
...
$table-bg-color-pressed: rgbaChange($primary-container, .65) !default;
...
$secondary-bg-color: linear-gradient(0deg, rgbaChange($content-bg-color, 1), rgbaChange($content-bg-color, 1)), rgbaChange($content-bg-color) !default;
$secondary-border-color: linear-gradient(0deg, rgbaChange($content-bg-color, 1), rgbaChange($content-bg-color, 1)) !default;
...
$diagram-palette-selection-background: rgbaChange($on-surface, .12) !default;
...
$msg-border-color-alt1: rgbaChange($outline-variant) !default;
