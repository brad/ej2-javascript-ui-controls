define(["require", "exports", "@syncfusion/ej2-base", "@syncfusion/ej2-buttons", "@syncfusion/ej2-inputs"], function (require, exports, ej2_base_1, ej2_buttons_1, ej2_inputs_1) {
    ...
    var HeaderFooterProperties = (function () {
        ...
        HeaderFooterProperties.prototype.initializeHeaderFooter = function () {
            ...
            this.element = ej2_base_1.createElement('div', { id: this.documentEditor.element.id + elementId, className: 'e-de-prop-pane' });
            ...
            ej2_base_1.classList(optionsLabelDiv, ['e-de-cntr-pane-padding', 'e-de-prop-separator-line'], []);
            ...
            this.firstPage = new ej2_buttons_1.CheckBox({ label: localObj.getConstant('Different First Page'), change: this.changeFirstPageOptions.bind(this), cssClass: 'e-de-prop-sub-label', enableRtl: this.isRtl });
            ...
            ej2_base_1.classList(oddOrEvenDiv, ['e-de-hdr-ftr-frst-div'], []);
            ...
            this.oddOrEven = new ej2_buttons_1.CheckBox({ label: localObj.getConstant('Different Odd And Even Pages'), change: this.changeoddOrEvenOptions.bind(this), cssClass: 'e-de-prop-sub-label', enableRtl: this.isRtl });
            ...
            this.linkToPrevious = new ej2_buttons_1.CheckBox({ label: localObj.getConstant('Link to Previous'), change: this.changeLinkToPreviousOptions.bind(this), cssClass: 'e-de-prop-sub-label', enableRtl: this.isRtl, checked: true });
            ...
            ej2_base_1.classList(positionLabelDiv, ['e-de-cntr-pane-padding', 'e-de-prop-separator-line'], []);
            var positionLabel = ej2_base_1.createElement('label', { className: 'e-de-ctnr-prop-label', styles: 'height:20px;' });
            ...
            ej2_base_1.classList(headerTopDiv, ['e-de-hdr-ftr-top-div'], []);
            var headerTopLabel = ej2_base_1.createElement('label', { className: 'e-de-prop-sub-label', styles: 'display:block' });
            ...
            var footerBottomLabel = ej2_base_1.createElement('label', { className: 'e-de-prop-sub-label', styles: 'display:block' });
