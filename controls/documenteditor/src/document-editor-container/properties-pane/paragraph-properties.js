define(["require", "exports", "@syncfusion/ej2-base", "@syncfusion/ej2-dropdowns", "@syncfusion/ej2-buttons", "@syncfusion/ej2-splitbuttons", "@syncfusion/ej2-data", "@syncfusion/ej2-base"], function (require, exports, ej2_base_1, ej2_dropdowns_1, ej2_buttons_1, ej2_splitbuttons_1, ej2_data_1, ej2_base_2) {
    ...
    var Paragraph = (function () {
        ...
        Paragraph.prototype.initializeParagraphPropertiesDiv = function (wholeDiv, isRtl) {
            ...
            ej2_base_1.classList(paragraphDiv, ['e-de-cntr-pane-padding'], []);
            ...
            var styleSelect = ej2_base_1.createElement('input', { id: element + '_style', styles: 'width:248px;letter-spacing: 0.05px;' });
            ...
            if (isRtl) {
                ej2_base_1.classList(indentWholeDiv, ['e-de-ctnr-segment-rtl'], []);
            }
            ...
            ej2_base_1.classList(listDiv, ['e-de-ctnr-segment', 'e-de-ctnr-group-btn'], []);
            ej2_base_1.classList(paraDiv, ['e-de-ctnr-segment', 'e-de-ctnr-group-btn'], []);
            if (isRtl) {
                ej2_base_1.classList(listDiv, ['e-de-ctnr-segment-rtl', 'e-de-ctnr-group-btn'], []);
                ej2_base_1.classList(paraDiv, ['e-de-ctnr-segment-rtl', 'e-de-ctnr-group-btn'], []);
            }
            var lineHeight = ej2_base_1.createElement('button', { id: element + '_lineHeight', attrs: { type: 'button' } });
            ...
            ej2_base_1.classList(listDropDown, ['de-split-button', 'e-de-ctnr-segment-list'], []);
            if (isRtl) {
                ej2_base_1.classList(listDropDown, ['e-de-ctnr-segment-list-rtl'], []);
            }
            var bulletButton = ej2_base_1.createElement('button', { id: element + '_bullet', attrs: { type: 'button' } });
            listDropDown.appendChild(bulletButton);
            var numberingList = ej2_base_1.createElement('button', { id: element + '_numberingList', attrs: { type: 'button' } });
        ...
        Paragraph.prototype.createNumberListDropButton = function (iconcss, button) {
            var _this = this;
            var div = ej2_base_1.createElement('div', { id: 'target', styles: 'width: 211px;height: auto;display:none' });
            ...
            var menuOptions = {
                ...
                beforeOpen: function () {
                    ...
                    if (!ej2_base_1.isNullOrUndefined(_this.documentEditor.selection.paragraphFormat)) {
                        if (ej2_base_1.isNullOrUndefined(_this.documentEditor.selection.paragraphFormat.listId) || _this.documentEditor.selection.paragraphFormat.listId == -1) {
                            levelPattern = 'None';
                        }
                        else {
