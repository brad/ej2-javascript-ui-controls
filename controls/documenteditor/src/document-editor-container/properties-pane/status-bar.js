define(["require", "exports", "@syncfusion/ej2-base", "@syncfusion/ej2-splitbuttons", "@syncfusion/ej2-buttons"], function (require, exports, ej2_base_1, ej2_splitbuttons_1, ej2_buttons_1) {
    ...
    var StatusBar = (function () {
        ...
        StatusBar.prototype.initializeStatusBar = function () {
            ...
            var div = ej2_base_1.createElement('div', { className: (this.container.enableSpellCheck) ? 'e-de-ctnr-pg-no' : 'e-de-ctnr-pg-no-spellout', styles: styles });
            this.statusBarDiv.appendChild(div);
            var label = ej2_base_1.createElement('span');
            ...
            var label1 = ej2_base_1.createElement('span', { styles: pageNumberOfLabelStyle });
            ...
            if (this.documentEditor.enableSpellCheck) {
                var verticalLine = ej2_base_1.createElement('div', { className: 'e-de-statusbar-separator' });
