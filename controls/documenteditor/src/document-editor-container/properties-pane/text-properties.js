define(["require", "exports", "@syncfusion/ej2-base", "@syncfusion/ej2-dropdowns", "@syncfusion/ej2-buttons", "@syncfusion/ej2-splitbuttons", "@syncfusion/ej2-inputs", "@syncfusion/ej2-data", "@syncfusion/ej2-base"], function (require, exports, ej2_base_1, ej2_dropdowns_1, ej2_buttons_1, ej2_splitbuttons_1, ej2_inputs_1, ej2_data_1, ej2_base_2) {
    ...
    var Text = (function () {
        ...
        Text.prototype.createFontColorPicker = function (id, width, divElement, toolTipText) {
            ...
            this.fontColorInputElement = new ej2_inputs_1.ColorPicker({ value: '#000000', showButtons: true, enableRtl: this.isRtl, locale: this.container.locale, enableOpacity: false }, inputElement);
        ...
        Text.prototype.changeFontFamily = function () {
            ...
            if (!this.documentEditor.isReadOnly && this.documentEditor.selection && this.fontFamily.value !== '') {
                setTimeout(function () {
                    _this.documentEditor.selection.characterFormat.fontFamily = ej2_base_2.SanitizeHtmlHelper.sanitize(_this.fontFamily.value);
                }, 10);
                this.documentEditor.focusIn();
            }
        };
        ...
        Text.prototype.onSelectionChange = function () {
            ...
            if (this.documentEditor.selection) {
                if (this.documentEditor.selection.characterFormat.fontFamily) {
                    ...
                    if (!ej2_base_1.isNullOrUndefined(this.documentEditor.selection.characterFormat.renderedFontFamily) && !ej2_base_1.isNullOrUndefined(this.documentEditor.selection.characterFormat.fontFamily)) {
