define(["require", "exports", "@syncfusion/ej2-base", "./dictionary"], function (require, exports, ej2_base_1, dictionary_1) {
    "use strict";
    ...
    var WUniqueFormat = (function () {
        function WUniqueFormat(type) {
            ...
            this.propertiesHash = new dictionary_1.Dictionary();
        }
        ...
        WUniqueFormat.prototype.isNotEqual = function (property, source, modifiedProperty, modifiedValue, uniqueFormatType) {
            ...
            if (!(targetValue === sourceValue || (!ej2_base_1.isNullOrUndefined(targetValue) && !ej2_base_1.isNullOrUndefined(sourceValue) && targetValue === sourceValue))) {
                return true;
            }
            return false;
        };
        ...
        WUniqueFormat.prototype.cloneProperties = function () {
            var hash = new dictionary_1.Dictionary();
            var keys = this.propertiesHash.keys;
            for (var i = 0; i < keys.length; i++) {
                hash.add(keys[i], this.propertiesHash.get(keys[i]));
            }
        ...
        WUniqueFormat.prototype.destroy = function () {
            if (!ej2_base_1.isNullOrUndefined(this.propertiesHash)) {
    ...
    exports.WUniqueFormat = WUniqueFormat;
});
