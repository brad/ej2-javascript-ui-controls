define(["require", "exports", "../../index", "@syncfusion/ej2-base", "@syncfusion/ej2-base"], function (require, exports, index_1, ej2_base_1, ej2_base_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var CollaborativeEditingHandler = (function () {
        ...
        CollaborativeEditingHandler.prototype.sendActionToServer = function (operations) {
            if (!ej2_base_1.isNullOrUndefined(operations) && operations.length === 0) {
                return;
            }
        ...
        CollaborativeEditingHandler.prototype.isAcknowledgePending = function () {
            return !ej2_base_1.isNullOrUndefined(this.acknowledgmentPending);
        };
        ...
        CollaborativeEditingHandler.prototype.handleRemoteOperation = function (action) {
            ...
            if (!ej2_base_1.isNullOrUndefined(this.acknowledgmentPending)) {
        ...
        CollaborativeEditingHandler.prototype.applyRemoteOperation = function (action, offset, selectionLength) {
            ...
            var currenteditorHistory = this.documentEditor.editorHistory.lastOperation;
            var currentTextArea;
            var isFieldOperation = false;
            if (!ej2_base_1.isNullOrUndefined(this.documentEditor.commentReviewPane.commentPane.currentEditingComment)) {
            ...
            for (var i = 0; i < action.operations.length; i++) {
                ...
                if (!ej2_base_1.isNullOrUndefined(markerData) && !ej2_base_1.isNullOrUndefined(markerData.author)) {
                    this.documentEditor.currentUser = markerData.author;
                }
                if (!ej2_base_1.isNullOrUndefined(markerData) && !ej2_base_1.isNullOrUndefined(markerData.isSkipTracking) && markerData.isSkipTracking && this.documentEditor.enableTrackChanges) {
                    this.documentEditor.enableTrackChanges = false;
                }
                if (action.operations[i].skipOperation || (!ej2_base_1.isNullOrUndefined(action.operations[i].markerData) && action.operations[i].markerData.skipOperation)) {
                    continue;
                }
                if (action.operations[i].action === 'Update') {
                    if (action.operations[i].text === (index_1.CONTROL_CHARACTERS.Marker_Start.toString() + index_1.CONTROL_CHARACTERS.Marker_End.toString())) {
                        ...
                        if (!ej2_base_1.isNullOrUndefined(markerData.ownerCommentId) && markerData.isReply) {
                            ...
                            if (!ej2_base_1.isNullOrUndefined(ownerComment)) {
                                commentToDelete = this.documentEditor.documentHelper.layout.getCommentById(ownerComment.replyComments, markerData.commentId);
                            }
                        }
                        var isDeleteComment = !ej2_base_1.isNullOrUndefined(commentToDelete);
                        if (!ej2_base_1.isNullOrUndefined(commentToDelete) && !(!ej2_base_1.isNullOrUndefined(markerData.done) && ej2_base_1.isNullOrUndefined(markerData.date))) {
                        ...
                        if (isDeleteComment || markerData.commentAction === "remove") {
                            if (ej2_base_1.isNullOrUndefined(commentToDelete)) {
                                continue;
                            }
                            if (!ej2_base_1.isNullOrUndefined(markerData.done) && ej2_base_1.isNullOrUndefined(markerData.date)) {
                            ...
                            if (markerData.commentAction === "remove") {
                                var commentView = this.documentEditor.commentReviewPane.commentPane.comments.get(!ej2_base_1.isNullOrUndefined(ownerComment) ? ownerComment : commentToDelete);
                            ...
                            var item = new index_1.CommentElementBox(markerData.date);
                            ...
                            if (!ej2_base_1.isNullOrUndefined(commentStart) && !ej2_base_1.isNullOrUndefined(commentEnd)) {
                            ...
                            else if (!ej2_base_1.isNullOrUndefined(commentStart) && !ej2_base_1.isNullOrUndefined(commentEnd)) {
                    ...
                    else if (!ej2_base_1.isNullOrUndefined(action.operations[i].styleData)) {
                        var styleData = JSON.parse(action.operations[i].styleData);
                        var styles = new index_1.WStyles();
                ...
                if (ej2_base_1.isNullOrUndefined(action.operations[i].action)) {
                ...
                if (op2.action === 'Insert' && (op2.text !== index_1.CONTROL_CHARACTERS.Row && op2.text !== index_1.CONTROL_CHARACTERS.Cell) && (ej2_base_1.isNullOrUndefined(op2.markerData) || ej2_base_1.isNullOrUndefined(op2.markerData.isAcceptOrReject))) {
                    this.documentEditor.selection.select(startOffset, endOffset);
                }
                else if (op2.action === 'Delete' && op2.text !== index_1.CONTROL_CHARACTERS.Cell && (ej2_base_1.isNullOrUndefined(op2.markerData) || ej2_base_1.isNullOrUndefined(op2.markerData.isAcceptOrReject))) {
                    this.documentEditor.selection.select(startOffset, endOffset);
                }
                else if (op2.action === 'Format' && (ej2_base_1.isNullOrUndefined(op2.markerData) || ej2_base_1.isNullOrUndefined(op2.markerData.isAcceptOrReject))) {
                    this.documentEditor.selection.select(startOffset, endOffset);
                }
                if (!ej2_base_1.isNullOrUndefined(op2.markerData)) {
                    this.documentEditor.editor.revisionData = [];
                    if (!ej2_base_1.isNullOrUndefined(op2.markerData.revisionForFootnoteEndnoteContent)) {
                        this.documentEditor.editor.revisionData.push(op2.markerData.revisionForFootnoteEndnoteContent);
                    }
                    if (!ej2_base_1.isNullOrUndefined(op2.markerData.revisionId)) {
                        this.documentEditor.editor.revisionData.push(op2.markerData);
                    }
                    if (!ej2_base_1.isNullOrUndefined(op2.markerData.splittedRevisions) && op2.markerData.splittedRevisions.length > 0) {
                        this.documentEditor.editor.revisionData = this.documentEditor.editor.revisionData.concat(op2.markerData.splittedRevisions);
                    }
                }
                if (!ej2_base_1.isNullOrUndefined(op2.markerData) && !ej2_base_1.isNullOrUndefined(op2.markerData.isAcceptOrReject) && op2.markerData.isAcceptOrReject !== '') {
                ...
                if (op2.action === 'Insert') {
                    if (op2.type === 'Paste') {
                        ...
                        this.documentEditor.editor.pasteContents(index_1.HelperMethods.getSfdtDocument(op2.pasteContent));
                    }
                    ...
                    else if (op2.text === index_1.CONTROL_CHARACTERS.Image.toString()) {
                        this.insertImage(op2.imageData);
                    }
                    else if (op2.text === index_1.CONTROL_CHARACTERS.Section_Break.toString() && op2.type === 'NewPage') {
                        this.documentEditor.editor.insertSectionBreak();
                    }
                    else if (op2.text === index_1.CONTROL_CHARACTERS.Section_Break.toString() && op2.type === 'Continuous') {
                        this.documentEditor.editor.insertSectionBreak(index_1.SectionBreakType.Continuous);
                    }
                    else if (markerData && (op2.text === index_1.CONTROL_CHARACTERS.Marker_Start || op2.text === index_1.CONTROL_CHARACTERS.Marker_End || op2.text === index_1.CONTROL_CHARACTERS.Field_Separator)) {
                        var element = void 0;
                        if (markerData.type && markerData.type === 'Bookmark') {
                            if (op2.text === index_1.CONTROL_CHARACTERS.Marker_Start) {
                            ...
                            var type = op2.text === index_1.CONTROL_CHARACTERS.Marker_Start ? 0 : op2.text === index_1.CONTROL_CHARACTERS.Marker_End ? 1 : op2.text === index_1.CONTROL_CHARACTERS.Field_Separator ? 2 : undefined;
                            if (!ej2_base_1.isNullOrUndefined(type) && ej2_base_1.isNullOrUndefined(markerData.checkBoxValue)) {
                                var field = new index_1.FieldElementBox(type);
                                if (type === 0 && !ej2_base_1.isNullOrUndefined(markerData.formFieldData)) {
                                ...
                                var characterFormat = new index_1.WCharacterFormat();
                        ...
                        else if (!ej2_base_1.isNullOrUndefined(markerData) && !ej2_base_1.isNullOrUndefined(markerData.commentId)) {
                            var commentType = op2.text === index_1.CONTROL_CHARACTERS.Marker_Start ? 0 : 1;
                            ...
                            if (ej2_base_1.isNullOrUndefined(deleteComment)) {
                                ...
                                if (ej2_base_1.isNullOrUndefined(deleteComment) && !ej2_base_1.isNullOrUndefined(markerData.ownerCommentId)) {
                            ...
                            if (!ej2_base_1.isNullOrUndefined(deleteComment)) {
                                var item = new index_1.CommentCharacterElementBox(commentType);
                                item.commentId = markerData.commentId;
                        ...
                        else if (!ej2_base_1.isNullOrUndefined(op2.markerData.type) && (op2.markerData.type === 'Footnote' || op2.markerData.type === 'Endnote')) {
                    ...
                    else if (markerData && !ej2_base_1.isNullOrUndefined(markerData.dropDownIndex) && op2.type === 'DropDown') {
                        var inlineObj = this.documentEditor.selection.start.currentWidget.getInline(this.documentEditor.selection.start.offset, 0);
                        var inline = inlineObj.element;
                        if (inline instanceof index_1.FieldElementBox) {
                    ...
                    else if (op2.text === index_1.CONTROL_CHARACTERS.Table) {
                        i = action.operations.length;
                        this.buildTable(action.operations);
                        tableLength = this.getOperationLength(action.operations);
                    }
                    else if (op2.text === index_1.CONTROL_CHARACTERS.Row) {
                        i = action.operations.length;
                        if (ej2_base_1.isNullOrUndefined(op2.format)) {
                            action.operations.reverse();
                        }
                        this.buildRow(action.operations);
                        tableLength = this.getOperationLength(action.operations);
                    }
                    else if (op2.text === index_1.CONTROL_CHARACTERS.Cell) {
                    ...
                    else if (op2.text === index_1.CONTROL_CHARACTERS.PageBreak.toString()) {
                        this.documentEditor.editor.insertPageBreak();
                    }
                    else if (op2.text === index_1.CONTROL_CHARACTERS.ColumnBreak.toString()) {
                    ...
                    if (op2.text === index_1.CONTROL_CHARACTERS.Marker_Start || op2.text === index_1.CONTROL_CHARACTERS.Marker_End) {
                        if (!ej2_base_1.isNullOrUndefined(markerData) && !ej2_base_1.isNullOrUndefined(markerData.commentId)) {
                            var deleteComment = this.documentEditor.documentHelper.layout.getCommentById(this.deletedComments, markerData.commentId);
                            var ownerDeleteComment = undefined;
                            if (ej2_base_1.isNullOrUndefined(deleteComment)) {
                                deleteComment = this.documentEditor.documentHelper.layout.getCommentById(this.documentEditor.documentHelper.comments, markerData.commentId);
                    ...
                    if (!ej2_base_1.isNullOrUndefined(op2.markerData) && !ej2_base_1.isNullOrUndefined(op2.markerData.revisionId)) {
                        if (!ej2_base_1.isNullOrUndefined(op2.markerData.revisionType)) {
                            if (op2.markerData.revisionType === 'Deletion') {
                                if (op2.text === index_1.CONTROL_CHARACTERS.Row) {
                                    var data_2 = this.getRelativePositionFromAbsolutePosition(op2.offset, false, true, false);
                                    if (!ej2_base_1.isNullOrUndefined(data_2.rowWidget)) {
                        ...
                        if (!ej2_base_1.isNullOrUndefined(data_3.rowWidget)) {
                    ...
                    else if (op2.text === index_1.CONTROL_CHARACTERS.Image) {
                        var inlineObj = this.documentEditor.selection.start.currentWidget.getInline(this.documentEditor.selection.start.offset, 0);
                        var inline = inlineObj.element;
                        if (inline instanceof index_1.ImageElementBox) {
                            this.documentEditor.editor.onImageFormat(inline, index_1.HelperMethods.convertPointToPixel(op2.imageData.width), index_1.HelperMethods.convertPointToPixel(op2.imageData.height), undefined);
                        }
                    }
                    else if (op2.type === 'ListFormat') {
                        var paragraphFormat = JSON.parse(op2.format);
                        var format = new index_1.WParagraphFormat(undefined);
                ...
                if (!ej2_base_1.isNullOrUndefined(tableLength)) {
                    var temp = op2.length;
                ...
                if (!ej2_base_1.isNullOrUndefined(this.documentEditor.search) && !ej2_base_1.isNullOrUndefined(this.documentEditor.optionsPaneModule) && this.documentEditor.search.searchResults.length > 0 && this.documentEditor.optionsPaneModule.isOptionsPaneShow) {
            ...
            if (!ej2_base_1.isNullOrUndefined(this.rowWidget)) {
            ...
            if (operation.listData) {
                ...
                if (!ej2_base_1.isNullOrUndefined(format)) {
                    ...
                    if (ej2_base_1.isNullOrUndefined(list)) {
                        ...
                        if (!ej2_base_1.isNullOrUndefined(list.abstractList)) {
                    ...
                    if (listData.hasOwnProperty(index_1.nsidProperty)) {
                        nsid = listData[index_1.nsidProperty];
                    }
                    this.updateListCollection(listData, this.documentEditor.parser.keywordIndex);
                }
            }
        ...
        CollaborativeEditingHandler.prototype.getOperationLength = function (operations) {
            ...
            for (var i = 0; i < operations.length; i++) {
                if (operations[parseInt(i.toString(), 10)].text === index_1.CONTROL_CHARACTERS.Table || operations[parseInt(i.toString(), 10)].text === index_1.CONTROL_CHARACTERS.Row || operations[parseInt(i.toString(), 10)].text === index_1.CONTROL_CHARACTERS.Cell)
        ...
        CollaborativeEditingHandler.prototype.updateListCollection = function (listData, keywordIndex) {
            ...
            var _loop_1 = function (k) {
                var list = listData[index_1.listsProperty[keywordIndex]][k];
                var abstractList = listData[index_1.abstractListsProperty[keywordIndex]].filter(function (obj) {
                    return obj[index_1.abstractListIdProperty[keywordIndex]] === list[index_1.abstractListIdProperty[keywordIndex]];
                })[0];
                if (!ej2_base_1.isNullOrUndefined(abstractList)) {
                    abstractList[index_1.abstractListIdProperty[keywordIndex]] = uniqueAbsLstId;
                    list[index_1.listIdProperty[keywordIndex]] = uniqueListId;
                    list[index_1.abstractListIdProperty[keywordIndex]] = uniqueAbsLstId;
                    uniqueListId++;
                    uniqueAbsLstId++;
                }
            };
            for (var k = 0; k < listData[index_1.listsProperty[keywordIndex]].length; k++) {
                _loop_1(k);
            }
        ...
        CollaborativeEditingHandler.prototype.transformOperation = function (operation1, operation2, action) {
            if (operation1.action === 'Insert' && (operation2.action === 'Insert' || operation2.action === 'Format')) {
                ...
                if (operation1.offset <= operation2.offset && (operation1.offset + operation1.length) <= operation2.offset) {
                    ...
                    if (!ej2_base_1.isNullOrUndefined(operation2.markerData) && !ej2_base_1.isNullOrUndefined(operation2.markerData.type) && operation2.markerData.type !== 'Field' && (operation2.text === index_1.CONTROL_CHARACTERS.Marker_End || operation2.text === index_1.CONTROL_CHARACTERS.Marker_Start)) {
                        if (!ej2_base_1.isNullOrUndefined(operation2.markerData.commentId) && operation2.text === index_1.CONTROL_CHARACTERS.Marker_End) {
                        ...
                        if (!ej2_base_1.isNullOrUndefined(operation2.markerData) && !ej2_base_1.isNullOrUndefined(operation2.markerData.type) && operation2.markerData.type === 'Field' && (operation2.text === index_1.CONTROL_CHARACTERS.Marker_Start || operation2.text === index_1.CONTROL_CHARACTERS.Marker_End)) {
                            this.skipAction(action);
                        }
                    }
                }
        ...
        CollaborativeEditingHandler.prototype.updateRemoteSelection = function (data, removeOffset) {
            ...
            if (data.connectionId) {
                ...
                if (this.userMap[data.connectionId] !== undefined) {
                    ...
                    caret = ej2_base_2.createElement('div', { className: 'e-de-blink-cursor', styles: ('position:absolute;border-left: 2px solid ' + color) });
        ...
        CollaborativeEditingHandler.prototype.getBlockPosition = function (offset, currentLength, block, completed, isTableInserted, isRowInserted, isCellInserted) {
            var paragraph;
            if (block instanceof index_1.ParagraphWidget) {
            ...
            else if (block instanceof index_1.TableWidget) {
                offset -= 1;
            ...
            for (var i = 0; i < splittedWidget.length; i++) {
                for (var j = 0; j < splittedWidget[i].childWidgets.length; j++) {
                    ...
                    for (var k = 0; k < line.children.length; k++) {
                        ...
                        if (element instanceof index_1.ListTextElementBox) {
                            continue;
                        }
                        if ((element instanceof index_1.ShapeElementBox && !ej2_base_1.isNullOrUndefined(element.textFrame) && element.textFrame.childWidgets.length > 0)
                            || element instanceof index_1.FootnoteElementBox) {
                            var absoluteData = void 0;
                            if (element instanceof index_1.ShapeElementBox) {
        ...
        CollaborativeEditingHandler.prototype.insertImage = function (imageData) {
            if (ej2_base_1.isNullOrUndefined(imageData.metaString)) {
                this.documentEditor.editor.insertImageInternal(imageData.imageString, true, index_1.HelperMethods.convertPointToPixel(imageData.width), index_1.HelperMethods.convertPointToPixel(imageData.height));
            }
            else {
                this.documentEditor.editor.isImageInsert = true;
                this.documentEditor.editor.insertImageInternal(imageData.metaString, true, index_1.HelperMethods.convertPointToPixel(imageData.width), index_1.HelperMethods.convertPointToPixel(imageData.height));
            }
        };
        CollaborativeEditingHandler.prototype.buildTable = function (operations) {
            ...
            var columns = 0;
            for (var i = 0; i < operations.length; i++) {
                if (operations[i].text === index_1.CONTROL_CHARACTERS.Row) {
                    if (!ej2_base_1.isNullOrUndefined(operations[i].markerData)) {
            ...
            for (var i = 0; i < operations.length; i++) {
                if (operations[i].text === index_1.CONTROL_CHARACTERS.Cell) {
                    i += 2;
                    columns++;
                }
                if (operations[i].text !== index_1.CONTROL_CHARACTERS.Table && (ej2_base_1.isNullOrUndefined(operations[i + 1]) || operations[i + 1].text === index_1.CONTROL_CHARACTERS.Row)) {
                    break;
                }
            }
        ...
        CollaborativeEditingHandler.prototype.buildRow = function (operations) {
            ...
            if (!ej2_base_1.isNullOrUndefined(operations[0].markerData)) {
                if (ej2_base_1.isNullOrUndefined(operations[0].format)) {
            ...
            for (var i = 0; i < operations.length; i++) {
                ...
                if (operation.text === index_1.CONTROL_CHARACTERS.Cell) {
                    cellCount++;
                ...
                if (ej2_base_1.isNullOrUndefined(operations[i + 1]) || operations[i + 1].text === index_1.CONTROL_CHARACTERS.Row) {
                    break;
                }
            }
            for (var i = 0; i < operations.length; i++) {
        ...
        CollaborativeEditingHandler.prototype.buildDeleteCells = function (operation) {
            var data = this.getRelativePositionFromAbsolutePosition(operation.offset, false, false, true);
            if (!ej2_base_1.isNullOrUndefined(data.cellWidget)) {
                var firstPara = this.documentEditor.selection.getFirstParagraph(data.cellWidget);
                var lastPara = this.documentEditor.selection.getLastParagraph(data.cellWidget);
                if (!ej2_base_1.isNullOrUndefined(firstPara) && !ej2_base_1.isNullOrUndefined(lastPara)) {
                    this.documentEditor.selection.start.setPosition(firstPara.firstChild, true);
                    this.documentEditor.selection.end.setPositionParagraph(lastPara.lastChild, lastPara.lastChild.getEndOffset() + 1);
                }
        ...
        CollaborativeEditingHandler.prototype.documentSettings = function (operation) {
            ...
            switch (operation.text) {
                ...
                case 'protection':
                    ...
                    if (!ej2_base_1.isNullOrUndefined(operation.protectionData.saltValue)) {
                        ...
                        if (ej2_base_1.isNullOrUndefined(operation.protectionData.hashValue)) {
        ...
        CollaborativeEditingHandler.prototype.insertParagraphFormat = function (property, paragraphData) {
            ...
            var update = false;
            if (!ej2_base_1.isNullOrUndefined(paragraphFormat.isFirstParaForList)) {
        ...
        CollaborativeEditingHandler.prototype.insertTableFormat = function (type, tableData, offset) {
            var format = new index_1.WTableFormat(undefined);
        ...
        CollaborativeEditingHandler.prototype.insertRowFormat = function (property, rowData) {
            var format = new index_1.WRowFormat(undefined);
        ...
        CollaborativeEditingHandler.prototype.insertCellFormat = function (cellData) {
            var format = new index_1.WCellFormat(undefined);
        ...
        CollaborativeEditingHandler.prototype.destory = function () {
    ...
    exports.CollaborativeEditingHandler = CollaborativeEditingHandler;
    var CaretInfo = (function () {
        ...
        CaretInfo.prototype.initializeElement = function () {
            this.hoverDiv = ej2_base_2.createElement('div', { className: 'e-de-user-info e-de-user-name-collapse', styles: 'z-index: 1; visibility: hidden;left:-4px;position:absolute;width:20px;height:20px;pointer-events:all;' });
            this.userViewContainer = ej2_base_2.createElement('div');
            this.spanViewContainer = ej2_base_2.createElement('div', { styles: 'background-color:' + this.color + ';left: 0px; top: 15px; visibility: visible;' });
            this.spanView = ej2_base_2.createElement('span', { styles: 'background-color:' + this.color + '; left: 0px;top:-4px;pointer:default' });
