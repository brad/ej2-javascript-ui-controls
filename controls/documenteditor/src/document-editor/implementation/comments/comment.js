define(["require", "exports", "@syncfusion/ej2-base", "../../implementation/viewer/page", "@syncfusion/ej2-splitbuttons", "@syncfusion/ej2-buttons", "@syncfusion/ej2-navigations", "@syncfusion/ej2-popups", "../../base/index", "../editor/editor-helper", "@syncfusion/ej2-base"], function (require, exports, ej2_base_1, page_1, ej2_splitbuttons_1, ej2_buttons_1, ej2_navigations_1, ej2_popups_1, index_1, editor_helper_1, ej2_base_2) {
    "use strict";
    ...
    var CommentReviewPane = (function () {
        function CommentReviewPane(owner) {
            ...
            this.owner = owner;
            var localObj = new ej2_base_1.L10n('documenteditor', this.owner.defaultLocale);
        ...
        Object.defineProperty(CommentReviewPane.prototype, "previousSelectedComment", {
            ...
            set: function (value) {
                if (!ej2_base_1.isNullOrUndefined(value) && value !== this.previousSelectedCommentInt) {
                    if (this.commentPane.comments.containsKey(value)) {
                        ...
                        if (commentMark) {
                            ej2_base_1.classList(commentMark, [], ['e-de-cmt-mark-selected']);
        ...
        CommentReviewPane.prototype.reviewPaneHelper = function (args) {
            var _this = this;
            if (!ej2_base_1.isNullOrUndefined(args.isUserClosed)) {
            ...
            if (!ej2_base_1.isNullOrUndefined(args.comment) || !ej2_base_1.isNullOrUndefined(args.changes)) {
        ...
        CommentReviewPane.prototype.addReviewTab = function (localValue) {
            var commentHeader = ej2_base_1.createElement('div', { innerHTML: localValue.getConstant('Comments') });
            var changesHeader = ej2_base_1.createElement('div', { innerHTML: localValue.getConstant('Changes') });
            this.parentPaneElement = ej2_base_1.createElement('div', { styles: 'height:100%;overflow:auto;display:none', className: 'e-de-review-pane' });
            this.element = ej2_base_1.createElement('div', { className: 'e-de-property-tab', id: this.owner.element.id + 'Review_Tab' });
            var items = [{ header: { text: commentHeader }, content: this.reviewPane }, { header: { text: changesHeader } }];
            this.reviewTab = new ej2_navigations_1.Tab({ items: items, selected: this.onTabSelection, animation: { previous: { effect: 'None' }, next: { effect: 'None' } } });
        ...
        CommentReviewPane.prototype.initPaneHeader = function (localValue) {
            this.headerContainer = ej2_base_1.createElement('div');
            this.reviewPane = ej2_base_1.createElement('div', { className: 'e-de-cmt-pane' });
            if (this.owner.enableRtl) {
                ej2_base_1.classList(this.reviewPane, ['e-rtl'], []);
            }
        ...
        CommentReviewPane.prototype.closePane = function () {
            if (this.commentPane && this.commentPane.isEditMode) {
                if (!ej2_base_1.isNullOrUndefined(this.commentPane.currentEditingComment)
                ...
                else if (this.isNewComment || !ej2_base_1.isNullOrUndefined(this.commentPane.currentEditingComment)
                    && this.commentPane.isInsertingReply && this.commentPane.currentEditingComment.replyViewTextBox.value !== '' ||
                    !ej2_base_1.isNullOrUndefined(this.commentPane.currentEditingComment) && !this.commentPane.isInsertingReply &&
                        this.commentPane.currentEditingComment.textArea.value !== this.commentPane.currentEditingComment.comment.text) {
                    var localObj = new ej2_base_1.L10n('documenteditor', this.owner.defaultLocale);
                    localObj.setLocale(this.owner.locale);
                    this.confirmDialog = ej2_popups_1.DialogUtility.confirm({
        ...
        CommentReviewPane.prototype.initToolbar = function (localValue) {
            this.toolbarElement = ej2_base_1.createElement('div');
        ...
        CommentReviewPane.prototype.enableDisableItems = function () {
            ...
            for (var i = 0; i < keys.length; i++) {
                ...
                if (this.owner.isReadOnly) {
                    if (!ej2_base_1.isNullOrUndefined(commentView.replyViewTextBox)) {
        ...
        CommentReviewPane.prototype.isUnreferredComment = function (comment) {
            if (ej2_base_1.isNullOrUndefined(comment.commentStart)
                || ej2_base_1.isNullOrUndefined(comment.commentEnd)) {
                return true;
            }
            return false;
        };
        ...
        CommentReviewPane.prototype.destroy = function () {
            ...
            if (!ej2_base_1.isNullOrUndefined(this.reviewTab)) {
                this.reviewTab.destroy();
            }
            this.reviewTab = undefined;
            if (!ej2_base_1.isNullOrUndefined(this.confirmDialog)) {
                this.confirmDialog.destroy();
            }
            this.confirmDialog = undefined;
            if (!ej2_base_1.isNullOrUndefined(this.previousSelectedCommentInt)) {
    ...
    exports.CommentReviewPane = CommentReviewPane;
    var CommentPane = (function () {
        function CommentPane(owner, pane) {
            ...
            this.comments = new index_1.Dictionary();
        }
            ...
            set: function (value) {
                ...
                if (this.owner) {
                    if (this.isEditModeInternal) {
                        this.owner.trigger(index_1.commentBeginEvent);
                    }
                    else {
                        this.owner.trigger(index_1.commentEndEvent);
                    }
                }
            },
            enumerable: true,
        ...
        CommentPane.prototype.initCommentPane = function () {
            this.commentPane = ej2_base_1.createElement('div', { className: 'e-de-cmt-container' });
            var localObj = new ej2_base_1.L10n('documenteditor', this.owner.defaultLocale);
            localObj.setLocale(this.owner.locale);
            this.noCommentIndicator = ej2_base_1.createElement('div', {
        ...
        CommentPane.prototype.removeSelectionMark = function (className) {
            if (this.parent) {
                ...
                for (var i = 0; i < elements.length; i++) {
                    ej2_base_1.classList(elements[i], [], [className]);
                }
            }
        };
        CommentPane.prototype.selectComment = function (comment) {
            ...
            if (comment) {
                ...
                if (selectedElement) {
                    ej2_base_1.classList(selectedElement, ['e-de-cmt-selection'], []);
                ...
                ej2_base_1.classList(commentStart.commentMark, ['e-de-cmt-mark-selected'], []);
                commentView.showDrawer();
            }
        };
        CommentPane.prototype.getCommentStart = function (comment) {
            var localValue = new ej2_base_1.L10n('documenteditor', this.owner.defaultLocale);
        ...
        CommentPane.prototype.getFirstCommentInLine = function (commentStart) {
            for (var i = 0; i < commentStart.line.children.length; i++) {
                ...
                if (startComment instanceof page_1.CommentCharacterElementBox && startComment.commentType === 0) {
                    return startComment;
                }
            }
            return commentStart;
        ...
        CommentPane.prototype.deleteComment = function (comment) {
            var commentView = this.comments.get(comment);
            if (!ej2_base_1.isNullOrUndefined(commentView)) {
                if (!ej2_base_1.isNullOrUndefined(this.currentEditingComment)
    ...
    var CommentView = (function () {
        ...
        CommentView.prototype.layoutComment = function (isReply) {
            ...
            var localObj = new ej2_base_1.L10n('documenteditor', this.owner.defaultLocale);
            localObj.setLocale(this.owner.locale);
            this.parentElement = ej2_base_1.createElement('div', { className: classList });
        ...
        CommentView.prototype.initCommentHeader = function (localObj) {
            var commentDiv = ej2_base_1.createElement('div', { className: 'e-de-cmt-view' });
            var commentUserInfo = ej2_base_1.createElement('div', { className: 'e-de-cmt-author' });
            var userName = ej2_base_1.createElement('div', { className: 'e-de-cmt-author-name' });
            userName.textContent = this.comment.author;
            if (!ej2_base_1.isNullOrUndefined(this.comment.author)) {
                commentUserInfo.style.display = 'flex';
                this.owner.documentHelper.getAvatar(commentUserInfo, userName, this.comment, undefined);
            }
            this.menuBar = ej2_base_1.createElement('button', { className: 'e-de-cp-option', attrs: { type: 'button' } });
            ...
            var menuItem = new ej2_splitbuttons_1.DropDownButton({
        ...
        CommentView.prototype.initCommentView = function (localObj) {
            this.commentText = ej2_base_1.createElement('div', { className: 'e-de-cmt-readonly' });
        ...
        CommentView.prototype.initEditView = function (localObj) {
            this.textAreaContainer = ej2_base_1.createElement('div', { styles: 'display:none' });
            this.textArea = ej2_base_1.createElement('textarea', { className: 'e-de-cmt-textarea e-input' });
            ...
            var editRegionFooter = ej2_base_1.createElement('div', { className: 'e-de-cmt-action-button' });
            var postButton = ej2_base_1.createElement('button', { className: 'e-de-cmt-post-btn e-btn e-flat', attrs: { type: 'button' } });
            this.postButton = new ej2_buttons_1.Button({ cssClass: 'e-btn e-flat e-primary e-de-overlay', iconCss: 'e-de-cmt-post', disabled: true }, postButton);
            ...
            var cancelButton = ej2_base_1.createElement('button', {
                className: 'e-de-cmt-cancel-btn e-btn e-flat',
                attrs: { type: 'button' }
            });
            this.cancelButton = new ej2_buttons_1.Button({ cssClass: 'e-btn e-flat', iconCss: 'e-de-cmt-cancel' }, cancelButton);
        ...
        CommentView.prototype.initDateView = function () {
            this.commentDate = ej2_base_1.createElement('div', { className: 'e-de-cmt-date' });
            this.commentDate.innerText = editor_helper_1.HelperMethods.getModifiedDate(this.comment.date);
            this.commentView.appendChild(this.commentDate);
        };
        CommentView.prototype.initDrawer = function () {
            this.drawerElement = ej2_base_1.createElement('div', { styles: 'display:none;', className: 'e-de-cmt-drawer-cnt' });
            var leftPane = ej2_base_1.createElement('div', { className: 'e-de-cmt-drawer' });
        ...
        CommentView.prototype.initReplyView = function (localObj) {
            this.replyViewContainer = ej2_base_1.createElement('div', { className: 'e-de-cmt-rply-view' });
            if (this.commentPane.parentPane.isNewComment) {
                this.replyViewContainer.style.display = 'none';
            }
            this.replyViewTextBox = ej2_base_1.createElement('textarea', { className: 'e-de-cmt-textarea e-input' });
            ...
            var editRegionFooter = ej2_base_1.createElement('div', { styles: 'display:none', className: 'e-de-cmt-action-button' });
            var postButton = ej2_base_1.createElement('button', { className: 'e-de-cmt-post-btn e-de-overlay e-btn e-flat', attrs: { type: 'button' } });
            this.replyPostButton = new ej2_buttons_1.Button({ cssClass: 'e-btn e-flat e-primary', iconCss: 'e-de-cmt-post', disabled: true }, postButton);
            ...
            cancelButton.setAttribute('aria-label', localObj.getConstant('Cancel'));
            this.replyCancelButton = new ej2_buttons_1.Button({ cssClass: 'e-btn e-flat', iconCss: 'e-de-cmt-cancel' }, cancelButton);
        ...
        CommentView.prototype.initResolveOption = function (localObj) {
            var editRegionFooter = ej2_base_1.createElement('div', { className: 'e-de-cmt-resolve-btn' });
            var postButton = ej2_base_1.createElement('button', { className: 'e-de-cmt-post-btn e-btn e-flat', attrs: { type: 'button' } });
            this.reopenButton = new ej2_buttons_1.Button({ cssClass: 'e-btn e-flat', iconCss: 'e-de-cmt-reopen' }, postButton);
            ...
            this.deleteButton = new ej2_buttons_1.Button({ cssClass: 'e-btn e-flat', iconCss: 'e-de-cmt-delete' }, cancelButton);
        ...
        CommentView.prototype.deleteComment = function () {
            ...
            this.owner.trigger(index_1.commentDeleteEvent, eventArgs);
            var eventActionArgs = { author: this.comment.author, cancel: eventArgs.cancel, type: 'Delete' };
            this.owner.trigger(index_1.beforeCommentActionEvent, eventActionArgs);
        ...
        CommentView.prototype.updateReplyTextAreaHeight = function () {
            var _this = this;
            setTimeout(function () {
                if (!ej2_base_1.isNullOrUndefined(_this.replyViewTextBox)) {
        ...
        CommentView.prototype.enableDisableReplyPostButton = function () {
            ...
            if (this.replyPostButton.disabled) {
                ej2_base_1.classList(this.replyPostButton.element, ['e-de-overlay'], []);
            }
        ...
        CommentView.prototype.enableReplyView = function () {
            ...
            this.owner.trigger(index_1.beforeCommentActionEvent, eventArgs);
        ...
        CommentView.prototype.postReply = function () {
            var replyText = ej2_base_2.SanitizeHtmlHelper.sanitize(this.replyViewTextBox.value);
            this.cancelReply();
        ...
        CommentView.prototype.updateTextAreaHeight = function () {
            var _this = this;
            setTimeout(function () {
                if (!ej2_base_1.isNullOrUndefined(_this.textArea)) {
        ...
        CommentView.prototype.showMenuItems = function () {
            if (this.comment.isReply && !this.owner.isReadOnly) {
                if (!this.commentPane.isEditMode && (!ej2_base_1.isNullOrUndefined(this.comment) && !this.comment.isResolved)) {
                    this.menuBar.style.display = 'block';
                }
            }
            var commentStart = this.commentPane.getCommentStart(this.comment);
            if (!ej2_base_1.isNullOrUndefined(commentStart) && !ej2_base_1.isNullOrUndefined(commentStart.commentMark)) {
        ...
        CommentView.prototype.enableDisablePostButton = function () {
            ...
            if (this.postButton.disabled) {
                ej2_base_1.classList(this.postButton.element, ['e-de-overlay'], []);
            }
        ...
        CommentView.prototype.resolveComment = function () {
            ej2_base_1.classList(this.parentElement, ['e-de-cmt-resolved'], []);
            var localObj = new ej2_base_1.L10n('documenteditor', this.owner.defaultLocale);
            localObj.setLocale(this.owner.locale);
        ...
        CommentView.prototype.postComment = function () {
            ...
            var updatedText = ej2_base_2.SanitizeHtmlHelper.sanitize(this.textArea.value);
            ...
            if (!ej2_base_1.isNullOrUndefined(this.replyViewContainer)) {
        ...
        CommentView.prototype.hideDrawer = function () {
            if (this.parentElement) {
                ...
                if (elements.length > 1) {
                    ...
                    ej2_base_1.classList(this.drawerSpanElement, [], ['e-de-nav-up']);
