define(["require", "exports", "@syncfusion/ej2-navigations", "@syncfusion/ej2-base", "./viewer/page", "./editor/editor-helper", "@syncfusion/ej2-buttons", "@syncfusion/ej2-popups", "@syncfusion/ej2-base"], function (require, exports, ej2_navigations_1, ej2_base_1, page_1, editor_helper_1, ej2_buttons_1, ej2_popups_1, ej2_base_2) {
    "use strict";
    ...
    var ContextMenu = (function () {
        function ContextMenu(documentHelper) {
            ...
            this.onContextMenuInternal = function (event) {
                ...
                if (_this.documentHelper.owner.isSpellCheck && _this.spellChecker.allowSpellCheckAndSuggestion) {
                    ...
                    if (!ej2_base_1.isNullOrUndefined(exactData_1) && _this.spellChecker.errorWordCollection.containsKey(exactData_1)) {
                        ...
                        if (_this.spellChecker.errorSuggestions.containsKey(exactData_1)) {
                            ...
                            if (_this.spellChecker.enableOptimizedSpellCheck) {
                                _this.spellChecker.callSpellChecker(_this.spellChecker.languageID, exactData_1, false, true, false, false).then(function (data) {
                                    ...
                                    if (!ej2_base_1.isNullOrUndefined(allSuggestions_1)) {
            ...
            this.locale = new ej2_base_1.L10n('documenteditor', this.documentHelper.owner.defaultLocale);
        ...
        ContextMenu.prototype.initContextMenu = function (localValue, isRtl) {
            ...
            this.contextMenuInstance = new ej2_navigations_1.ContextMenu(menuOptions, '#' + this.documentHelper.owner.containerId + 'e-de-contextmenu-list');
            this.contextMenuInstance.beforeOpen = function () {
                ...
                if (_this.viewer && _this.documentHelper.selection) {
                    ej2_base_1.classList(_this.documentHelper.selection.caret, [], ['e-de-cursor-animation']);
                    _this.documentHelper.selection.showCaret();
                }
            };
            if (!ej2_base_1.isNullOrUndefined(this.documentHelper.owner.documentEditorSettings.popupTarget)) {
        ...
        ContextMenu.prototype.openPasteDialog = function () {
            var _this = this;
            var container = ej2_base_2.createElement('div');
            var contentDiv = ej2_base_2.createElement('div');
            var contentValue = ej2_base_2.createElement('p');
            ...
            var contentWithBookMark = ej2_base_2.createElement('div');
            this.pasteCheckBoxDialog = ej2_base_2.createElement('input', { attrs: { type: 'checkbox' } });
            contentWithBookMark.appendChild(this.pasteCheckBoxDialog);
            var bookmarkCheckbox = new ej2_buttons_1.CheckBox({ label: this.locale.getConstant('Paste Content CheckBox') });
            ...
            if (!getDialogBox) {
                var dialogUtility = ej2_popups_1.DialogUtility.alert({
            ...
            switch (item) {
                ...
                case id + CONTEXTMENU_PROPERTIES:
                    ...
                    if (inline instanceof page_1.FieldElementBox) {
                        if (inline.formFieldData instanceof page_1.TextFormField) {
                            this.documentHelper.owner.textFormFieldDialogModule.show();
                        }
                        else if (inline.formFieldData instanceof page_1.CheckBoxFormField) {
                            this.documentHelper.owner.checkBoxFormFieldDialogModule.show();
                        }
                        else if (inline.formFieldData instanceof page_1.DropDownFormField) {
        ...
        ContextMenu.prototype.addCustomMenu = function (items, isEnable, isBottom) {
            var menuItems = JSON.parse(editor_helper_1.HelperMethods.sanitizeString(JSON.stringify(items)));
            this.destroy();
        ...
        ContextMenu.prototype.showContextMenuOnSel = function (event) {
            ...
            if (isTouch) {
                ...
                yPos = ((ej2_base_1.Browser.isIE) ? event.clientY : event.y) + document.body.scrollTop + document.documentElement.scrollTop;
                xPos = ((ej2_base_1.Browser.isIE) ? event.clientX : event.x) + document.body.scrollLeft + document.documentElement.scrollLeft;
            }
        ...
        ContextMenu.prototype.processSuggestions = function (allSuggestions, splittedSuggestion, event) {
            ...
            if (!ej2_base_1.isNullOrUndefined(this.noSuggestion)) {
                this.noSuggestion.style.display = 'block';
                ej2_base_1.classList(this.noSuggestion, ['e-disabled'], ['e-focused']);
            }
        ...
        ContextMenu.prototype.constructContextmenu = function (allSuggestion, splittedSuggestion) {
            ...
            if (ej2_base_1.isNullOrUndefined(allSuggestion) || allSuggestion.length === 0) {
            ...
            if (!ej2_base_1.isNullOrUndefined(splittedSuggestion) && splittedSuggestion.length > 1) {
        ...
        ContextMenu.prototype.showHideElements = function (selection) {
            ...
            if (!this.documentHelper.owner.enableLockAndEdit) {
                ...
                if (this.documentHelper.editRanges.containsKey(this.documentHelper.owner.currentUser)) {
                    ...
                    if (this.documentHelper.selection.isSelectionInEditRegion()) {
                        ej2_base_1.classList(unlock, ['e-blankicon'], ['e-disabled']);
                    }
                    else {
                        ej2_base_1.classList(unlock, ['e-disabled', 'e-blankicon'], []);
                    }
                }
                else {
                    ...
                    if (this.documentHelper.owner.collaborativeEditingModule &&
                        ...
                        ej2_base_1.classList(unlock, ['e-disabled'], []);
                    }
                    else {
                        ej2_base_1.classList(unlock, [], ['e-disabled']);
                    }
            ...
            if (field instanceof page_1.FieldElementBox && selection.isReferenceField(field)) {
                isCrossRefField = true;
            }
            if (field instanceof page_1.FieldElementBox && isCrossRefField &&
            ...
            ej2_base_1.classList(cut, isSelectionEmpty ? ['e-disabled'] : [], !isSelectionEmpty ? ['e-disabled'] : []);
            ej2_base_1.classList(copy, isSelectionEmpty ? ['e-disabled'] : [], !isSelectionEmpty ? ['e-disabled'] : []);
            ...
            if (owner.isReadOnlyMode) {
                if (!ej2_base_1.isNullOrUndefined(field) && field instanceof page_1.FieldElementBox) {
            ...
            if (this.viewer && this.documentHelper.owner && this.documentHelper.owner.commentReviewPane &&
                ...
                ej2_base_1.classList(addComment, ['e-disabled'], []);
            }
            else {
                ej2_base_1.classList(addComment, [], ['e-disabled']);
            }
            ...
            ej2_base_1.classList(insertTable, ['e-blankicon'], []);
            ej2_base_1.classList(deleteTable, ['e-blankicon'], []);
            ej2_base_1.classList(editField, ['e-blankicon'], []);
            ej2_base_1.classList(autoFitTable, ['e-blankicon'], []);
            if (!ej2_base_1.Browser.isIE) {
                var getDialogBox = JSON.parse(localStorage.getItem("ej_de_hidePasteAlert"));
                if (getDialogBox) {
                    var enablePaste = (owner.enableLocalPaste && !ej2_base_1.isNullOrUndefined(owner.editor.copiedData));
                    ej2_base_1.classList(paste, enablePaste ? [] : ['e-disabled'], enablePaste ? ['e-disabled'] : []);
                }
            }
