define(["require", "exports", "@syncfusion/ej2-base", "@syncfusion/ej2-inputs", "../format/index", "@syncfusion/ej2-dropdowns", "@syncfusion/ej2-inputs"], function (require, exports, ej2_base_1, ej2_inputs_1, index_1, ej2_dropdowns_1, ej2_inputs_2) {
    ...
    var BordersAndShadingDialog = (function () {
        function BordersAndShadingDialog(documentHelper) {
            ...
            this.applyBordersShadingsProperties = function () {
                ...
                if (_this.ulelementShading.value === 'Cell') {
                    ...
                    if (!ej2_base_1.isNullOrUndefined(selectedCell.cellFormat.shading)) {
                    ...
                    if (!ej2_base_1.isNullOrUndefined(currentTableFormat.shading)) {
            ...
            this.applyTableCellPreviewBoxes = function () {
                if (!ej2_base_1.isNullOrUndefined(_this.ulelementShading)) {
                    if (_this.ulelementShading.value === 'Cell') {
        ...
        BordersAndShadingDialog.prototype.initBordersAndShadingsDialog = function (localeValue, isRtl) {
            ...
            var displayText = ej2_base_1.createElement('div', {
                innerHTML: localeValue.getConstant('Borders'),
                className: 'e-de-table-border-heading'
            });
            var settingAndPreviewContainer = ej2_base_1.createElement('div', {
                className: 'e-de-dlg-row'
            });
            var settingsContiner = ej2_base_1.createElement('div', {});
            var styleContainer = ej2_base_1.createElement('div', {});
            var previewContiner = ej2_base_1.createElement('div', {
                className: 'e-de-table-border-preview-container'
            });
            var previewSubContainer1 = ej2_base_1.createElement('div', {
                className: 'e-de-dlg-row'
            });
            var previewSubContainer2 = ej2_base_1.createElement('div', {});
            var styleSubContainer = ej2_base_1.createElement('div', {
                className: 'e-de-container-row'
            });
            var dropdownListDiv = ej2_base_1.createElement('div', {
                className: 'e-de-subcontainer-left'
            });
            var dropDownList = ej2_base_1.createElement('input', {});
            var widthcontainerDiv = ej2_base_1.createElement('div', {
                className: 'e-de-container-row'
            });
            var widthNumericDiv = ej2_base_1.createElement('div', {
                className: 'e-de-subcontainer-left'
            });
            var widthNumeric = ej2_base_1.createElement('input', {});
            var colorDiv = ej2_base_1.createElement('div', {
                className: 'e-de-subcontainer-right'
            });
            var colorText = ej2_base_1.createElement('div', {
                innerHTML: localeValue.getConstant('Color'),
                className: 'e-de-table-border-clr-heading'
            });
            var borderColorPickerElement = ej2_base_1.createElement('input', {
                attrs: { 'type': 'color' },
                className: 'e-dlg-clr-pkr-top'
            });
            var settingText = ej2_base_1.createElement('div', {
                innerHTML: localeValue.getConstant('Setting'),
                className: 'e-de-table-setting-heading'
            });
            var settingsSubContiner = ej2_base_1.createElement('div', {
                className: 'e-de-dlg-row'
            });
            var noneDivContainer = ej2_base_1.createElement('div', {
            ...
            var customDivLabel = ej2_base_1.createElement('label', {
            ...
            var previewText = ej2_base_1.createElement('div', {
            ...
            var previewDivVerticalContainer = ej2_base_1.createElement('div');
            ...
            var previewDivHorizontalContainer = ej2_base_1.createElement('div', { className: 'e-de-dlg-row' });
            ...
            var shadingText = ej2_base_1.createElement('div', {
                innerHTML: localeValue.getConstant('Shading'), className: 'e-de-table-border-heading',
            });
            var shadings = ej2_base_1.createElement('div', { className: 'e-de-dlg-row' });
            var colorPickerDiv = ej2_base_1.createElement('div', { className: 'e-de-table-border-clr-left-container' });
            var label = ej2_base_1.createElement('div', {
                innerHTML: localeValue.getConstant('Fill'), className: 'e-de-table-border-clr-heading',
            });
            var shadingColorPickerElement = ej2_base_1.createElement('input', {
                attrs: { 'type': 'color' },
                id: this.target.id + '_shading_color',
            });
            var shdApply = ej2_base_1.createElement('div', {
                className: 'e-de-subcontainer-right'
            });
        ...
        BordersAndShadingDialog.prototype.loadBordersShadingsPropertiesDialog = function (localeValue) {
            ...
            if (!ej2_base_1.isNullOrUndefined(this.documentHelper.selection.tableFormat.table)) {
                ...
                if (!ej2_base_1.isNullOrUndefined(tableFormat) && !ej2_base_1.isNullOrUndefined(tableFormat.borders)) {
                    this.cloneBorders(tableFormat.borders);
                    if (ej2_base_1.isNullOrUndefined(tableFormat.borders) || ej2_base_1.isNullOrUndefined(tableFormat.borders.top)) {
                        lineStyle = 0;
                        borderColor = '#000000';
                        borderWidth = 0;
                        fillColor = '#000000';
