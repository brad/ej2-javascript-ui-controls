define(["require", "exports", "@syncfusion/ej2-base", "@syncfusion/ej2-buttons", "@syncfusion/ej2-inputs", "../index"], function (require, exports, ej2_base_1, ej2_buttons_1, ej2_inputs_1, index_1) {
    "use strict";
    ...
    var ColumnsDialog = (function () {
        ...
        ColumnsDialog.prototype.initColumnsDialog = function (localeValue, isRtl) {
            ...
            var PresetsContainer = ej2_base_1.createElement('div', {
                className: 'e-de-dlg-row'
            });
            var oneDivContainer = ej2_base_1.createElement('div', {
            ...
            var subcontainer1 = ej2_base_1.createElement('div', {
                className: 'e-de-subcontainer-right'
            });
            var lineCheckDiv = ej2_base_1.createElement('div', {
                className: 'e-de-columns-padding-alignment'
            });
            var lineCheck = ej2_base_1.createElement('input', { attrs: { type: 'checkbox' } });
            ...
            var widthAndSpacingContainer = ej2_base_1.createElement('div', {
                className: 'e-de-dlg-row'
            });
            var widthAndSpacingContainerDiv = ej2_base_1.createElement('div', {});
            var widthAndSpacingText = ej2_base_1.createElement('div', {
            ...
            cell.style.display = 'table-cell';
            cell.classList.add('e-de-dlg-sub-header');
            var columnDiv = ej2_base_1.createElement('div', { styles: 'width:100%;height:100px;overflow-y: scroll;overflow-x: hidden;' });
            ...
            var equalCheckDiv = ej2_base_1.createElement('div', {
                className: 'e-de-columns-padding-alignment'
            });
            var equalCheck = ej2_base_1.createElement('input', { attrs: { type: 'checkbox' } });
        ...
        ColumnsDialog.prototype.createColumn = function (index, width, space) {
            ...
            cell1.style.width = '20%';
            var col = new Column();
            var columnCount = ej2_base_1.createElement('input', {});
            col.index = new ej2_inputs_1.NumericTextBox({
                format: '#',
                min: 1,
                value: index,
            ...
            if (!ej2_base_1.isNullOrUndefined(space)) {
