define(["require", "exports", "@syncfusion/ej2-base", "@syncfusion/ej2-buttons", "../viewer/page", "@syncfusion/ej2-lists", "@syncfusion/ej2-inputs", "@syncfusion/ej2-base"], function (require, exports, ej2_base_1, ej2_buttons_1, page_1, ej2_lists_1, ej2_inputs_1, ej2_base_2) {
    "use strict";
    ...
    var DropDownFormFieldDialog = (function () {
        function DropDownFormFieldDialog(owner) {
            ...
            this.addItemtoList = function () {
                _this.dropDownItems.push(ej2_base_2.SanitizeHtmlHelper.sanitize(_this.drpDownItemsInput.value));
                _this.currentSelectedItem = ej2_base_2.SanitizeHtmlHelper.sanitize(_this.drpDownItemsInput.value);
            ...
            this.insertDropDownField = function () {
                ...
                dropDownField.name = ej2_base_2.SanitizeHtmlHelper.sanitize(_this.bookmarkInput.value);
                dropDownField.helpText = ej2_base_2.SanitizeHtmlHelper.sanitize(_this.tooltipInput.value);
        ...
        DropDownFormFieldDialog.prototype.initTextDialog = function (localValue, isRtl) {
            ...
            var firstDiv = ej2_base_1.createElement('div', { className: 'e-de-drp-dwn-frst-div' });
            ...
            var secondDiv = ej2_base_1.createElement('div', { className: 'e-de-ff-drpdwn-dlg-scndiv' });
            var itemsDrpItemsLabel = ej2_base_1.createElement('div', {
            ...
            var addButtonEle = ej2_base_1.createElement('button', {
            ...
            var editButtonDiv = ej2_base_1.createElement('div', { className: 'e-bookmark-addbutton' });
            editButtonDiv.style.display = 'none';
            var editButtonEle = ej2_base_1.createElement('button', {
                innerHTML: 'EDIT',
                attrs: { type: 'button', style: 'height:36px;width:100%' }
            });
            this.editButton = new ej2_buttons_1.Button({ cssClass: 'e-button-custom' });
            editButtonEle.setAttribute('aria-label', 'EDIT');
            var removeButtonDiv = ej2_base_1.createElement('div', { className: 'e-bookmark-addbutton' });
            var removeButtonEle = ej2_base_1.createElement('button', {
            ...
            var moveBtnDiv = ej2_base_1.createElement('div', { attrs: { style: 'display:inline-flex' } });
            var moveUpButtonDiv = ej2_base_1.createElement('div', { className: 'e-bookmark-addbutton' });
            var moveUpButtonEle = ej2_base_1.createElement('button', {
            ...
            var moveDownButtonDiv = ej2_base_1.createElement('div', { className: 'e-bookmark-addbutton' });
            var moveDownButtonEle = ej2_base_1.createElement('button', {
                attrs: { type: 'button', style: 'height:36px;width:40px' },
            ...
            var fileSettingsLabel = ej2_base_1.createElement('div', {
                className: 'e-de-para-dlg-heading',
                innerHTML: localValue.getConstant('Field settings')
            });
            var thirdDiv = ej2_base_1.createElement('div', { className: 'e-de-container-row' });
            var toolTipDiv = ej2_base_1.createElement('div', { className: 'e-de-subcontainer-left' });
            var bookmarkDiv = ej2_base_1.createElement('div', { className: 'e-de-subcontainer-right' });
            ...
            var dropDownEnableDiv = ej2_base_1.createElement('div');
            var dropDownEnableEle = ej2_base_1.createElement('input', { attrs: { type: 'checkbox' } });
