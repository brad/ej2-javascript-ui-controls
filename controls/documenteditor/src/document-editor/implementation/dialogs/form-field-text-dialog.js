    ...
    var TextFormFieldDialog = (function () {
        function TextFormFieldDialog(owner) {
            ...
            this.updateTextFormtas = function () {
                var defautText = ej2_base_2.SanitizeHtmlHelper.sanitize(_this.updateFormats(_this.defaultTextInput.value));
            ...
            this.insertTextField = function () {
                ...
                if (valid) {
                    ...
                    if (_this.defaultTextInput.value.length > _this.maxLengthNumber.value && !ej2_base_1.isNullOrUndefined(_this.maxLengthNumber.value) &&
                        ...
                        formField.name = ej2_base_2.SanitizeHtmlHelper.sanitize(_this.bookmarkTextInput.value);
                        formField.helpText = ej2_base_2.SanitizeHtmlHelper.sanitize(_this.tooltipTextInput.value);
        ...
        TextFormFieldDialog.prototype.initTextDialog = function (localValue, isRtl) {
            ...
            var firstDiv = ej2_base_1.createElement('div', { className: 'e-de-container-row' });
            var typeDiv = ej2_base_1.createElement('div', { className: 'e-de-subcontainer-left' });
            ...
            var typeDropDownList = ej2_base_1.createElement('input');
            ...
            var secondDiv = ej2_base_1.createElement('div', { className: 'e-de-container-row' });
            var maxLengthDiv = ej2_base_1.createElement('div', { className: 'e-de-subcontainer-left' });
            var maxLength = ej2_base_1.createElement('input', { attrs: { 'aria-labelledby': localValue.getConstant('Maximum length') } });
            ...
            var textFromatDiv = ej2_base_1.createElement('div', { className: 'e-de-subcontainer-right' });
            var textFormatList = ej2_base_1.createElement('input');
            ...
            var toolTipTotalDiv = ej2_base_1.createElement('div', { className: 'e-de-subcontainer-left' });
            var bookmarkTotalDiv = ej2_base_1.createElement('div', { className: 'e-de-subcontainer-right' });
            ...
            var fillInEnableDiv = ej2_base_1.createElement('div');
            var fillInEnableEle = ej2_base_1.createElement('input', { attrs: { type: 'checkbox' } });
