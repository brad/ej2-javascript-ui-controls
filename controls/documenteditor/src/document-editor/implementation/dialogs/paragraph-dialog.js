    ...
    var ParagraphDialog = (function () {
        function ParagraphDialog(documentHelper) {
            ...
            this.changeByValue = function () {
                ...
                switch (_this.special.index) {
                    case 0:
                        ...
                        break;
                    case 1:
                        if (paragraphFormat.firstLineIndent === 0 || ej2_base_2.isNullOrUndefined(paragraphFormat.firstLineIndent)) {
            ...
            this.changeBySpacing = function () {
                if (ej2_base_2.isNullOrUndefined(_this.lineSpacing)) {
                    return;
                }
            ...
            this.applyParagraphFormat = function () {
                ...
                if (!ej2_base_2.isNullOrUndefined(_this.spaceBeforeAuto)) {
                    paraFormat.spaceBeforeAuto = _this.spaceBeforeAuto;
                }
                if (!ej2_base_2.isNullOrUndefined(_this.spaceAfterAuto)) {
                ...
                if (!ej2_base_2.isNullOrUndefined(_this.rightIndent)) {
                    paraFormat.rightIndent = _this.rightIndent;
                }
                if (!ej2_base_2.isNullOrUndefined(_this.lineSpacingIn)) {
                    paraFormat.lineSpacing = _this.lineSpacingIn;
                }
                if (!ej2_base_2.isNullOrUndefined(_this.firstLineIndent)) {
                ...
                if (!ej2_base_2.isNullOrUndefined(_this.contextualSpacing)) {
                    paraFormat.contextualSpacing = _this.contextualSpacing;
                }
                if (!ej2_base_2.isNullOrUndefined(_this.keepWithNextValue)) {
                ...
                if (!ej2_base_2.isNullOrUndefined(_this.keepLineTogetherValue)) {
                ...
                if (!ej2_base_2.isNullOrUndefined(_this.widowControlValue)) {
        ...
        ParagraphDialog.prototype.initParagraphDialog = function (locale) {
            ...
            var ejtab = ej2_base_1.createElement('div');
            var instance = this;
            var ownerId = this.documentHelper.owner.containerId;
            var indentContainer = ej2_base_1.createElement('div', { className: 'e-de-dlg-tab-first-child e-de-para-dlg-container' });
            this.target = tabContainer;
            tabContainer.appendChild(ejtab);
            var div = ej2_base_1.createElement('div', { styles: 'width:400px;' });
            var generalDiv = ej2_base_1.createElement('div');
            var genLabel = ej2_base_1.createElement('div', { className: 'e-de-para-dlg-heading', innerHTML: locale.getConstant('General') });
            generalDiv.appendChild(genLabel);
            var alignmentWholeDiv = ej2_base_1.createElement('div', { className: 'e-de-container-row' });
            generalDiv.appendChild(alignmentWholeDiv);
            var alignmentDiv = ej2_base_1.createElement('div', { className: 'e-de-subcontainer-left' });
            ...
            var dirLabel = ej2_base_1.createElement('div', {
            ...
            var rtlDiv = ej2_base_1.createElement('div', { className: 'e-de-rtl-btn-div' });
            var rtlInputELe = ej2_base_1.createElement('input', { id: ownerId + '_rtlEle' });
            ...
            var ltrDiv = ej2_base_1.createElement('div', { className: 'e-de-ltr-btn-div' });
            var ltrInputELe = ej2_base_1.createElement('input', { id: ownerId + '_ltrEle' });
            ...
            var indentionWholeDiv = ej2_base_1.createElement('div');
            var indentLabel = ej2_base_1.createElement('div', { className: 'e-de-para-dlg-heading',
                innerHTML: locale.getConstant('Indentation')
            });
            indentionWholeDiv.appendChild(indentLabel);
            var indentionSubDiv1 = ej2_base_1.createElement('div', { className: 'e-de-container-row' });
            indentionWholeDiv.appendChild(indentionSubDiv1);
            var indentionSubDiv2 = ej2_base_1.createElement('div', { className: 'e-de-container-row' });
            indentionWholeDiv.appendChild(indentionSubDiv2);
            var beforeTextDiv = ej2_base_1.createElement('div', { className: 'e-de-subcontainer-left' });
            indentionSubDiv1.appendChild(beforeTextDiv);
            var afterTextDiv = ej2_base_1.createElement('div', { className: 'e-de-subcontainer-right' });
            indentionSubDiv1.appendChild(afterTextDiv);
            var specialDiv = ej2_base_1.createElement('div', { className: 'e-de-subcontainer-left' });
            indentionSubDiv2.appendChild(specialDiv);
            var byDiv = ej2_base_1.createElement('div', { className: 'e-de-subcontainer-right' });
            indentionSubDiv2.appendChild(byDiv);
            var spacingDiv = ej2_base_1.createElement('div');
            var leftSpacingDiv = ej2_base_1.createElement('div');
            spacingDiv.appendChild(leftSpacingDiv);
            var contextSpacingDiv = ej2_base_1.createElement('div', { className: 'e-de-container-row' });
            spacingDiv.appendChild(contextSpacingDiv);
            var rightSpacingDiv = ej2_base_1.createElement('div', { className: 'e-de-container-row' });
            spacingDiv.appendChild(rightSpacingDiv);
            var contextInputEle = ej2_base_1.createElement('input', {
                attrs: { type: 'checkbox' },
            ...
            var by = ej2_base_1.createElement('input', { id: ownerId + '_By', attrs: { 'type': 'text' } });
            ...
            var spaceLabel = ej2_base_1.createElement('div', { className: 'e-de-para-dlg-heading', innerHTML: locale.getConstant('Spacing') });
            var spacingWholeDiv = ej2_base_1.createElement('div', { className: 'e-de-container-row' });
            var beforeSpacingWholeDiv = ej2_base_1.createElement('div', { className: 'e-de-subcontainer-left' });
            var beforeSpacing = ej2_base_1.createElement('input', { id: ownerId + '_beforeSpacing', attrs: { 'type': 'text' } });
            var afterSpacingWholeDiv = ej2_base_1.createElement('div', { className: 'e-de-subcontainer-right' });
            ...
            var lineSpacingDiv = ej2_base_1.createElement('div', { className: 'e-de-subcontainer-left' });
            ...
            var lineTypeDiv = ej2_base_1.createElement('div', { className: 'e-de-subcontainer-right' });
            var lineSpacingAt = ej2_base_1.createElement('input', { id: ownerId + '_lineSpacingAt', attrs: { 'type': 'text' } });
            ...
            var lineBreakContainer = ej2_base_1.createElement('div', { className: 'e-de-dlg-tab-first-child' });
            var paginationDiv = ej2_base_1.createElement('div', { className: 'e-de-para-dlg-sub-container' });
            this.paginationDiv = paginationDiv;
            var paginationLabel = ej2_base_1.createElement('div', { className: 'e-de-para-dlg-heading', innerHTML: locale.getConstant('Pagination') });
            paginationDiv.appendChild(paginationLabel);
            var widowContorlContainer = ej2_base_1.createElement('div', { styles: 'display:block' });
            paginationDiv.appendChild(widowContorlContainer);
            var keepNextContainer = ej2_base_1.createElement('div', { styles: 'display:block' });
            paginationDiv.appendChild(keepNextContainer);
            var keepLines = ej2_base_1.createElement('div', { styles: 'display:block' });
            paginationDiv.appendChild(keepLines);
            var keepWithNext = ej2_base_1.createElement('input', {
                attrs: { type: 'checkbox' },
            });
            ...
            var keepLinesTogether = ej2_base_1.createElement('input', {
                attrs: { type: 'checkbox' },
            });
            ...
            var widowControl = ej2_base_1.createElement('input', {
                attrs: { type: 'checkbox' },
            });
            ...
            this.tabObj = new ej2_navigations_1.Tab({ items: items, enableRtl: isRtl, animation: { previous: { effect: 'None' }, next: { effect: 'None' } } }, ejtab);
