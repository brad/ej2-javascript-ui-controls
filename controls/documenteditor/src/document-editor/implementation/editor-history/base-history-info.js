define(["require", "exports", "../format/paragraph-format", "../format/section-format", "../format/character-format", "../format/list-format", "../index", "./history-helper", "../viewer/page", "../../base/dictionary", "../../index", "../index", "@syncfusion/ej2-base", "../viewer/page", "../format/index", "../editor/editor-helper", "../../base/types"], function (require, exports, paragraph_format_1, section_format_1, character_format_1, list_format_1, index_1, history_helper_1, page_1, dictionary_1, index_2, index_3, ej2_base_1, page_2, index_4, editor_helper_1, types_1) {
    "use strict";
    ...
    var BaseHistoryInfo = (function () {
                ...
                if (this.owner.enableCollaborativeEditing && !this.editorHistory.isUndoing && this.cellOperation.length == 0) {
                    if (value === 'DeleteColumn' || value === 'DeleteCells' || value === 'ClearCells' || value === 'MergeCells') {
                        if (!(this.owner.selection.isTableSelected(true) || this.owner.selection.isRowSelect()) || value === 'ClearCells' || value === 'MergeCells') {
                            this.insertedText = types_1.CONTROL_CHARACTERS.Cell;
                        ...
                        this.insertedText = types_1.CONTROL_CHARACTERS.Section_Break;
                        this.type = "NewPage";
                    }
        ...
        Object.defineProperty(BaseHistoryInfo.prototype, "insertPosition", {
            ...
            set: function (value) {
                ...
                if (this.owner.enableCollaborativeEditing && value !== '' && !ej2_base_1.isNullOrUndefined(value) && value.indexOf('C') === -1) {
        ...
        BaseHistoryInfo.prototype.revertFormTextFormat = function () {
            ...
            if (this.editorHistory.isUndoing) {
                ...
                text = editor_helper_1.HelperMethods.formatText(formField.formFieldData.format, text);
                this.owner.editorModule.applyTextFormatInternal(formField, text);
        ...
        BaseHistoryInfo.prototype.revertFormField = function () {
            ...
            if (field.formFieldData instanceof page_1.CheckBoxFormField) {
        ...
        BaseHistoryInfo.prototype.revertBookmark = function () {
            ...
            if (this.editorHistory.isUndoing) {
                ...
                if (previousNode instanceof page_1.FieldElementBox && !ej2_base_1.isNullOrUndefined(previousNode.formFieldData)) {
        ...
        BaseHistoryInfo.prototype.revert = function () {
            ...
            var isForwardSelection = index_3.TextPosition.isForwardSelection(start, end);
            if (this.modifiedProperties.length > 0 || this.action === 'Selection'
                ...
                this.removedNodesIn = [];
                if (ej2_base_1.isNullOrUndefined(this.endPosition)) {
                    this.endPosition = this.insertPosition;
                }
                var isForward = index_3.TextPosition.isForwardSelection(this.insertPosition, this.endPosition);
                ...
                if (this.editorHistory.isUndoing) {
                    if (this.lastElementRevision && ej2_base_1.isNullOrUndefined(this.endRevisionLogicalIndex)) {
                ...
                if (!insertTextPosition.isAtSamePosition(endTextPosition)) {
                    ...
                    if (!(isRemoveContent) && this.action !== 'MergeCells' && this.action !== 'InsertRowAbove'
                        ...
                        if (!this.owner.selection.isEmpty && !skipDelete) {
                            ...
                            if (!ej2_base_1.isNullOrUndefined(this.editorHistory.currentHistoryInfo) &&
                    ...
                    if (insertTextPosition.offset === 0 && !ej2_base_1.isNullOrUndefined(insertTextPosition.paragraph.previousRenderedWidget) && insertTextPosition.paragraph.previousRenderedWidget instanceof page_1.ParagraphWidget && insertTextPosition.paragraph.previousRenderedWidget.isEndsWithPageBreak && insertTextPosition.paragraph.containerWidget instanceof page_1.BodyWidget && insertTextPosition.currentWidget === insertTextPosition.currentWidget.paragraph.firstChild && insertTextPosition.paragraph.containerWidget.sectionFormat.breakCode === 'NoBreak') {
            ...
            if (!ej2_base_1.isNullOrUndefined(this.editorHistory.currentHistoryInfo) && (this.editorHistory.currentHistoryInfo.action === 'Reject All' || this.editorHistory.currentHistoryInfo.action === 'Accept All' || this.editorHistory.currentHistoryInfo.action === 'Paste')) {
                updateSelection = true;
            }
            if (!this.owner.trackChangesPane.isTrackingPageBreak && ((this.editorHistory.isUndoing || this.endRevisionLogicalIndex || this.action === 'RemoveRowTrack' || updateSelection) && ej2_base_1.isNullOrUndefined(this.editorHistory.currentHistoryInfo) || updateSelection) ||
        ...
        BaseHistoryInfo.prototype.removeContent = function (insertTextPosition, endTextPosition, skipDeletecell) {
            if ((!ej2_base_1.isNullOrUndefined(insertTextPosition.paragraph.containerWidget) &&
                insertTextPosition.paragraph.containerWidget instanceof page_1.BodyWidget &&
                (!ej2_base_1.isNullOrUndefined(endTextPosition.paragraph.containerWidget)
                    && endTextPosition.paragraph.containerWidget instanceof page_1.BodyWidget))
                || (!ej2_base_1.isNullOrUndefined(insertTextPosition.paragraph.containerWidget)
                    && !ej2_base_1.isNullOrUndefined(endTextPosition.paragraph.containerWidget)
                    && insertTextPosition.paragraph.containerWidget instanceof page_1.TableCellWidget
                    && endTextPosition.paragraph.containerWidget instanceof page_1.TableCellWidget
                    && !ej2_base_1.isNullOrUndefined(insertTextPosition.paragraph.bodyWidget)) ||
                (!ej2_base_1.isNullOrUndefined(insertTextPosition.paragraph.containerWidget)
                    && !ej2_base_1.isNullOrUndefined(endTextPosition.paragraph.containerWidget)
                    && insertTextPosition.paragraph.containerWidget instanceof page_1.TextFrame
                    && endTextPosition.paragraph.containerWidget instanceof page_1.TextFrame)) {
        ...
        BaseHistoryInfo.prototype.retrieveEndPosition = function (elementBox) {
            var endPosition = new index_3.TextPosition(this.owner);
        ...
        BaseHistoryInfo.prototype.checkAdjacentNodeForMarkedRevision = function (elementBox) {
            ...
            var markedNode;
            while (!ej2_base_1.isNullOrUndefined(nextItem) && nextItem.isMarkedForRevision) {
                markedNode = nextItem;
                nextItem = nextItem.nextNode;
            }
            return !ej2_base_1.isNullOrUndefined(markedNode) ? markedNode : elementBox;
        };
        ...
        BaseHistoryInfo.prototype.revertModifiedNodes = function (deletedNodes, isRedoAction, start, isEmptySelection) {
            ...
            if (deletedNodes.length > 0) {
                if ((this.editorHistory.isUndoing && (this.action === 'RemoveRowTrack' || this.action === 'DeleteCells' ||
                    ...
                    if ((block instanceof page_1.TableWidget || block.previousRenderedWidget instanceof page_1.TableWidget || block.isInsideTable)
                        && lastNode instanceof page_1.TableWidget) {
                        if (block instanceof page_1.ParagraphWidget && !block.isInsideTable) {
                            block = block.previousRenderedWidget;
                        }
                        else if (block instanceof page_1.ParagraphWidget && block.isInsideTable) {
                    ...
                    else if (lastNode instanceof page_1.TableWidget && !(this.action === 'RemoveRowTrack')) {
                    ...
                    if (deletedNodes.length > 0 && (this.action === 'BackSpace' && isEmptySelection
                        || (!(block instanceof page_1.TableWidget) && !(block instanceof page_1.HeaderFooterWidget)))) {
                        var lastNode = deletedNodes[0];
                        if (lastNode instanceof page_1.BodyWidget && !ej2_base_1.isNullOrUndefined(deletedNodes[1])) {
                            lastNode = deletedNodes[1];
                        }
                        if (this.action === 'TrackingPageBreak' || ((this.action === 'SectionBreak' || this.action === 'SectionBreakContinuous') && lastNode instanceof page_1.BodyWidget ||
                            !ej2_base_1.isNullOrUndefined(this.editorHistory.currentHistoryInfo) &&
                                this.editorHistory.currentHistoryInfo.action === 'PageBreak')) {
                            lastNode = deletedNodes[1];
                        }
                        if (lastNode instanceof character_format_1.WCharacterFormat) {
                        ...
                        if (lastNode instanceof page_1.ParagraphWidget && this.owner.selection.start.offset > 0) {
                            ...
                            if (ej2_base_1.isNullOrUndefined(block)) {
                                ...
                                if (nextBlock && startParagraph && startParagraph.bodyWidget instanceof page_1.BodyWidget
                        ...
                        if (lastNode instanceof page_1.TableWidget && this.owner.selection.start.offset > 0) {
                    ...
                    if (deletedNodes.length > 0) {
                        ...
                        if (block instanceof page_1.TableWidget) {
                            block = block.combineWidget(this.viewer);
                            if (firstNode instanceof page_1.TableWidget) {
                                ...
                                if (nextWidget.nextRenderedWidget instanceof page_1.TableWidget) {
                        ...
                        if (firstNode instanceof page_1.ParagraphWidget && this.owner.selection.start.offset > 0
                        ...
                        else if (deletedNodes[0] instanceof page_1.TableWidget && deletedNodes.length !== 1) {
                            var nextNode = deletedNodes[1];
                            if (nextNode instanceof page_1.ParagraphWidget && nextNode.isEmpty()) {
        ...
        BaseHistoryInfo.prototype.insertRemovedNodes = function (deletedNodes, block) {
            ...
            for (var i = deletedNodes.length - 1, index = 0; i > -1; i--) {
                ...
                if (node instanceof page_2.ElementBox) {
                    this.owner.editorModule.insertInlineInSelection(this.owner.selection, node);
                }
                else if (node instanceof page_1.BlockWidget) {
                    if (node instanceof page_1.TableRowWidget) {
                        if (block instanceof page_1.TableWidget) {
                            block.childWidgets.splice(index, 0, node);
                            this.owner.editorModule.updateNextBlocksIndex(node, true);
                            if (i === 0 || !(deletedNodes[i - 1] instanceof page_1.TableRowWidget)) {
                                this.documentHelper.layout.layoutBodyWidgetCollection(block.index, block.containerWidget, block, false);
                            }
                        }
                    }
                    else if (block instanceof page_1.TableWidget && this.action !== 'RemoveRowTrack') {
                        this.owner.editorModule.insertBlockTable(this.owner.selection, node, block);
                    }
                    else {
                        if (node instanceof page_1.ParagraphWidget && !node.isInsideTable && this.action === 'RemoveRowTrack') {
                            this.owner.editorModule.insertNewParagraphWidget(node, false);
                        }
                        else if (node instanceof page_1.TableWidget && this.action === 'RemoveRowTrack') {
                            this.owner.editorModule.insertTableInternal(node, node, false, true);
                            if (!ej2_base_1.isNullOrUndefined(deletedNodes[i - 1]) && !ej2_base_1.isNullOrUndefined(node.nextRenderedWidget) && node.nextRenderedWidget instanceof page_1.ParagraphWidget) {
                                this.owner.selection.start.setPositionParagraph(node.nextRenderedWidget.firstChild, 0);
                                this.owner.selection.end.setPositionParagraph(node.nextRenderedWidget.firstChild, 0);
                            }
                        }
                        else {
                ...
                else if (node instanceof character_format_1.WCharacterFormat) {
                    var insertIndex = this.selectionStart;
                    var wiget = this.owner.editorModule.getBlock({ index: insertIndex }).node;
                    if (wiget instanceof page_1.ParagraphWidget) {
                ...
                else if (node instanceof page_1.BodyWidget) {
                    if (!ej2_base_1.isNullOrUndefined(node.removedHeaderFooters) && node.removedHeaderFooters.length !== 0) {
                    ...
                    if (this.editorHistory.isUndoing) {
                        while (widget instanceof page_1.ParagraphWidget && widget !== endWidget) {
        ...
        BaseHistoryInfo.prototype.undoRevisionForElements = function (start, end, id) {
            ...
            if (this.editorHistory.isUndoing) {
                while (currentPara !== endPara) {
                    ...
                    if (!ej2_base_1.isNullOrUndefined(currentPara) && !ej2_base_1.isNullOrUndefined(currentPara.previousRenderedWidget) && currentPara.previousRenderedWidget instanceof page_1.ParagraphWidget && currentPara.previousRenderedWidget.nextSplitWidget && currentPara === endPara) {
        ...
        BaseHistoryInfo.prototype.revertResizing = function () {
            ...
            if (this.action === 'RowResizing') {
                if (this.modifiedProperties[0] instanceof history_helper_1.RowHistoryFormat) {
                ...
                if (this.modifiedProperties[0] instanceof history_helper_1.TableHistoryInfo) {
                    ...
                    if (block instanceof page_1.TableWidget) {
                        ...
                        if (this.editorHistory.isUndoing || this.editorHistory.isRedoing) {
                            var tableHistoryInfoCurrent = new history_helper_1.TableHistoryInfo(block, this.owner);
        ...
        BaseHistoryInfo.prototype.addModifiedPropertiesForSection = function (format, property, value) {
            if (this.editorHistory.isUndoing || this.editorHistory.isRedoing) {
                ...
                if (ej2_base_1.isNullOrUndefined(property)) {
                ...
                if (ej2_base_1.isNullOrUndefined(property)) {
                    ...
                    var currentFormat = new section_format_1.WSectionFormat();
        ...
        BaseHistoryInfo.prototype.addModifiedProperties = function (format, property, value) {
            if (this.editorHistory.isUndoing || this.editorHistory.isRedoing) {
                ...
                if (format.ownerBase instanceof page_2.ElementBox) {
                    ...
                    if (format.ownerBase.length < prevLength) {
                        ...
                        var nextFormat = new character_format_1.WCharacterFormat(undefined);
                ...
                if (ej2_base_1.isNullOrUndefined(property)) {
                    ...
                    var currentFormat = new character_format_1.WCharacterFormat(undefined);
                    currentFormat.copyFormat(format);
                    this.modifiedProperties.push(currentFormat);
                }
                if (format.ownerBase instanceof page_2.ElementBox) {
        ...
        BaseHistoryInfo.prototype.addModifiedPropertiesForParagraphFormat = function (format, property, value) {
            if (this.editorHistory.isUndoing || this.editorHistory.isRedoing) {
                ...
                if (property === 'listFormat') {
                    value = new paragraph_format_1.WParagraphFormat(undefined);
                    value.copyFormat(previousFormat);
                    previousFormat.listFormat = new list_format_1.WListFormat(previousFormat);
                ...
                if (property === 'tabStop') {
                    ...
                    var currentFormat = new paragraph_format_1.WParagraphFormat(undefined);
                    currentFormat.copyFormat(format);
                ...
                if (property === 'styleName') {
                    if (!ej2_base_1.isNullOrUndefined(previousFormat.baseStyle)) {
                        value = new index_4.WParagraphStyle();
                        value.copyStyle(previousFormat.baseStyle);
                        this.currentPropertyIndex++;
                        if (!ej2_base_1.isNullOrUndefined(format.baseStyle)) {
                            previousFormat.baseStyle = new index_4.WParagraphStyle();
        ...
        BaseHistoryInfo.prototype.addModifiedPropertiesForContinueNumbering = function (paragraphFormat, value) {
            if (this.editorHistory.isUndoing || this.editorHistory.isRedoing) {
                ...
                var currentFormat = new paragraph_format_1.WParagraphFormat();
        ...
        BaseHistoryInfo.prototype.addModifiedPropertiesForList = function (listLevel) {
            ...
            if (this.editorHistory.isUndoing || this.editorHistory.isRedoing) {
                ...
                value = previousLevel;
                previousLevel = new history_helper_1.ModifiedLevel(listLevel, this.owner.editorModule.cloneListLevel(listLevel));
                if (this.currentPropertyIndex < this.modifiedProperties.length) {
                ...
                this.modifiedProperties.push(new history_helper_1.ModifiedLevel(listLevel, this.owner.editorModule.cloneListLevel(listLevel)));
                value = listLevel;
            }
            return value;
        };
        BaseHistoryInfo.prototype.revertProperties = function () {
            ...
            if (this.action === 'ClearCharacterFormat' || this.modifiedProperties[0] instanceof character_format_1.WCharacterFormat) {
            ...
            else if (this.action === 'ClearParagraphFormat' || this.modifiedProperties[0] instanceof paragraph_format_1.WParagraphFormat) {
                ...
                if (this.action === 'StyleName' && this.modifiedProperties[0] instanceof paragraph_format_1.WParagraphFormat) {
            ...
            else if (this.action === 'LinkToPrevious' && this.modifiedProperties[0] instanceof section_format_1.WSectionFormat) {
            ...
            else if (this.modifiedProperties[0] instanceof section_format_1.WSectionFormat) {
            ...
            else if (this.modifiedProperties[0] instanceof index_3.ImageSizeInfo) {
                this.owner.selection.updateImageSize(this.modifiedProperties[0]);
            }
            else if (this.modifiedProperties[0] instanceof history_helper_1.ModifiedLevel) {
                var modified = new dictionary_1.Dictionary();
            ...
            else if (this.modifiedProperties[0] instanceof index_4.WTableFormat) {
                this.owner.editorModule.updateTableFormat(this.owner.selection, property, undefined);
            }
            else if (this.modifiedProperties[0] instanceof index_4.WCellFormat) {
                this.owner.isShiftingEnabled = true;
                this.owner.editorModule.updateCellFormat(this.owner.selection, property, undefined);
            }
            else if (this.modifiedProperties[0] instanceof index_4.WRowFormat) {
        ...
        BaseHistoryInfo.prototype.addModifiedCellOptions = function (applyFormat, format, table) {
            var currentFormat;
            if (ej2_base_1.isNullOrUndefined(applyFormat.bottomMargin) && ej2_base_1.isNullOrUndefined(applyFormat.topMargin)
                && ej2_base_1.isNullOrUndefined(applyFormat.rightMargin) && ej2_base_1.isNullOrUndefined(applyFormat.leftMargin)) {
        ...
        BaseHistoryInfo.prototype.copyCellOptions = function (format) {
            var cellFormat = new index_4.WCellFormat();
        ...
        BaseHistoryInfo.prototype.copyTableOptions = function (format) {
            var tableFormat = new index_4.WTableFormat();
        ...
        BaseHistoryInfo.prototype.addModifiedTableProperties = function (format, property, value) {
            if (this.editorHistory.isUndoing || this.editorHistory.isRedoing) {
                ...
                var currentFormat = new index_4.WTableFormat();
                currentFormat.copyFormat(format);
                this.modifiedProperties.push(currentFormat);
            }
            return value;
        ...
        BaseHistoryInfo.prototype.addModifiedRowProperties = function (rowFormat, property, value) {
            if (this.editorHistory.isUndoing || this.editorHistory.isRedoing) {
                ...
                var currentFormat = new index_4.WRowFormat();
        ...
        BaseHistoryInfo.prototype.addModifiedCellProperties = function (cellFormat, property, value) {
            if (this.editorHistory.isUndoing || this.editorHistory.isRedoing) {
                ...
                var currentFormat = new index_4.WCellFormat();
        ...
        BaseHistoryInfo.prototype.destroy = function () {
            ...
            this.insertPosition = undefined;
            this.endPosition = undefined;
            if (!ej2_base_1.isNullOrUndefined(this.modifiedNodeLength)) {
                this.modifiedNodeLength = [];
                this.modifiedNodeLength = undefined;
            }
            if (!ej2_base_1.isNullOrUndefined(this.modifiedProperties)) {
                for (var i = 0; i < this.modifiedProperties.length; i++) {
                    var property = this.modifiedProperties[i];
                    if (property instanceof character_format_1.WCharacterFormat) {
                        property.destroy();
                    }
                    else if (property instanceof paragraph_format_1.WParagraphFormat) {
                        property.destroy();
                    }
                    else if (property instanceof section_format_1.WSectionFormat) {
                        property.destroy();
                    }
                    else if (property instanceof history_helper_1.ModifiedLevel) {
                        property.destroy();
                    }
            ...
            if (!ej2_base_1.isNullOrUndefined(this.removedNodes)) {
                for (var i = 0; i < this.removedNodes.length; i++) {
                    var node = this.removedNodes[i];
                    if (node instanceof page_1.ParagraphWidget) {
                        node.destroyInternal(this.viewer);
                    }
                    else if (node instanceof page_2.ElementBox && !(node instanceof page_2.CommentCharacterElementBox)) {
                        node.destroy();
                    }
            ...
            if (!ej2_base_1.isNullOrUndefined(this.insertedNodes)) {
        ...
        BaseHistoryInfo.prototype.getDeleteOperationsForTrackChanges = function () {
            ...
            for (var i = this.removedNodes.length - 1; i >= 0; i--) {
                ...
                if (!ej2_base_1.isNullOrUndefined(operation)) {
        ...
        BaseHistoryInfo.prototype.getDeleteOperationForTrackChanges = function (element) {
            var operation;
            if (element instanceof page_1.TextElementBox || element instanceof page_1.ImageElementBox || element instanceof page_1.FieldElementBox || element instanceof page_1.BookmarkElementBox) {
                        ...
                        if (revision.author !== currentUser) {
                            ...
                            if (element.removedIds.length > 0) {
                                for (var i = 0; i < element.removedIds.length; i++) {
                                    if (!ej2_base_1.isNullOrUndefined(operation.markerData.removedIds)) {
            ...
            else if (element instanceof page_1.ParagraphWidget) {
            ...
            if (this.action !== 'Enter' && !(element instanceof page_1.ParagraphWidget) && (ej2_base_1.isNullOrUndefined(operation) || operation.action !== 'Delete')) {
        ...
        BaseHistoryInfo.prototype.getActionInfo = function (isInvertOperation) {
            ...
            if (!ej2_base_1.isNullOrUndefined(this.isAcceptOrReject) && this.isAcceptOrReject === 'Reject') {
            ...
            switch (action.toString()) {
                ...
                case 'SectionBreak':
                case 'SectionBreakContinuous':
                    if (this.removedNodes.length > 0 && ej2_base_1.isNullOrUndefined(this.dropDownIndex)) {
                    ...
                    if ((action === 'Enter' || this.insertedText.length > 0)) {
                        if (!this.editorHistory.isUndoing && (!this.editorHistory.isRedoing || action === 'Enter')) {
                            ...
                            if (this.owner.enableTrackChanges && this.action !== 'Enter') {
                                if (this.insertedElement instanceof page_1.FootnoteElementBox) {
                                    operation_1.markerData = this.markerData[0];
                                    this.markerData.splice(0, 1);
                                    operation_1.text = types_1.CONTROL_CHARACTERS.Marker_Start;
                                ...
                                for (var i = 0; i < this.splittedRevisions.length; i++) {
                                    if (ej2_base_1.isNullOrUndefined(operation_1.markerData)) {
                                        operation_1.markerData = {};
                                    }
                                    if (ej2_base_1.isNullOrUndefined(operation_1.markerData.splittedRevisions)) {
                    ...
                    if (action === 'Insert' && !ej2_base_1.isNullOrUndefined(operation2.text)) {
                        operation2.length = operation2.text.length;
                    }
                    if (!ej2_base_1.isNullOrUndefined(this.dropDownIndex)) {
                ...
                case 'RemoveEditRange':
                    if (this.editorHistory.isUndoing) {
                        if (action == "DeleteBookmark" || action == "RemoveEditRange") {
                            this.startIndex -= 1;
                            this.insertIndex = this.startIndex;
                            this.insertedText = types_1.CONTROL_CHARACTERS.Marker_Start;
                            operations.push(this.getInsertOperation(action));
                            this.insertedText = types_1.CONTROL_CHARACTERS.Marker_End;
                        ...
                        if (this.cellOperation.length > 0) {
                            ...
                            if (this.removedNodes.length > 0) {
                                if (this.owner.enableTrackChanges) {
                                    ...
                                    for (var i = 0; i < this.removedNodes.length; i++) {
                                        var element = this.removedNodes[i];
                                        if (element instanceof page_1.BodyWidget) {
                                    ...
                                    if (action === 'DeleteBookmark' || action === 'RemoveEditRange') {
                                        ...
                                        if (action === 'RemoveEditRange') {
                                            var operation_3 = operations[operations.length - 1];
                                            operation_3.offset -= 1;
                                        }
                                    }
                                }
                            }
                ...
                case 'EditComment':
                    for (var i = 0; i < this.removedNodes.length; i++) {
                        var operation_4 = this.getUpdateOperation();
                        operations.push(this.getCommentOperation(operation_4, action, this.removedNodes[i]));
                    }
                    break;
                case 'ClearRevisions':
                    ...
                    if (this.removedNodes.length > 0) {
                        ...
                        if (action === 'TrackingPageBreak') {
                            if (!(typeof this.removedNodes[0] === 'string')) {
                                var operation_5 = this.getDeleteOperation(action);
                                operation_5.markerData.isAcceptOrReject = 'Reject';
                        ...
                        if (revision.revisionType === 'Insertion') {
                            ...
                            var operation_7 = this.getFormatOperation();
                            operations.push(operation_7);
                        }
                    }
                    break;
                case 'Reject Change':
                ...
                case 'Paste':
                    if (this.editorHistory.isUndoing || this.editorHistory.isRedoing) {
                        ...
                        if (this.removedNodes.length > 0) {
                            for (var i = this.removedNodes.length - 1; i >= 0; i--) {
                                if (this.removedNodes[i] instanceof page_1.ParagraphWidget) {
                                    isTextRemoved = true;
                                }
                                else {
                                    isTextRemoved = false;
                ...
                case 'UpdateFormField':
                    ...
                    operation1.text = types_1.CONTROL_CHARACTERS.Marker_Start;
                ...
                case 'RemoveRowTrack':
                    if (this.removedNodes.length > 0) {
                        if (this.removedNodes[0] instanceof page_1.TableWidget) {
                            operations = this.cellOperation.slice();
                        }
                    }
                    break;
                ...
                case 'List':
                    ...
                    if (action === 'Borders' && this.removedNodes[this.removedNodes.length - 1] instanceof page_1.TableWidget) {
                        this.insertedText = types_1.CONTROL_CHARACTERS.Cell;
                ...
                case 'LinkToPrevious':
                    ...
                    if (action === 'LinkToPrevious') {
                        ...
                        operation_8.offset = this.insertIndex;
                    }
                    break;
                case 'RowHeight':
                case 'RowHeightType':
                ...
                do {
                    ...
                    if (element instanceof page_1.FieldElementBox) {
                        if (element.fieldType === 0 && this.getRemovedText() !== '') {
                            operations.push(this.getDeleteOperation('Delete'));
                            var operation_9 = operations[operations.length - 1];
                            operation_9.offset = elementOffset;
                            if (!ej2_base_1.isNullOrUndefined(operation_9.markerData) && this.owner.enableTrackChanges) {
                                operation_9.markerData.isSkipTracking = true;
                            }
                        }
                        insertedText = element.fieldType === 0 ? types_1.CONTROL_CHARACTERS.Marker_Start : element.fieldType === 1 ? types_1.CONTROL_CHARACTERS.Marker_End : element.fieldType === 2 ? types_1.CONTROL_CHARACTERS.Field_Separator : '';
                    ...
                    else if (this.fieldBegin.formFieldData && element instanceof page_1.BookmarkElementBox) {
                        insertedText = element.bookmarkType === 0 ? types_1.CONTROL_CHARACTERS.Marker_Start : types_1.CONTROL_CHARACTERS.Marker_End;
                    ...
                    if (!(element instanceof page_1.BookmarkElementBox)) {
                        var characterData = {};
                        editor_helper_1.HelperMethods.writeCharacterFormat(characterData, true, element.characterFormat, undefined, true);
                    ...
                    if (element instanceof page_1.FieldElementBox && element.fieldType === 1) {
                        isFieldEnd = true;
                        if (this.fieldBegin.formFieldData && element.nextNode instanceof page_1.BookmarkElementBox) {
                            var elementBox = element.nextNode;
                            insertedText = elementBox.bookmarkType === 0 ? types_1.CONTROL_CHARACTERS.Marker_Start : types_1.CONTROL_CHARACTERS.Marker_End;
                            ...
                            operations.push(operation_10);
                        }
                    }
                    element = element.nextNode;
                } while (!isFieldEnd && !ej2_base_1.isNullOrUndefined(element));
            }
            return operations;
        };
        BaseHistoryInfo.prototype.getDeleteContent = function (action) {
            var operations = [];
            var startPosition = this.owner.selection.getTextPosBasedOnLogicalIndex(this.collabStart);
            var endPosition = this.owner.selection.getTextPosBasedOnLogicalIndex(this.collabEnd);
        ...
        BaseHistoryInfo.prototype.getPasteContentLength = function () {
            ...
            for (var i = 0; i < this.insertedNodes.length; i++) {
                ...
                if (block instanceof page_1.TextElementBox) {
                    length += block.length;
                }
                else {
        ...
        BaseHistoryInfo.prototype.getResizingOperation = function (action) {
            ...
            if (!ej2_base_1.isNullOrUndefined(table.childWidgets)) {
                ...
                if (action == 'RowResizing') {
                    ...
                    for (var i = 0; i < row.childWidgets.length; i++) {
                        length_1 += this.owner.selection.calculateCellLength(row.childWidgets[i]) + 1;
                    }
                    this.endIndex = this.startIndex;
                    this.endIndex += length_1;
                    var rowFormat = {};
                    ...
                    this.insertedText = types_1.CONTROL_CHARACTERS.Row;
                    operations.push(this.getFormatOperation());
                }
                else {
        ...
        BaseHistoryInfo.prototype.getDeleteOperation = function (action, setEndIndex, text) {
            if (this.startIndex > this.endIndex) {
                _a = [this.endIndex, this.startIndex], this.startIndex = _a[0], this.endIndex = _a[1];
            }
            ...
            var selectionLength = !ej2_base_1.isNullOrUndefined(text) ? text.length : this.endIndex - this.startIndex;
            var removedText;
            if (action === 'DeleteBookmark' || action === 'RemoveEditRange') {
                ...
                removedText = !ej2_base_1.isNullOrUndefined(text) ? text : this.getRemovedText();
            }
            ...
            if (this.removedNodes[0] instanceof page_1.FootnoteElementBox) {
        ...
        BaseHistoryInfo.prototype.getInsertOperation = function (action, setEndIndex) {
            ...
            if (action === 'InsertTable' || action === 'InsertTableBelow' || action === 'InsertRowAbove' || action === 'InsertRowBelow'
                ...
                if (!ej2_base_1.isNullOrUndefined(insertedText)) {
            ...
            if (!ej2_base_1.isNullOrUndefined(this.markerData)) {
        ...
        BaseHistoryInfo.prototype.getUndoRedoOperation = function (isTableInsert, issamePosition) {
            var table;
            var lastPara;
            var startLine;
            var lastLine;
            ...
            var startOffset;
            if (isTableInsert) {
                table = this.owner.selection.start.paragraph.associatedCell.ownerTable.combineWidget(this.owner.viewer);
        ...
        BaseHistoryInfo.prototype.buildTableRowCellOperation = function (action) {
            ...
            if (this.insertedNodes.length > 0) {
                if (this.insertedNodes[0] instanceof page_1.TableRowWidget) {
                ...
                for (var i = 0; i < this.insertedNodes.length; i++) {
                    ...
                    else if (this.insertedNodes[i] instanceof page_1.TableRowWidget) {
                    ...
                    else if (this.insertedNodes[i] instanceof page_1.TableCellWidget) {
        ...
        BaseHistoryInfo.prototype.afterInsertTableRrevision = function () {
            ...
            for (var i = 0; i < table.childWidgets.length; i++) {
                ...
                var length_4 = 0;
                for (var j = 0; j < row.childWidgets.length; j++) {
                    length_4 += this.owner.selection.calculateCellLength(row.childWidgets[j]) + 1;
                }
                this.tableRelatedLength = length_4 + 1;
                this.insertedText = types_1.CONTROL_CHARACTERS.Row;
                var paragraphInfo = { 'paragraph': null, 'offset': 0 };
        ...
        BaseHistoryInfo.prototype.buildRowOperation = function (row, action) {
            ...
            if (row.rowFormat.revisions.length > 0) {
                ...
                if (!(!ej2_base_1.isNullOrUndefined(lastRevision) && lastRevision.revisionId === revision.revisionID)) {
                    this.markerData.push(this.owner.editor.getMarkerData(undefined, undefined, revision));
                }
            }
            this.tableRelatedLength = 1;
        ...
        BaseHistoryInfo.prototype.buildCellOperation = function (cell, action, isCellInserted) {
            ...
            this.insertedText = types_1.CONTROL_CHARACTERS.Cell;
            this.type = 'CellFormat';
            var cellFormat = !ej2_base_1.isNullOrUndefined(this.owner.sfdtExportModule) ? this.owner.sfdtExportModule.writeCellFormat(cell.cellFormat, 0) : {};
            this.format = JSON.stringify(cellFormat);
            operations.push(this.getInsertOperation(action));
            if (!isCellInserted) {
                return operations;
            ...
            editor_helper_1.HelperMethods.writeParagraphFormat(paragraphFormat, true, cell.childWidgets[0].paragraphFormat);
            this.format = JSON.stringify(paragraphFormat);
            operations.push(this.getInsertOperation(action));
            var characterFormat = {};
            this.tableRelatedLength = 0;
            this.type = 'CharacterFormat';
            editor_helper_1.HelperMethods.writeCharacterFormat(characterFormat, true, cell.childWidgets[0].characterFormat);
        ...
        BaseHistoryInfo.prototype.deleteColumnOperation = function (action) {
            ...
            if (action === 'DeleteColumn') {
                ...
                var start = this.owner.selection.getCellLeft(startCell.ownerRow, startCell);
                var end = start + startCell.cellFormat.cellWidth;
                var endCellLeft = this.owner.selection.getCellLeft(endCell.ownerRow, endCell);
                var endCellRight = endCellLeft + endCell.cellFormat.cellWidth;
                var cellInfo = this.owner.editor.updateSelectedCellsInTable(start, end, endCellLeft, endCellRight);
                ...
                for (var i = rowStartIndex; i <= count; i++) {
                    ...
                    for (var j = 0; j < row.childWidgets.length; j++) {
                        var cell = row.childWidgets[j];
                        var cellStart = this.owner.selection.getCellLeft(row, cell);
                        if (editor_helper_1.HelperMethods.round(start, 2) <= editor_helper_1.HelperMethods.round(cellStart, 2)
                            && editor_helper_1.HelperMethods.round(cellStart, 2) < editor_helper_1.HelperMethods.round(end, 2)) {
                            deleteCells.push(cell);
                        }
                    }
                }
            }
            var isRowSelect = this.owner.selection.isRowSelect() && rowStartIndex != count;
        ...
        BaseHistoryInfo.prototype.getPasteMergeOperation = function () {
            ...
            var length = this.owner.selection.calculateCellLength(cell) - 1;
        ...
        BaseHistoryInfo.prototype.deleteCell = function (action, cell, isRowDelete) {
            ...
            if (!this.owner.enableTrackChanges) {
                if (action === 'ClearCells') {
                    ...
                    if (cell.childWidgets.length === 1 && block instanceof page_1.ParagraphWidget && block.isEmpty()) {
                        return;
                    }
        ...
        BaseHistoryInfo.prototype.getFormatOperation = function (element, action) {
            ...
            if (action === 'RemoveRowTrack') {
                ...
                length = !ej2_base_1.isNullOrUndefined(element) ? element.length : this.endIndex - this.startIndex;
            }
            var formatOperation = {
                action: 'Format',
                offset: this.startIndex,
        ...
        BaseHistoryInfo.prototype.getRemovedText = function (element) {
            ...
            if (!ej2_base_1.isNullOrUndefined(element)) {
                ...
                else if (node instanceof page_2.ElementBox) {
                    if (node instanceof page_1.TextElementBox) {
                        text += node.text;
                    }
                    else {
                        text += page_2.ElementBox.objectCharacter;
                    }
                }
                else if (node instanceof page_1.TableWidget) {
                    text += this.getTableText(node);
                }
                else if (node instanceof page_1.TableRowWidget) {
        ...
        BaseHistoryInfo.prototype.getRemovedFieldCode = function () {
            ...
            for (var i = this.removedNodes.length - 1; i >= 0; i--) {
                var node = this.removedNodes[i];
                if (node instanceof page_2.ElementBox) {
                    if (node instanceof page_1.FieldElementBox && node.fieldType === 0) {
                        isStarted = true;
                    }
                    if (node && node instanceof page_1.TextElementBox) {
                        if (isStarted) {
                            fieldCode += node.text;
                        }
                    }
                    if (node instanceof page_1.FieldElementBox
                        && (node.fieldType === 2 || node.fieldType === 1)) {
                        return fieldCode;
                    }
                }
                else if (node instanceof page_1.ParagraphWidget) {
        ...
        BaseHistoryInfo.prototype.getParagraphText = function (paragraph) {
            var text = '';
            if (!ej2_base_1.isNullOrUndefined(paragraph) && !ej2_base_1.isNullOrUndefined(paragraph.childWidgets)) {
                for (var i = 0; i < paragraph.childWidgets.length; i++) {
                    var line = paragraph.childWidgets[i];
                    for (var j = 0; j < line.children.length; j++) {
                        if (line.children[j] instanceof page_1.TextElementBox) {
        ...
        BaseHistoryInfo.prototype.getCommentOperation = function (operation, action, comment) {
            if (action === 'InsertInline' || action === 'RemoveInline') {
                ...
                operation.text = commentRangeElement.commentType === 0 ? types_1.CONTROL_CHARACTERS.Marker_Start : types_1.CONTROL_CHARACTERS.Marker_End;
                ...
                operation.text = types_1.CONTROL_CHARACTERS.Marker_Start + types_1.CONTROL_CHARACTERS.Marker_End;
                operation.markerData = {
                    type: 'Comment',
                ...
                if (!ej2_base_1.isNullOrUndefined(comment.ownerComment)) {
        ...
        BaseHistoryInfo.prototype.getDeleteCommentOperation = function (modifiedActions, operations) {
            for (var i = 0; i < modifiedActions.length; i++) {
                ...
                if (currentHistory instanceof index_1.HistoryInfo && (currentHistory.action === 'DeleteComment')) {
        ...
        BaseHistoryInfo.prototype.buildFormatOperation = function (action, ischarFormat) {
            var operations = [];
            if ((action === 'ApplyStyle' || action === 'StyleName') && this.insertedFormat instanceof index_4.WParagraphStyle) {
        ...
        BaseHistoryInfo.prototype.getSelectedCellOperation = function (action, ischarFormat, isBorder, isShading) {
            ...
            if (start.paragraph.isInsideTable && end.paragraph.isInsideTable && (start.paragraph.associatedCell.ownerTable.equals(end.paragraph.associatedCell.ownerTable)
                ...
                for (var i = 0; i < selectCells.length; i++) {
                    ...
                    var length_5 = this.owner.selection.calculateCellLength(cell) - 1;
                    this.endIndex = this.startIndex + length_5;
                    if (length_5 === 0 && ischarFormat) {
                        continue;
                    }
                    var cellFormat = {};
                    if (isBorder) {
                        cellFormat['borders'] = editor_helper_1.HelperMethods.writeBorders(cell.cellFormat.borders, 0);
                        this.format = JSON.stringify(cellFormat);
                    }
                    if (isShading) {
        ...
        BaseHistoryInfo.prototype.createListFormat = function (action, operation) {
            ...
            if (listId > -1) {
                ...
                if (!ej2_base_1.isNullOrUndefined(this.owner.sfdtExportModule)) {
                    ...
                    listData[index_2.listsProperty[this.owner.sfdtExportModule.keywordIndex]] = [];
                    listData[index_2.listsProperty[this.owner.sfdtExportModule.keywordIndex]].push(this.owner.sfdtExportModule.writeList(list));
                    listData[index_2.abstractListsProperty[this.owner.sfdtExportModule.keywordIndex]] = [];
                    if (!ej2_base_1.isNullOrUndefined(list)) {
                        listData[index_2.abstractListsProperty[this.owner.sfdtExportModule.keywordIndex]].push(this.owner.sfdtExportModule.writeAbstractList(list.abstractList));
                    }
                    if (action == 'RestartNumbering') {
                        listData[index_2.listIdProperty[this.owner.sfdtExportModule.keywordIndex]] = listId;
                        listData[index_2.nsidProperty] = nsid;
                    }
                }
        ...
        BaseHistoryInfo.prototype.createParagraphFormat = function (action) {
            ...
            if (action === 'ParagraphFormat' || action === 'ContinueNumbering') {
                ...
                paragraphFormat['borders'] = editor_helper_1.HelperMethods.writeBorders(this.insertedFormat, 0);
            }
            else {
                if (this.insertedFormat instanceof paragraph_format_1.WParagraphFormat) {
        ...
        BaseHistoryInfo.prototype.createTableFormat = function (action) {
            ...
            this.endIndex = this.startIndex;
            this.endIndex += this.owner.selection.getBlockLength(undefined, this.owner.selection.start.paragraph.associatedCell.ownerTable.combineWidget(this.owner.viewer), 0, { done: false }, true, undefined, undefined) - 1;
            var tableFormat = {};
            if (action === 'TableFormat') {
                var tabFormat = this.insertedFormat;
                if (!ej2_base_1.isNullOrUndefined(tabFormat)) {
                ...
                if (!ej2_base_1.isNullOrUndefined(tableOption)) {
                ...
                tableFormat = !ej2_base_1.isNullOrUndefined(this.owner.sfdtExportModule) ? this.owner.sfdtExportModule.writeTableFormat(tabBorderFormat, 0) : {};
            }
            else {
        ...
        BaseHistoryInfo.prototype.createRowFormat = function (action) {
            ...
            if (action === 'RowFormat') {
                ...
                if (!ej2_base_1.isNullOrUndefined(rForamt)) {
        ...
        BaseHistoryInfo.prototype.createCellFormat = function (action) {
            ...
            if (action === 'CellFormat') {
                ...
                cellFormat[this.getCellString(action)] = !ej2_base_1.isNullOrUndefined(this.owner.sfdtExportModule) ? this.owner.sfdtExportModule.writeShading(this.insertedFormat, 0) : {};
            }
            else if (action === 'Borders') {
                cellFormat['borders'] = editor_helper_1.HelperMethods.writeBorders(this.insertedFormat, 0);
            }
            else if (action === 'BordersAndShading') {
                cellFormat['shading'] = !ej2_base_1.isNullOrUndefined(this.owner.sfdtExportModule) ? this.owner.sfdtExportModule.writeShading(this.insertedFormat, 0) : {};
                cellFormat['borders'] = editor_helper_1.HelperMethods.writeBorders(this.insertedFormat.borders, 0);
            }
            else {
    ...
    exports.BaseHistoryInfo = BaseHistoryInfo;
});
