            ...
            switch (action) {
                ...
                case 'RemoveHyperlink':
                    for (var i = 0; i < this.modifiedActions.length; i++) {
                        ...
                        if (currentHistory.action === 'InsertInline') {
                            if (currentHistory.insertedText === types_1.CONTROL_CHARACTERS.Marker_Start || currentHistory.insertedText === types_1.CONTROL_CHARACTERS.Marker_End) {
                ...
                case 'InsertComment':
                    if (this.editorHistory.isUndoing) {
                        ...
                        for (var i_8 = 0; i_8 < this.modifiedActions.length; i_8++) {
                            ...
                            if ((currentHistory_6.insertedElement instanceof page_1.CommentCharacterElementBox && currentHistory_6.action === 'InsertInline')) {
                ...
                case 'RemoveComment':
                    if (this.editorHistory.isUndoing) {
                        for (var i_9 = this.modifiedActions.length - 1; i_9 >= 0; i_9--) {
                            ...
                            if (currentHistory_7.action === 'InsertInline' && currentHistory_7.insertedElement instanceof page_1.CommentCharacterElementBox) {
                        ...
                        for (var i_10 = 0; i_10 < this.modifiedActions.length; i_10++) {
                            ...
                            var operationCollection = [];
                            if (currentHistory_8.action === 'RemoveInline' && currentHistory_8.removedNodes[0] instanceof page_1.CommentCharacterElementBox) {
                            ...
                            else if (currentHistory_8.action === 'InsertInline' && currentHistory_8.insertedElement instanceof page_1.CommentCharacterElementBox) {
                ...
                case 'Reject All':
                    ...
                    for (var i_12 = 0; i_12 < this.modifiedActions.length; i_12++) {
                        ...
                        if (!ej2_base_1.isNullOrUndefined(currentHistory_10.cellOperation) && currentHistory_10.cellOperation.length > 0) {
