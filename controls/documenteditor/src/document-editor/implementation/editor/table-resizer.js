define(["require", "exports", "../index", "@syncfusion/ej2-base", "./editor-helper"], function (require, exports, index_1, ej2_base_1, editor_helper_1) {
    "use strict";
    ...
    var TableResizer = (function () {
        function TableResizer(node) {
            ...
            this.startingPoint = new editor_helper_1.Point(0, 0);
        }
        ...
        TableResizer.prototype.getCellReSizerPosition = function (touchPoint) {
            ...
            var cellSpacing = ej2_base_1.isNullOrUndefined(tableWidget) ? 0 : tableWidget.tableFormat.cellSpacing;
            if (tableWidget && cellSpacing > 0) {
                this.currentResizingTable = tableWidget;
                if (this.documentHelper.isInsideRect(tableWidget.x - editor_helper_1.HelperMethods.convertPointToPixel(tableWidget.leftBorderWidth) - 0.25, tableWidget.y, editor_helper_1.HelperMethods.convertPointToPixel(tableWidget.leftBorderWidth) + 0.5, tableWidget.height, touchPoint)) {
                    return position = 0;
                }
                var startingPointX = tableWidget.x;
                for (var i = 0; i < tableWidget.tableHolder.columns.length; i++) {
                    var preferredWidth = editor_helper_1.HelperMethods.convertPointToPixel(tableWidget.tableHolder.columns[parseInt(i.toString(), 10)].preferredWidth);
                ...
                if (!ej2_base_1.isNullOrUndefined(cellWidget)) {
                    ...
                    else if (ej2_base_1.isNullOrUndefined(cellWidget.nextRenderedWidget)
        ...
        TableResizer.prototype.getCellReSizerPositionInternal = function (cellWidget, touchPoint) {
            ...
            if (!ej2_base_1.isNullOrUndefined(childTableWidget) && childTableWidget.tableFormat.cellSpacing > 0) {
                ...
                for (var i = 0; i < childTableWidget.tableHolder.columns.length; i++) {
                    var preferredWidth = editor_helper_1.HelperMethods.convertPointToPixel(childTableWidget.tableHolder.columns[parseInt(i.toString(), 10)].preferredWidth);
                ...
                if (!ej2_base_1.isNullOrUndefined(childTableWidget)) {
                    childCellWidget = childTableWidget.getTableCellWidget(touchPoint);
                }
                if (!ej2_base_1.isNullOrUndefined(childCellWidget)) {
                    ...
                    else if (ej2_base_1.isNullOrUndefined(childCellWidget.nextRenderedWidget)
        ...
        TableResizer.prototype.getRowReSizerPosition = function (widget, touchPoint) {
            ...
            if (tableWidget && cellSpacing > 0) {
                this.currentResizingTable = tableWidget;
                if (this.owner.documentHelper.isInsideRect(tableWidget.x, tableWidget.y + tableWidget.height - cellSpacing, this.getActualWidth(tableWidget.lastChild), (ej2_base_1.isNullOrUndefined(tableWidget.nextSplitWidget) ? tableWidget.bottomBorderWidth + cellSpacing : 0), touchPoint)) {
        ...
        TableResizer.prototype.resizeTableRow = function (dragValue) {
            ...
            if (ej2_base_1.isNullOrUndefined(table) || dragValue === 0 || this.resizerPosition === -1) {
                return;
            }
            ...
            this.startingPoint.y += editor_helper_1.HelperMethods.convertPointToPixel(dragValue);
        ...
        TableResizer.prototype.getTableWidget = function (cursorPoint) {
            ...
            if (!ej2_base_1.isNullOrUndefined(currentPage)) {
        ...
        TableResizer.prototype.getTableWidgetFromWidget = function (point, widget) {
            for (var j = 0; j < widget.childWidgets.length; j++) {
                if (widget.childWidgets[parseInt(j.toString(), 10)] instanceof index_1.TableWidget) {
        ...
        TableResizer.prototype.resizeTableCellColumn = function (dragValue) {
            var table = this.currentResizingTable;
            if (ej2_base_1.isNullOrUndefined(table) || dragValue === 0 || ej2_base_1.isNullOrUndefined(table.childWidgets) || this.resizerPosition < 0) {
                return;
            }
            ...
            if (this.resizerPosition === 0) {
                ...
                if (dragValue > 0) {
                    ...
                    do {
                        var newWidth = editor_helper_1.HelperMethods.round(rightColumn.preferredWidth - dragValue, 1);
        ...
        TableResizer.prototype.resizeColumnAtLastColumnIndex = function (table, dragValue, containerWidth) {
            ...
            var prevDragValue = 0;
            while (dragValue !== prevDragValue) {
                var newWidth = editor_helper_1.HelperMethods.round(leftColumn.preferredWidth + dragValue, 1);
        ...
        TableResizer.prototype.updateGridValue = function (table, isUpdate, dragValue) {
            ...
            this.owner.editorModule.isSkipOperationsBuild = false;
            if (dragValue) {
                this.startingPoint.x += editor_helper_1.HelperMethods.convertPointToPixel(dragValue);
        ...
        TableResizer.prototype.applyProperties = function (table, tableHistoryInfo) {
            if (ej2_base_1.isNullOrUndefined(tableHistoryInfo)) {
                return;
            }
