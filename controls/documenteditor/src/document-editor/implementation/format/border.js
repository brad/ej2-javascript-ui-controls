define(["require", "exports", "../../base/dictionary", "../../base/unique-format", "../../base/unique-formats", "@syncfusion/ej2-base"], function (require, exports, dictionary_1, unique_format_1, unique_formats_1, ej2_base_1) {
    "use strict";
    ...
    var WBorder = (function () {
        ...
        WBorder.prototype.getPropertyValue = function (property) {
            ...
            if (hasValue) {
                var propertyType = unique_format_1.WUniqueFormat.getPropertyType(WBorder.uniqueFormatType, property);
                if (!ej2_base_1.isNullOrUndefined(this.uniqueBorderFormat)) {
        ...
        WBorder.prototype.setPropertyValue = function (property, value) {
            ...
            if (ej2_base_1.isNullOrUndefined(this.uniqueBorderFormat)) {
                ...
                var propertyType = unique_format_1.WUniqueFormat.getPropertyType(this.uniqueBorderFormat.uniqueFormatType, property);
        ...
        WBorder.prototype.initializeUniqueBorder = function (property, propValue) {
            var uniqueBorderFormatTemp = new dictionary_1.Dictionary();
        ...
        WBorder.prototype.copyFormat = function (border) {
            if (!ej2_base_1.isNullOrUndefined(border) && !ej2_base_1.isNullOrUndefined(border.uniqueBorderFormat)) {
    ...
    WBorder.uniqueBorderFormats = new unique_formats_1.WUniqueFormats();
    WBorder.uniqueFormatType = 1;
    exports.WBorder = WBorder;
});
