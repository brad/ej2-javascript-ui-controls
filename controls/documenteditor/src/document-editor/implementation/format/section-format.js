define(["require", "exports", "@syncfusion/ej2-base", "../../base/dictionary", "../../base/unique-format", "../../base/unique-formats"], function (require, exports, ej2_base_1, dictionary_1, unique_format_1, unique_formats_1) {
    "use strict";
    ...
    var WSectionFormat = (function () {
        ...
        WSectionFormat.prototype.destroy = function () {
            if (!ej2_base_1.isNullOrUndefined(this.uniqueSectionFormat)) {
        ...
        WSectionFormat.prototype.hasValue = function (property) {
            if (!ej2_base_1.isNullOrUndefined(this.uniqueSectionFormat)) {
                var propertyType = unique_format_1.WUniqueFormat.getPropertyType(this.uniqueSectionFormat.uniqueFormatType, property);
        ...
        WSectionFormat.prototype.getPropertyValue = function (property) {
            ...
            if (hasValue) {
                var propertyType = unique_format_1.WUniqueFormat.getPropertyType(WSectionFormat.uniqueFormatType, property);
                if (!ej2_base_1.isNullOrUndefined(this.uniqueSectionFormat) && this.uniqueSectionFormat.propertiesHash.containsKey(propertyType)) {
        ...
        WSectionFormat.prototype.initializeUniqueSectionFormat = function (property, propValue) {
            var uniqueSectionFormatTemp = new dictionary_1.Dictionary();
        ...
        WSectionFormat.prototype.copyFormat = function (format, history) {
            if (history && (history.isUndoing || history.isRedoing)) {
                ...
                if (!ej2_base_1.isNullOrUndefined(format)) {
                    this.removedHeaderFooters = format.removedHeaderFooters;
                    if (!ej2_base_1.isNullOrUndefined(format.uniqueSectionFormat) && format.uniqueSectionFormat.propertiesHash) {
        ...
        WSectionFormat.prototype.updateUniqueSectionFormat = function (format) {
            ...
            this.uniqueSectionFormat = new unique_format_1.WUniqueFormat(WSectionFormat.uniqueFormatType);
    ...
    WSectionFormat.uniqueSectionFormats = new unique_formats_1.WUniqueFormats();
    WSectionFormat.uniqueFormatType = 10;
    exports.WSectionFormat = WSectionFormat;
    var WColumnFormat = (function () {
        function WColumnFormat(node) {
            this.uniqueColumnFormat = undefined;
            this.ownerBase = node;
        }
        WColumnFormat.prototype.destroy = function () {
            if (!ej2_base_1.isNullOrUndefined(this.uniqueColumnFormat)) {
        ...
        WColumnFormat.prototype.hasValue = function (property) {
            if (!ej2_base_1.isNullOrUndefined(this.uniqueColumnFormat)) {
                var propertyType = unique_format_1.WUniqueFormat.getPropertyType(this.uniqueColumnFormat.uniqueFormatType, property);
        ...
        WColumnFormat.prototype.getPropertyValue = function (property) {
            var hasValue = this.hasValue(property);
            if (hasValue) {
                var propertyType = unique_format_1.WUniqueFormat.getPropertyType(WColumnFormat.uniqueFormatType, property);
                if (!ej2_base_1.isNullOrUndefined(this.uniqueColumnFormat) && this.uniqueColumnFormat.propertiesHash.containsKey(propertyType)) {
        ...
        WColumnFormat.prototype.initializeUniqueColumnFormat = function (property, propValue) {
            var uniqueColumnFormatTemp = new dictionary_1.Dictionary();
        ...
        WColumnFormat.prototype.updateUniqueColumnFormat = function (format) {
            ...
            this.uniqueColumnFormat = new unique_format_1.WUniqueFormat(WColumnFormat.uniqueFormatType);
            if (ej2_base_1.isNullOrUndefined(hash)) {
                hash = this.uniqueColumnFormat.mergeProperties(format.uniqueColumnFormat);
            }
        ...
        WColumnFormat.prototype.copyFormat = function (colFormat) {
            if (!ej2_base_1.isNullOrUndefined(colFormat) && !ej2_base_1.isNullOrUndefined(colFormat.uniqueColumnFormat)) {
    ...
    WColumnFormat.uniqueColumnFormats = new unique_formats_1.WUniqueFormats();
    WColumnFormat.uniqueFormatType = 11;
    exports.WColumnFormat = WColumnFormat;
});
