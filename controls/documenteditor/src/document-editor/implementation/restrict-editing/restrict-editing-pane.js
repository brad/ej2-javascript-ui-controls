define(["require", "exports", "@syncfusion/ej2-base", "@syncfusion/ej2-buttons", "./add-user-dialog", "./enforce-protection-dialog", "../editor/editor-helper", "@syncfusion/ej2-lists", "@syncfusion/ej2-dropdowns"], function (require, exports, ej2_base_1, ej2_buttons_1, add_user_dialog_1, enforce_protection_dialog_1, editor_helper_1, ej2_lists_1, ej2_dropdowns_1) {
    "use strict";
    ...
    var RestrictEditing = (function () {
        function RestrictEditing(documentHelper) {
            ...
            this.addUserDialog = new add_user_dialog_1.AddUserDialog(documentHelper);
            this.enforceProtectionDialog = new enforce_protection_dialog_1.EnforceProtectionDialog(documentHelper, this);
            this.unProtectDialog = new enforce_protection_dialog_1.UnProtectDocumentDialog(documentHelper, this);
            this.base64 = new editor_helper_1.Base64();
        }
        ...
        RestrictEditing.prototype.showHideRestrictPane = function (isShow) {
            if (!this.restrictPane) {
                this.localObj = new ej2_base_1.L10n('documenteditor', this.viewer.owner.defaultLocale);
        ...
        RestrictEditing.prototype.initPane = function (localValue, isRtl) {
            this.restrictPane = ej2_base_1.createElement('div', { className: 'e-de-restrict-pane' });
            if (isRtl) {
                this.restrictPane.classList.add('e-rtl');
            }
            var headerWholeDiv = ej2_base_1.createElement('div', { className: 'e-de-rp-whole-header' });
            var headerDiv1 = ej2_base_1.createElement('div', {
        ...
        RestrictEditing.prototype.initRestrictEditingPane = function (localObj) {
            this.restrictPaneWholeDiv = ej2_base_1.createElement('div');
            var formatWholeDiv = ej2_base_1.createElement('div', { className: 'e-de-rp-sub-div' });
            var formatDiv = ej2_base_1.createElement('div', {
                innerHTML: localObj.getConstant('Formatting restrictions'),
                className: 'e-de-rp-format'
            });
            formatWholeDiv.appendChild(formatDiv);
            var allowFormatting = ej2_base_1.createElement('input', {
                attrs: { type: 'checkbox' },
            });
            ...
            var editRestrictWholeDiv = ej2_base_1.createElement('div', { className: 'e-de-rp-sub-div' });
            var readOnly = ej2_base_1.createElement('input', {
                attrs: { type: 'checkbox' },
            });
            var protectionTypeInput = ej2_base_1.createElement('input', {
            ...
            this.protectionTypeDrop = new ej2_dropdowns_1.DropDownList({
            ...
            this.userWholeDiv = ej2_base_1.createElement('div', { className: 'e-de-rp-sub-div' });
            var userDiv = ej2_base_1.createElement('div', {
                innerHTML: localObj.getConstant('Exceptions Optional'),
                className: 'e-de-rp-format'
            });
            this.userWholeDiv.appendChild(userDiv);
            var subContentDiv = ej2_base_1.createElement('div', {
            ...
            var emptyuserDiv = ej2_base_1.createElement('div', { className: 'e-de-rp-user' });
            this.userWholeDiv.appendChild(emptyuserDiv);
            this.addedUser = new ej2_lists_1.ListView({
            ...
            this.addUser = ej2_base_1.createElement('button', {
            ...
            var lastDiv = ej2_base_1.createElement('div', { className: 'e-de-rp-enforce' });
            this.restrictPaneWholeDiv.appendChild(lastDiv);
            this.enforceProtection = ej2_base_1.createElement('button', {
            ...
            this.stopProtectionDiv = ej2_base_1.createElement('div', { styles: 'display:none' });
            var headerDiv = ej2_base_1.createElement('div', { innerHTML: localObj.getConstant('Your permissions'), className: 'e-de-rp-stop-div1' });
            this.stopProtectionDiv.appendChild(headerDiv);
            var contentWholeDiv = ej2_base_1.createElement('div', { className: 'e-de-rp-stop-div2' });
            this.stopProtectionDiv.appendChild(contentWholeDiv);
            var content1 = localObj.getConstant('Protected Document');
            this.contentDiv1 = ej2_base_1.createElement('div', { innerHTML: content1 });
            contentWholeDiv.appendChild(this.contentDiv1);
            var content2 = localObj.getConstant('ReadOnlyProtection');
            this.contentDiv2 = ej2_base_1.createElement('div', { innerHTML: content2 });
            contentWholeDiv.appendChild(this.contentDiv2);
            this.stopReadOnlyOptions = ej2_base_1.createElement('div');
            this.stopProtectionDiv.appendChild(this.stopReadOnlyOptions);
            var navigateNext = ej2_base_1.createElement('div', { className: 'e-de-rp-enforce-nav' });
            var navigateNextButton = ej2_base_1.createElement('button', {
            ...
            var showAllRegion = ej2_base_1.createElement('div', { className: 'e-de-rp-enforce-nav' });
            var showAllRegionButton = ej2_base_1.createElement('button', {
            ...
            var highlightRegion = ej2_base_1.createElement('div', { className: 'e-de-rp-nav-lbl e-de-rp-more-less' });
            var highlightRegionInput = ej2_base_1.createElement('input', { attrs: { type: 'checkbox' }, className: 'e-btn e-de-rp-nav-btn' });
            highlightRegion.appendChild(highlightRegionInput);
            this.stopReadOnlyOptions.appendChild(highlightRegion);
            this.highlightCheckBox = new ej2_buttons_1.CheckBox({ label: localObj.getConstant('Highlight the regions I can edit'), change: this.changeHighlightOptions.bind(this), enableRtl: this.documentHelper.owner.enableRtl }, highlightRegionInput);
            var lastButtonDiv = ej2_base_1.createElement('div', { className: 'e-de-rp-enforce' });
            this.stopProtection = ej2_base_1.createElement('button', {
        ...
        RestrictEditing.prototype.stopProtectionTriggered = function (args) {
            if ((ej2_base_1.isNullOrUndefined(this.documentHelper.saltValue) || this.documentHelper.saltValue === '')
                && (ej2_base_1.isNullOrUndefined(this.documentHelper.hashValue) || this.documentHelper.hashValue === '')) {
        ...
        RestrictEditing.prototype.createCheckBox = function (label, element) {
            var checkBox = new ej2_buttons_1.CheckBox({ label: label, enableRtl: this.documentHelper.owner.enableRtl });
    ...
    exports.RestrictEditing = RestrictEditing;
});
