define(["require", "exports", "../index", "../index", "../index", "@syncfusion/ej2-base"], function (require, exports, index_1, index_2, index_3, ej2_base_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var TextPosition = (function () {
        function TextPosition(owner) {
            this.location = new index_3.Point(0, 0);
        ...
        Object.defineProperty(TextPosition.prototype, "isCurrentParaBidi", {
            get: function () {
                if (!ej2_base_1.isNullOrUndefined(this.currentWidget.paragraph)) {
        ...
        TextPosition.prototype.setPositionForSelection = function (line, element, index, physicalLocation) {
            ...
            if (ej2_base_1.isNullOrUndefined(element)) {
                ...
                if (element.nextNode instanceof index_1.FieldElementBox && index > element.length) {
        ...
        TextPosition.prototype.setPositionFromLine = function (line, offset, location) {
            this.currentWidget = line;
            this.offset = offset;
            if (location instanceof index_3.Point) {
        ...
        TextPosition.prototype.getLineWidget = function (widget, position, page) {
            ...
            else if (!ej2_base_1.isNullOrUndefined(page)) {
            ...
            if (widget instanceof index_1.BlockContainer) {
            ...
            else if (widget.nextRenderedWidget instanceof index_1.Widget) {
                position.index = '0';
                if (widget.nextRenderedWidget instanceof index_1.TableWidget) {
        ...
        TextPosition.prototype.isExistAfter = function (textPosition) {
            ...
            if (!ej2_base_1.isNullOrUndefined(startParagraph) && !ej2_base_1.isNullOrUndefined(endParagraph)) {
                if (startParagraph.containerWidget instanceof index_1.BodyWidget && endParagraph.containerWidget instanceof index_1.BodyWidget &&
        ...
        TextPosition.prototype.setPositionForLineWidget = function (lineWidget, offset) {
            ...
            if (lineWidget.isLastLine()) {
                if (!ej2_base_1.isNullOrUndefined(lineWidget.paragraph.bodyWidget.footNoteReference)) {
        ...
        TextPosition.prototype.moveNextPosition = function (isNavigate) {
            if (ej2_base_1.isNullOrUndefined(isNavigate)) {
                isNavigate = true;
            }
            var inline = this.selection.getNextStartInline(this.currentWidget, this.offset);
            if (inline instanceof index_1.FieldElementBox && inline.fieldType === 0 && !ej2_base_1.isNullOrUndefined(inline.fieldEnd)) {
                if (isNavigate) {
            ...
            if (nextOffset > this.offset) {
                ...
                inline = info.element;
                index = info.index;
                if (!ej2_base_1.isNullOrUndefined(inline) && index === inline.length && (inline.nextNode instanceof index_1.FieldElementBox
                    || inline.nextNode instanceof index_1.BookmarkElementBox)) {
                    var nextValidInline = this.selection.getNextValidElement(inline.nextNode);
                    if (nextValidInline instanceof index_1.FieldElementBox && nextValidInline.fieldType === 1
                        || nextValidInline instanceof index_1.BookmarkElementBox && nextValidInline.bookmarkType === 1) {
                ...
                if (inline instanceof index_1.FieldElementBox && inline.fieldType === 0) {
                    this.offset++;
                }
            }
            else {
        ...
        TextPosition.prototype.moveToPreviousParagraphInTable = function (selection) {
            ...
            if (ej2_base_1.isNullOrUndefined(previousParagraph)) {
                return;
            }
        ...
        TextPosition.prototype.updateOffsetToNextParagraph = function (indexInInline, isHighlight) {
            ...
            if (!isHighlight) {
                ...
                if (!ej2_base_1.isNullOrUndefined(nextParagraph)) {
                    if (nextParagraph.containerWidget instanceof index_1.TableCellWidget) {
            ...
            if (!ej2_base_1.isNullOrUndefined(nextParagraph) && nextParagraph.childWidgets.length > 0) {
                if (!positionAtStart) {
        ...
        TextPosition.prototype.updateOffsetToPrevPosition = function (index, isHighlight) {
            ...
            if (this.offset > prevOffset) {
                ...
                if (!isHighlight) {
                    ...
                    if (!ej2_base_1.isNullOrUndefined(previousParagraph)) {
                        if (previousParagraph.containerWidget instanceof index_1.TableCellWidget) {
                            if (this.selection.start.paragraph.isInsideTable) {
            ...
            if (inline instanceof index_1.FieldElementBox) {
        ...
        TextPosition.prototype.moveToNextParagraphStartInternal = function () {
            ...
            if (!ej2_base_1.isNullOrUndefined(this.selection.getNextParagraphBlock(paragraph))) {
        ...
        TextPosition.prototype.movePreviousPosition = function () {
            ...
            index = inlineInfo.index;
            var lineIndex = this.paragraph.childWidgets.indexOf(this.currentWidget);
            if (inline instanceof index_1.FieldElementBox && inline.fieldType === 1 && !ej2_base_1.isNullOrUndefined(inline.fieldBegin)
                || inline instanceof index_1.BookmarkElementBox && inline.bookmarkType === 1) {
        ...
        TextPosition.prototype.moveBackward = function () {
            ...
            indexInInline = inlineObj.index;
            if (!this.owner.selection.isEmpty && !ej2_base_1.isNullOrUndefined(inline)) {
                var nextInline = this.selection.getNextRenderedElementBox(inline, indexInInline);
                if (nextInline instanceof index_1.FieldElementBox && nextInline.fieldType === 0) {
        ...
        TextPosition.prototype.moveForward = function () {
            ...
            if (!ej2_base_1.isNullOrUndefined(inline)) {
                if (!this.owner.selection.isEmpty && indexInInline === inline.length && inline instanceof index_1.FieldElementBox
                    && inline.fieldType === 1) {
                    var hierarchicalIndex = this.owner.selection.start.getHierarchicalIndexInternal();
                    var fieldBeginOffset = inline.fieldBegin.line.getOffset(inline.fieldBegin, 0);
            ...
            if (inline instanceof index_1.FieldElementBox && !ej2_base_1.isNullOrUndefined(inline.fieldEnd)) {
            ...
            else if ((inline instanceof index_1.FieldElementBox)
            ...
            if (this.offset < nextOffset) {
                ...
                if (!ej2_base_1.isNullOrUndefined(inline) && indexInInline === inline.length && inline.nextNode instanceof index_1.FieldElementBox) {
                    var nextValidInline = this.selection.getNextValidElement(inline.nextNode);
                    if (nextValidInline instanceof index_1.FieldElementBox && nextValidInline.fieldType === 1) {
                        inline = nextValidInline;
                        this.offset = this.currentWidget.getOffset(inline, 1);
            ...
            else if (this.offset === nextOffset && inline instanceof index_1.FieldElementBox && inline.fieldType === 1 &&
                inline.previousNode instanceof index_1.ImageElementBox) {
                this.offset = nextOffset;
            }
        ...
        TextPosition.prototype.movePreviousPositionInternal = function (fieldEnd) {
            var inline;
            if (fieldEnd instanceof index_1.FieldElementBox && ej2_base_1.isNullOrUndefined(fieldEnd.fieldSeparator)) {
            ...
            this.currentWidget = inline.line;
            var index = inline instanceof index_1.FieldElementBox || inline instanceof index_1.BookmarkElementBox && inline.bookmarkType === 1 ? 0 : inline.length;
            this.offset = this.currentWidget.getOffset(inline, index);
        };
        TextPosition.prototype.moveToWordStartInternal = function (type) {
            ...
            if (this.offset === endOffset + 1) {
                ...
                var inline = inlineObj.element;
                indexInInline = inlineObj.index;
                this.getPreviousWordOffset(inline, selection, indexInInline, type, (inline instanceof index_1.FieldElementBox && inline.fieldType === 1), isStarted, endSelection, this);
            }
            if (type === 1) {
        ...
        TextPosition.prototype.getNextWordOffsetFieldBegin = function (fieldBegin, indexInInline, type, isInField, endSelection, endPosition, excludeSpace) {
            ...
            if (ej2_base_1.isNullOrUndefined(fieldBegin.fieldSeparator)) {
            ...
            else if (!ej2_base_1.isNullOrUndefined(fieldBegin.fieldEnd)) {
                ...
                if (endSelection && !ej2_base_1.isNullOrUndefined(fieldBegin.fieldSeparator) && (endPosition.paragraph === fieldBegin.line.paragraph) && (endPosition.offset === fieldBegin.fieldSeparator.line.getOffset(fieldBegin.fieldSeparator, fieldBegin.fieldSeparator.length))) {
        ...
        TextPosition.prototype.getNextWordOffsetImage = function (image, indexInInline, type, isInField, endSelection, endPosition, excludeSpace) {
            ...
            if (indexInInline === 0) {
                ...
                if (endPosition.offset === startOffset) {
                    if (ej2_base_1.isNullOrUndefined(image.nextNode)) {
            ...
            else if (!ej2_base_1.isNullOrUndefined(image.nextNode)) {
                this.getNextWordOffset(image.nextNode, 0, type, isInField, endSelection, endPosition, excludeSpace);
            }
        };
        TextPosition.prototype.getNextWordOffsetSpan = function (span, indexInInline, type, isInField, endSelection, endPosition, excludeSpace) {
            if (span.text === '\t' || span.text === '\v') {
                ...
                else if (!ej2_base_1.isNullOrUndefined(span.nextNode)) {
                    this.getNextWordOffset(span.nextNode, 0, type, isInField, endSelection, endPosition, excludeSpace);
                }
            }
            else {
                var wordEndIndex = 0;
                if (indexInInline === 0 && endSelection && (index_2.HelperMethods.wordSplitCharacters.indexOf(span.text[0]) === -1)) {
                    endPosition.setPositionParagraph(span.line, span.line.getOffset(span, indexInInline));
                    if (isInField) {
                        return;
                    }
                    ...
                    wordEndIndex = index_2.HelperMethods.indexOfAny(txt, index_2.HelperMethods.wordSplitCharacters);
                    if (wordEndIndex === -1 && span.nextNode instanceof index_1.CommentCharacterElementBox &&
                        ej2_base_1.isNullOrUndefined(span.nextNode.nextNode)) {
                    ...
                    if (wordEndIndex !== -1) {
                        ...
                        while (wordEndIndex < txt.length && !isSpaceCharacter) {
                            if (index_2.HelperMethods.wordSplitCharacters.indexOf(txt[wordEndIndex]) === -1) {
                                break;
                            }
                            wordEndIndex++;
                            if (spaceCharacter.indexOf(txt[wordEndIndex]) !== -1 && spaceCharacter.indexOf(txt[wordEndIndex + 1]) === -1 && index_2.HelperMethods.wordSplitCharacters.indexOf(txt[wordEndIndex + 1]) !== -1) {
                                wordEndIndex++;
                                break;
                            }
                        }
                        ...
                        if (!ej2_base_1.isNullOrUndefined(span.nextNode)) {
                            nextNodeText = span.nextNode.text;
                        }
                        if (wordEndIndex < txt.length || (!ej2_base_1.isNullOrUndefined(nextNodeText) && span.line == span.nextNode.line && spaceCharacter.indexOf(txt[txt.length - 1]) !== -1 && spaceCharacter.indexOf(nextNodeText[0]) === -1)) {
        ...
        TextPosition.prototype.getNextWordOffsetFieldSeparator = function (fieldSeparator, indexInInline, type, isInField, endSelection, endPosition, excludeSpace) {
            if (!ej2_base_1.isNullOrUndefined(fieldSeparator.nextNode)) {
        ...
        TextPosition.prototype.getNextWordOffsetComment = function (comment, indexInInline, type, isInField, endSelection, endPosition, excludeSpace) {
            if (!ej2_base_1.isNullOrUndefined(comment.nextNode)) {
        ...
        TextPosition.prototype.getNextWordOffsetFieldEnd = function (fieldEnd, indexInInline, type, isInField, endSelection, endPosition, excludeSpace) {
            ...
            if (endPosition.offset === startOffset) {
                ...
                if (ej2_base_1.isNullOrUndefined(fieldEnd.nextNode)) {
                    return;
                }
            }
            if (!ej2_base_1.isNullOrUndefined(fieldEnd.nextNode)) {
        ...
        TextPosition.prototype.getPreviousWordOffset = function (inline, selection, indexInInline, type, isInField, isStarted, endSelection, endPosition) {
            ...
            else if (inline instanceof index_1.FieldElementBox && inline.fieldType === 2) {
            ...
            else if (inline instanceof index_1.BookmarkElementBox) {
                this.getPreviousWordOffsetBookMark(inline, selection, indexInInline, type, isInField, isStarted, endSelection, endPosition);
            }
            else if (inline instanceof index_1.ListTextElementBox && inline.previousNode) {
        ...
        TextPosition.prototype.getPreviousWordOffsetBookMark = function (bookmark, selection, indexInInline, type, isInField, isStarted, endSelection, endPosition) {
            if (bookmark.previousNode) {
                if (bookmark.previousNode instanceof index_1.TextElementBox) {
                    var inline = bookmark.previousNode;
                    if (index_2.HelperMethods.lastIndexOfAny(inline.text, index_2.HelperMethods.wordSplitCharacters) !== inline.text.length - 1) {
        ...
        TextPosition.prototype.getPreviousWordOffsetFieldEnd = function (fieldEnd, selection, indexInInline, type, isInField, isStarted, endSelection, endPosition) {
            var startOffset = fieldEnd.line.getOffset(fieldEnd, 0);
            var endOffset = startOffset + fieldEnd.length;
            if (ej2_base_1.isNullOrUndefined(fieldEnd.fieldSeparator)) {
                this.getPreviousWordOffsetFieldBegin(fieldEnd.fieldBegin, selection, 0, type, isInField, isStarted, endSelection, endPosition);
            }
            else if (type === 0 && !ej2_base_1.isNullOrUndefined(fieldEnd.previousNode)) {
                var inline = fieldEnd.previousNode;
                this.getPreviousWordOffset(inline, selection, inline.length, type, (inline instanceof index_1.FieldElementBox && inline.fieldType === 1), isStarted, endSelection, endPosition);
            }
            else if (!ej2_base_1.isNullOrUndefined(fieldEnd.fieldBegin) && type !== 0) {
                var inline = fieldEnd.previousNode;
                if (ej2_base_1.isNullOrUndefined(inline) || (inline.line.paragraph === fieldEnd.fieldBegin.line.paragraph && !selection.hasValidInline(inline.line.paragraph, inline, fieldEnd.fieldBegin))) {
        ...
        TextPosition.prototype.getPreviousWordOffsetComment = function (comment, selection, indexInInline, type, isInField, isStarted, endSelection, endPosition) {
            if (comment.previousNode) {
                ...
                if (comment.previousNode instanceof index_1.TextElementBox
                    && index_2.HelperMethods.lastIndexOfAny(inline.text, index_2.HelperMethods.wordSplitCharacters) !== inline.text.length - 1) {
                    this.getPreviousWordOffset(inline, selection, indexInInline, type, isInField, isStarted, endSelection, endPosition);
                }
                else {
        ...
        TextPosition.prototype.getPreviousWordOffsetFieldBegin = function (fieldBegin, selection, indexInInline, type, isInField, isStarted, endSelection, endPosition) {
            ...
            if (!ej2_base_1.isNullOrUndefined(fieldBegin.previousNode)) {
                ...
                if (endPosition.offset === startOffset) {
                    if (type !== 0 && !ej2_base_1.isNullOrUndefined(fieldBegin.fieldSeparator)) {
        ...
        TextPosition.prototype.getPreviousWordOffsetImage = function (image, selection, indexInInline, type, isInField, isStarted, endSelection, endPosition) {
            ...
            else if (!ej2_base_1.isNullOrUndefined(image.previousNode)) {
        ...
        TextPosition.prototype.getPreviousWordOffsetSpan = function (span, selection, indexInInline, type, isInField, isStarted, endSelection, endPosition) {
            if (span.text === '\t' || span.text === '\v') {
                ...
                else if (!ej2_base_1.isNullOrUndefined(span.previousNode)) {
                ...
                if (indexInInline > 0) {
                    ...
                    wordStartIndex = index_2.HelperMethods.lastIndexOfAny(txt, index_2.HelperMethods.wordSplitCharacters);
                    if (wordStartIndex === -1 && span.previousElement instanceof index_1.CommentCharacterElementBox && ej2_base_1.isNullOrUndefined(span.previousNode.previousNode)) {
                    ...
                    if (wordStartIndex !== -1) {
                        ...
                        while (wordStartIndex > 0 && endSelection && txt[wordStartIndex] !== ' '
                            && (index_2.HelperMethods.wordSplitCharacters.indexOf(txt[wordStartIndex - 1])) !== -1) {
                            wordStartIndex--;
                        }
                        ...
                        else if (span.previousNode instanceof index_1.TextElementBox) {
                            var previousNodeText = span.previousNode.text;
                            if (index_2.HelperMethods.wordSplitCharacters.indexOf(span.text[0]) !== -1 && index_2.HelperMethods.wordSplitCharacters.indexOf(previousNodeText[previousNodeText.length - 1]) === -1) {
                                var offset = span.line.getOffset(span, wordStartIndex);
                                endPosition.setPositionParagraph(span.line, offset);
                                return;
                            }
        ...
        TextPosition.prototype.setPreviousWordOffset = function (span, selection, indexInInline, type, isInField, isStarted, endSelection, endPosition) {
            if (span.previousNode instanceof index_1.ElementBox && span.line === span.previousNode.line) {
                this.getPreviousWordOffset(span.previousNode, selection, span.previousNode.length, type, isInField, isStarted, endSelection, endPosition);
            }
            else {
        ...
        TextPosition.prototype.validateForwardFieldSelection = function (currentIndex, selectionEndIndex) {
            ...
            while (currentIndex !== selectionEndIndex && TextPosition.isForwardSelection(currentIndex, selectionEndIndex)) {
                ...
                if (!ej2_base_1.isNullOrUndefined(inline)) {
                    ...
                    if (indexInInline === inline.length && inline instanceof index_1.FieldElementBox && inline.fieldType === 1) {
                    ...
                    var nextInline = this.selection.getNextRenderedElementBox(inline, indexInInline);
                    if (!ej2_base_1.isNullOrUndefined(nextInline) && nextInline instanceof index_1.ElementBox) {
                        inline = nextInline;
                    }
                }
                isPositionMoved = (inline instanceof index_1.FieldElementBox && inline.fieldType === 0 && !ej2_base_1.isNullOrUndefined(inline.fieldEnd));
                if (isPositionMoved) {
                    if (inline.line.getOffset(inline, 0) === this.offset) {
                        return;
                    }
        ...
        TextPosition.prototype.validateBackwardFieldSelection = function (currentIndex, selectionEndIndex) {
            ...
            if ((this.selection.start.paragraph !== this.selection.end.paragraph
                ...
                (this.documentHelper.isSelectionChangedOnMouseMoved && this.selection.isParagraphFirstLine(this.selection.end.currentWidget)
                    && this.selection.end.offset === this.selection.getStartOffset(this.selection.start.paragraph))
                || (((ej2_base_1.isNullOrUndefined(this.selection.start.paragraph.previousRenderedWidget)
        ...
        TextPosition.prototype.paragraphStartInternal = function (selection, moveToPreviousParagraph) {
            ...
            if (this.offset === offset && moveToPreviousParagraph) {
                ...
                else if (!ej2_base_1.isNullOrUndefined(selection.getPreviousParagraphBlock(this.currentWidget.paragraph))) {
        ...
        TextPosition.prototype.moveToParagraphStartInternal = function (selection, moveToPreviousParagraph) {
            ...
            if (this.offset === startOffset && moveToPreviousParagraph) {
                ...
                else if (!ej2_base_1.isNullOrUndefined(selection.getPreviousParagraphBlock(this.paragraph))) {
        ...
        TextPosition.prototype.moveToParagraphEndInternal = function (selection, moveToNextParagraph) {
            ...
            if (this.offset === endOffset && moveToNextParagraph) {
                ...
                else if (!ej2_base_1.isNullOrUndefined(selection.getNextParagraphBlock(this.currentWidget.paragraph))) {
        ...
        TextPosition.prototype.moveUp = function (selection, left) {
            ...
            if (paragraph.isInsideTable && paragraph !== currentParagraph && paragraph.associatedCell !== currentParagraph.associatedCell
                && (!ej2_base_1.isNullOrUndefined(currentParagraph.associatedCell) && (paragraph.associatedCell.ownerRow === currentParagraph.associatedCell.ownerRow))) {
                var ownerRow = currentParagraph.associatedCell.ownerRow;
                if (ownerRow.previousRenderedWidget instanceof index_1.TableRowWidget) {
                    ...
                    do {
                        if (prevBlock instanceof index_1.TableWidget) {
                            prevBlock = selection.getLastBlockInLastCell(prevBlock);
                        }
                    } while (prevBlock instanceof index_1.TableWidget);
                    if (prevBlock instanceof index_1.ParagraphWidget) {
                ...
                else if (paragraph.isInsideTable && (!ej2_base_1.isNullOrUndefined(this.currentWidget.paragraph.associatedCell) && paragraph.associatedCell.ownerRow.previousRenderedWidget !== paragraph.associatedCell.ownerRow.previousSplitWidget &&
            ...
            selection.updateTextPositionWidget(prevLine, new index_3.Point(left, top), this, false);
        };
        TextPosition.prototype.moveDown = function (selection, left) {
            ...
            if (prevParagraph.isInsideTable && prevParagraph !== this.currentWidget.paragraph && prevParagraph.associatedCell !== this.currentWidget.paragraph.associatedCell && (!ej2_base_1.isNullOrUndefined(this.currentWidget.paragraph.associatedCell) && prevParagraph.associatedCell.ownerRow === this.currentWidget.paragraph.associatedCell.ownerRow)) {
                ...
                if (ownerRow.nextRenderedWidget instanceof index_1.TableRowWidget) {
                    ...
                    do {
                        if (nextBlock instanceof index_1.TableWidget) {
                            nextBlock = this.selection.getFirstBlockInFirstCell(nextBlock);
                        }
                    } while (nextBlock instanceof index_1.TableWidget);
                    if (nextBlock instanceof index_1.ParagraphWidget) {
                ...
                else if (prevParagraph.isInsideTable && (!ej2_base_1.isNullOrUndefined(this.currentWidget.paragraph.associatedCell) && prevParagraph.associatedCell.ownerRow.nextRenderedWidget !== prevParagraph.associatedCell.ownerRow.nextSplitWidget
            ...
            if (nextLine !== currentLine) {
                this.selection.updateTextPositionWidget(nextLine, new index_3.Point(left, top), this, false);
            }
        };
        TextPosition.prototype.moveToLineStartInternal = function (selection, moveToPreviousLine) {
            ...
            if (ej2_base_1.isNullOrUndefined(firstElement) && this.offset > startOffset) {
                var index = 0;
                var inlineObj = this.currentWidget.getInline(this.offset, index);
                var inline = inlineObj.element;
                index = inlineObj.index;
                if (inline instanceof index_1.TextElementBox && inline.text !== '\v') {
                    this.offset = startOffset;
                }
            }
            else if (!ej2_base_1.isNullOrUndefined(firstElement)) {
                var indexInInline = 0;
        ...
        TextPosition.prototype.moveToWordEndInternal = function (type, excludeSpace) {
            ...
            if (this.selection.isParagraphFirstLine(this.currentWidget)) {
                if (this.currentWidget.children[0] instanceof index_1.ListTextElementBox) {
                    incrementValue = 1;
                }
                if (this.currentWidget.children[1] instanceof index_1.ListTextElementBox) {
                    incrementValue = 2;
                }
            }
            if ((this.offset + incrementValue === endOffset || this.offset === endOffset + 1) && ej2_base_1.isNullOrUndefined(this.currentWidget.nextLine)) {
        ...
        TextPosition.prototype.moveToPreviousParagraph = function (selection) {
            var startOffset = selection.getStartOffset(this.currentWidget.paragraph);
            if (this.offset === startOffset && !ej2_base_1.isNullOrUndefined(selection.getPreviousParagraphBlock(this.currentWidget.paragraph))) {
        ...
        TextPosition.prototype.moveToPreviousLine = function (selection, left) {
            ...
            if (lineWidth + lineStart >= left && currentLine !== prevLine) {
                ...
                var point = new index_3.Point(left, top_1);
        ...
        TextPosition.prototype.moveToLineEndInternal = function (selection, moveToNextLine) {
            ...
            if (ej2_base_1.isNullOrUndefined(firstElement) && this.offset === selection.getStartLineOffset(this.currentWidget)) {
                ...
                if (isParaBidi && this.containsRtlText(currentLine)) {
                    ...
                    if (lastElement instanceof index_1.ListTextElementBox && currentLine.children.length > 2) {
                        lastElement = currentLine.children[currentLine.children.length - 3];
                    }
                }
                var index = 0;
                index += lastElement instanceof index_1.TextElementBox ? lastElement.length : 1;
                this.currentWidget = lastElement.line;
                if (index === lastElement.length
                    && ej2_base_1.isNullOrUndefined(lastElement.nextNode) && selection.isParagraphLastLine(this.currentWidget)) {
                    ...
                    while (!ej2_base_1.isNullOrUndefined(inline) && inline.length === index && inline.nextNode instanceof index_1.FieldElementBox) {
                    ...
                    if (!moveToNextLine && inline instanceof index_1.ElementBox && inline.text === '\v') {
                        index--;
                    }
                    this.offset = this.currentWidget.getOffset(inline, index);
                }
        ...
        TextPosition.prototype.moveToNextLine = function (left) {
            ...
            var firstItemWidth = ej2_base_1.isNullOrUndefined(firstElement) ? selection.getWidth(nextLine, true) : selection.getLeftInternal(nextLine, firstElement, 1) - lineStart;
            if (lineStart < left && (firstItemWidth / 2 < left - lineStart)) {
                var top_2 = selection.getTop(nextLine);
                var point = new index_3.Point(left, top_2);
            ...
            if (isPositionUpdated) {
                ...
                if (isPositionUpdated) {
                    ...
                    if ((isInContainerCell && isContainerCellSelected
                        || !isInContainerCell) && !ej2_base_1.isNullOrUndefined(startCell.ownerRow.previousRenderedWidget)) {
                        ...
                        && ej2_base_1.isNullOrUndefined(startCell.ownerRow.previousRenderedWidget) || !isInContainerCell) {
        ...
        TextPosition.prototype.moveDownInTable = function (selection) {
            ...
            if (isPositionUpdated) {
                ...
                if (isPositionUpdated) {
                    ...
                    if ((isInContainerCell && isContainerCellSelected
                        || !isInContainerCell) && !ej2_base_1.isNullOrUndefined(endCell.ownerRow.nextRenderedWidget)) {
                        ...
                        && ej2_base_1.isNullOrUndefined(endCell.ownerRow.nextRenderedWidget) || !isInContainerCell) {
        ...
        TextPosition.prototype.destroy = function () {
            ...
            if (!ej2_base_1.isNullOrUndefined(this.location)) {
    ...
    exports.SelectionWidgetInfo = SelectionWidgetInfo;
    var Hyperlink = (function () {
        ...
        Hyperlink.prototype.setLinkType = function () {
            if (ej2_base_1.isNullOrUndefined(this.linkInternal) || this.linkInternal.length < 1) {
    ...
    exports.ImageSizeInfo = ImageSizeInfo;
});
