define(["require", "exports", "@syncfusion/ej2-base", "@syncfusion/ej2-navigations", "@syncfusion/ej2-buttons", "@syncfusion/ej2-splitbuttons", "../viewer/page", "../index", "../editor/editor-helper", "../../base/index"], function (require, exports, ej2_base_1, ej2_navigations_1, ej2_buttons_1, ej2_splitbuttons_1, page_1, index_1, editor_helper_1, index_2) {
    ...
    var TrackChangesPane = (function () {
        function TrackChangesPane(owner, commentReviewPane) {
            ...
            this.tableRevisions = new index_2.Dictionary();
            this.owner = owner;
        ...
        TrackChangesPane.prototype.initTrackChangePane = function () {
            ...
            this.changesInfoDiv = ej2_base_1.createElement('div', { id: 'e-de-tc-pane-revision', styles: 'overflow:auto' });
        ...
        TrackChangesPane.prototype.isUpdateTrackChanges = function (revisionCount) {
            ...
            if (!ej2_base_1.isNullOrUndefined(this.changesInfoDiv)) {
        ...
        TrackChangesPane.prototype.updateCurrentTrackChanges = function (revision) {
            ...
            if (!ej2_base_1.isNullOrUndefined(currentChangeView) && revision.range.length > 0) {
        ...
        TrackChangesPane.prototype.updateTrackChanges = function (show) {
            if (show || ej2_base_1.isNullOrUndefined(show)) {
                if (this.owner.documentHelper.layout.isInitialLoad) {
                    ...
                    for (var i = 0; i < this.tableRevisions.keys.length; i++) {
                        ...
                        if (!ej2_base_1.isNullOrUndefined(this.changesInfoDiv.childNodes[index + 1]) && removeChild) {
                ...
                if (this.owner.documentHelper.layout.isInitialLoad) {
                    for (var i = 0; i < this.owner.revisions.changes.length; i++) {
                        ...
                        if ((ranges instanceof page_1.TextElementBox || ranges instanceof page_1.FieldElementBox) &&
                            ranges.paragraph.containerWidget instanceof page_1.HeaderFooterWidget && ej2_base_1.isNullOrUndefined(ranges.paragraph.containerWidget.sectionFormat)) {
                            continue;
                        }
                        if (ranges instanceof page_1.TextElementBox &&
                            ranges.paragraph.containerWidget instanceof page_1.HeaderFooterWidget) {
                        ...
                        if (ranges instanceof index_1.WRowFormat) {
        ...
        TrackChangesPane.prototype.groupTableRevisions = function (revisions, startIndex) {
            ...
            for (var i = startIndex + 1; i < revisions.length; i++) {
                ...
                if (change instanceof index_1.WRowFormat) {
                    var nextRow = change.ownerBase;
                    var nextTable = nextRow.ownerTable;
                    var nextRowIndex = nextRow.index;
                    if (!startTable.equals(nextTable) &&
                        (!ej2_base_1.isNullOrUndefined(startParentTable) && startParentTable.equals(this.owner.documentHelper.layout.getParentTable(nextTable)))) {
                        continue;
                    }
                    ...
                    var block = void 0;
                    if (change instanceof index_1.WCharacterFormat) {
                        block = change.ownerBase;
                    }
                    else if (change instanceof page_1.ElementBox) {
                    ...
                    if (block instanceof page_1.ParagraphWidget && block.isInsideTable) {
                        ...
                        if (startTable.equals(nextTable) || (!startTable.equals(nextTable) &&
                            (!ej2_base_1.isNullOrUndefined(startParentTable) && startParentTable.equals(parentTable)))) {
                            continue;
                        }
                    }
                    break;
    ...
    var ChangesSingleView = (function () {
        ...
        ChangesSingleView.prototype.createSingleChangesDiv = function (revision) {
            ...
            var userNameLabel = ej2_base_1.createElement('div', { innerHTML: revision.author, className: 'e-de-track-user-nme' });
            if (!ej2_base_1.isNullOrUndefined(revision.author)) {
        ...
        ChangesSingleView.prototype.layoutElementText = function (range, changesText) {
            ...
            for (var i = 0; i < range.length; i++) {
                ...
                if (element instanceof page_1.TextElementBox) {
                    ...
                    var paraMark = '¶';
                    if (element.ownerBase instanceof page_1.ParagraphWidget && element.ownerBase.isEndsWithPageBreak) {
                        paraMark = '............Page Break............' + paraMark;
                    }
                    changesText.appendChild(this.addSpan(paraMark, 'e-de-tc-pmark'));
                    changesText.appendChild(ej2_base_1.createElement('br'));
                }
            }
            changesText.appendChild(this.addSpan(text));
        };
