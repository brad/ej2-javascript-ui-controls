define(["require", "exports", "@syncfusion/ej2-base", "../ruler/index", "../editor/editor-helper", "../format/paragraph-format"], function (require, exports, ej2_base_1, index_1, editor_helper_1, paragraph_format_1) {
    "use strict";
    ...
    var RulerHelper = (function () {
        ...
        RulerHelper.prototype.renderRulerMarkerIndicatorElement = function (documentEditor) {
            ...
            for (var i = 0; i < 5; i++) {
                ...
                if (!ej2_base_1.isNullOrUndefined(element_1)) {
        ...
        RulerHelper.prototype.renderRuler = function (documentEditor, isHorizontal) {
            ...
            var ruler = new index_1.Ruler(div, this);
            ...
            if (rulerObj) {
                if (isHorizontal) {
                    rulerObj.scrollLeft = ruler.zeroPosition -
                        editor_helper_1.HelperMethods.convertPointToPixel(documentEditor.selection.end.paragraph.bodyWidget.sectionFormat.leftMargin);
                }
                else {
                    rulerObj.scrollTop = ruler.zeroPosition -
                        editor_helper_1.HelperMethods.convertPointToPixel(documentEditor.selection.end.paragraph.bodyWidget.sectionFormat.topMargin);
                }
            }
            ...
            if (isHorizontal) {
                document.addEventListener('mousemove', function (e) {
                    ...
                    var rightMargin = (editor_helper_1.HelperMethods.convertPixelToPoint(divRect.width) - documentEditor.selection.end.paragraph.bodyWidget.sectionFormat.rightMargin * documentEditor.zoomFactor);
                    ...
                    if (isDragging) {
                        var rulerZeroPoint = editor_helper_1.HelperMethods.convertPointToPixel(1584 - documentEditor.selection.sectionFormat.leftMargin) * documentEditor.zoomFactor;
                        ...
                        if (isLeftRulerMargin) {
                            var leftMaxLimit = rulerZeroPoint + (editor_helper_1.HelperMethods.convertPointToPixel(pageWidth - rightMarginValue - rightIndentValue - minimumValue - firstLineIndent - leftIndent) * documentEditor.zoomFactor);
                            ...
                            var rightMinLimit = rulerZeroPoint + (editor_helper_1.HelperMethods.convertPointToPixel(leftMarginValue + leftIndent + firstLineIndent + minimumValue + rightIndentValue) * documentEditor.zoomFactor);
                            var rightMaxLimit = rulerZeroPoint + (editor_helper_1.HelperMethods.convertPointToPixel(pageWidth) * documentEditor.zoomFactor);
                        ...
                        var currentRightMargin = (editor_helper_1.HelperMethods.convertPixelToPoint(divRect.width) - (documentEditor.selection.end.paragraph.bodyWidget.sectionFormat.rightMargin * documentEditor.zoomFactor));
                        ...
                        if (isLeftRulerMargin) {
                            ...
                            rightIndent.style.left = (initialRightMargin - editor_helper_1.HelperMethods.convertPointToPixel(difference)) + 'px';
                        }
                        else {
                            var difference = mouseXRelativeToDiv - initialValue;
                            rightIndent.style.left = (initialRightMargin + editor_helper_1.HelperMethods.convertPointToPixel(difference)) + 'px';
                ...
                hRuler.addEventListener("mouseenter", function (e) {
                    if (!ej2_base_1.isNullOrUndefined(_this.currentTabStopElement)) {
                ...
                hRuler.addEventListener("mousedown", function (e) {
                    if (resizerEnabled && !documentEditor.isTableMarkerDragging) {
                        ...
                        initialValue = editor_helper_1.HelperMethods.convertPixelToPoint(Math.round(e.clientX - divRect_1.left));
                        currentScrollLeft = hRuler.scrollLeft;
                        var rightIndent = document.getElementById(documentEditor.element.id + '_rightIndent');
                        initialRightMargin = editor_helper_1.HelperMethods.getNumberFromString(rightIndent.style.left);
                    ...
                    if (divRect.y + (divRect.height / 2) <= e.clientY) {
                        ...
                        if (documentEditor.layoutType === 'Pages') {
                            mouseDownTabValue_1 = editor_helper_1.HelperMethods.convertPixelToPoint(mouseDownTabValue_1 - editor_helper_1.HelperMethods.convertPointToPixel(documentEditor.selection.end.paragraph.bodyWidget.sectionFormat.leftMargin) * documentEditor.zoomFactor);
                            if (_this.position.paragraph.paragraphFormat.bidi) {
                                var paraWidth = !ej2_base_1.isNullOrUndefined(_this.position.paragraph['absoluteXPosition']) ? parseFloat(_this.position.paragraph['absoluteXPosition']['width'].toString()) : _this.position.paragraph.width;
                                paraWidth = editor_helper_1.HelperMethods.convertPixelToPoint(paraWidth * documentEditor.zoomFactor);
                                mouseDownTabValue_1 = paraWidth - mouseDownTabValue_1;
                            }
                        }
                        else if (documentEditor.layoutType === 'Continuous') {
                            if (_this.position.paragraph.paragraphFormat.bidi) {
                                mouseDownTabValue_1 = editor_helper_1.HelperMethods.convertPixelToPoint((mouseDownTabValue_1) - 20);
                                var paraWidth = !ej2_base_1.isNullOrUndefined(_this.position.paragraph['absoluteXPosition']) ? parseFloat(_this.position.paragraph['absoluteXPosition']['width'].toString()) : _this.position.paragraph.width;
                                paraWidth = editor_helper_1.HelperMethods.convertPixelToPoint(paraWidth * documentEditor.zoomFactor);
                                mouseDownTabValue_1 = paraWidth - mouseDownTabValue_1;
                            }
                ...
                hRuler.addEventListener("mouseup", function (e) {
                    ...
                    if (divRect.y + (divRect.height / 2) <= e.clientY) {
                        ...
                        if (documentEditor.layoutType === 'Pages') {
                            mouseUpTabValue_1 = editor_helper_1.HelperMethods.convertPixelToPoint(mouseUpTabValue_1 - editor_helper_1.HelperMethods.convertPointToPixel(documentEditor.selection.end.paragraph.bodyWidget.sectionFormat.leftMargin) * documentEditor.zoomFactor);
                            if (_this.position.paragraph.paragraphFormat.bidi) {
                                var paraWidth = !ej2_base_1.isNullOrUndefined(_this.position.paragraph['absoluteXPosition']) ? parseFloat(_this.position.paragraph['absoluteXPosition']['width'].toString()) : _this.position.paragraph.width;
                                paraWidth = editor_helper_1.HelperMethods.convertPixelToPoint(paraWidth * documentEditor.zoomFactor);
                            ...
                            if (_this.position.paragraph.paragraphFormat.bidi) {
                                mouseUpTabValue_1 = editor_helper_1.HelperMethods.convertPixelToPoint((mouseUpTabValue_1) - 20);
                                var paraWidth = !ej2_base_1.isNullOrUndefined(_this.position.paragraph['absoluteXPosition']) ? parseFloat(_this.position.paragraph['absoluteXPosition']['width'].toString()) : _this.position.paragraph.width;
                                paraWidth = editor_helper_1.HelperMethods.convertPixelToPoint(paraWidth * documentEditor.zoomFactor);
                                mouseUpTabValue_1 = paraWidth - mouseUpTabValue_1;
                            }
                ...
                document.addEventListener("mouseup", function (e) {
                    if (isDragging && !documentEditor.isTableMarkerDragging) {
                        var divRect = hRuler.getBoundingClientRect();
                        var mouseXRelativeToDiv = finalmouseXRelativeToDiv;
                        if (isLeftMultiColumn || isRightMultiColumn) {
                            ...
                            var columnSpace = isLeftMultiColumn ? (secFormat.columns[0].space + ((editor_helper_1.HelperMethods.convertPixelToPoint(finalvalue)))) : (secFormat.columns[0].space - ((editor_helper_1.HelperMethods.convertPixelToPoint(finalvalue))));
                            ...
                            var rightMargin = editor_helper_1.HelperMethods.convertPixelToPoint(rulerGeometry.width) - (mouseXRelativeToDiv / documentEditor.zoomFactor);
            ...
            if (!isHorizontal) {
                document.addEventListener("mousemove", function (e) {
                    ...
                    var bottomMargin = (editor_helper_1.HelperMethods.convertPixelToPoint(divRect.height) - documentEditor.selection.end.paragraph.bodyWidget.sectionFormat.bottomMargin * documentEditor.zoomFactor);
                    ...
                    if (isDragging) {
                        ...
                        var rulerZeroPoint = editor_helper_1.HelperMethods.convertPointToPixel(1584 - documentEditor.selection.sectionFormat.topMargin) * documentEditor.zoomFactor;
                        ...
                        if (isTopRulerMargin) {
                            ...
                            var topMaxLimit = rulerZeroPoint + (editor_helper_1.HelperMethods.convertPointToPixel(pageHeight - bottomMarginValue - minimumValue) * documentEditor.zoomFactor);
                            ...
                            var bottomMinLimit = rulerZeroPoint + (editor_helper_1.HelperMethods.convertPointToPixel(topMarginValue + minimumValue) * documentEditor.zoomFactor);
                            var bottomMaxLimit = rulerZeroPoint + (editor_helper_1.HelperMethods.convertPointToPixel(pageHeight) * documentEditor.zoomFactor);
                        ...
                        var currentBottomMargin = (editor_helper_1.HelperMethods.convertPixelToPoint(divRect.height) - (documentEditor.selection.end.paragraph.bodyWidget.sectionFormat.bottomMargin * documentEditor.zoomFactor));
                ...
                vRuler.addEventListener("mousedown", function (e) {
                    if (resizerEnabled) {
                        isDragging = true;
                        var divRect = vRuler.getBoundingClientRect();
                        initialYValue = editor_helper_1.HelperMethods.convertPixelToPoint(Math.round(e.clientY - divRect.top));
                ...
                document.addEventListener("mouseup", function (e) {
                    if (isDragging) {
                        ...
                        if (isTopRulerMargin) {
                            ...
                            var bottomtMargin = editor_helper_1.HelperMethods.convertPixelToPoint(rulerGeometry.height) - (mouseXRelativeToDiv / documentEditor.zoomFactor);
        ...
        RulerHelper.prototype.updateRulerPosition = function (documentEditor, isHorizontal) {
            ...
            isHorizontal ? documentEditor.hRuler.element = rulerObj : documentEditor.vRuler.element = rulerObj;
            if (rulerObj) {
                rulerObj.scrollLeft = 2112 - editor_helper_1.HelperMethods.convertPointToPixel(documentEditor.selection.end.paragraph.bodyWidget.sectionFormat.leftMargin);
            }
        };
        ...
        RulerHelper.prototype.updateIndentMarkers = function (documentEditor) {
            if (ej2_base_1.isNullOrUndefined(documentEditor) || ej2_base_1.isNullOrUndefined(documentEditor.element) || ej2_base_1.isNullOrUndefined(documentEditor.element.id) || ej2_base_1.isNullOrUndefined(documentEditor.hRuler) || ej2_base_1.isNullOrUndefined(documentEditor.hRuler.zeroPosition)) {
                return;
            }
            var indent = undefined;
            var ownerId = documentEditor.element.id;
            var rulerZeroPoint = editor_helper_1.HelperMethods.convertPointToPixel(1584 - documentEditor.selection.sectionFormat.leftMargin);
            ...
            if (this.position.paragraph.paragraphFormat.bidi || (this.position.paragraph.isInsideTable && this.position.paragraph.associatedCell.ownerTable.tableFormat.bidi)) {
                var rulerMarginDivWidth = ((rulerGeometry.width / documentEditor.zoomFactor) - (editor_helper_1.HelperMethods.convertPointToPixel((this.position.paragraph.bodyWidget.sectionFormat.rightMargin) + (this.position.paragraph.bodyWidget.sectionFormat.leftMargin))));
            ...
            if (this.position.paragraph.paragraphFormat.bidi) {
                rulerZeroPoint = editor_helper_1.HelperMethods.convertPointToPixel(1584 - documentEditor.selection.sectionFormat.leftMargin - (documentEditor.selection.sectionFormat.pageWidth - documentEditor.selection.sectionFormat.leftMargin - documentEditor.selection.sectionFormat.rightMargin));
            }
        ...
        RulerHelper.prototype.updateTabStopMarkers = function (documentEditor) {
            ...
            if (!ej2_base_1.isNullOrUndefined(RenderedTabElement)) {
        ...
        RulerHelper.prototype.renderRulerMargins = function (documentEditor, isHorizontal, rulerContainer) {
            ...
            var rulerHeight = (isHorizontal ? rulerSize.height : (rulerGeometry.height - (editor_helper_1.HelperMethods.convertPointToPixel(documentEditor.selection.end.paragraph.bodyWidget.sectionFormat.topMargin + documentEditor.selection.end.paragraph.bodyWidget.sectionFormat.bottomMargin) * documentEditor.zoomFactor)));
            if (isHorizontal) {
                for (var i = 1; i <= 13; i++) {
        ...
        RulerHelper.prototype.updateRulerMargins = function (documentEditor) {
            ...
            var rulerMarginDivHeight = rulerGeometry.height - (editor_helper_1.HelperMethods.convertPointToPixel((documentEditor.selection.end.paragraph.bodyWidget.sectionFormat.bottomMargin * documentEditor.zoomFactor) + (documentEditor.selection.end.paragraph.bodyWidget.sectionFormat.topMargin * documentEditor.zoomFactor)));
        ...
        RulerHelper.prototype.updateHorizontalRulerMargin = function (documentEditor) {
            ...
            var tableBidi = false;
            var currnLefttMargin = editor_helper_1.HelperMethods.convertPointToPixel(documentEditor.selection.end.paragraph.bodyWidget.sectionFormat.leftMargin - 72);
            var currentRightMargin = editor_helper_1.HelperMethods.convertPointToPixel(documentEditor.selection.end.paragraph.bodyWidget.sectionFormat.rightMargin - 72);
            if (this.position.paragraph.isInsideTable) {
                tableBidi = this.position.paragraph.associatedCell.ownerTable.tableFormat.bidi;
            }
            var rulerMarginDivWidth = (this.getRulerGeometry(documentEditor).width - (editor_helper_1.HelperMethods.convertPointToPixel((documentEditor.selection.end.paragraph.bodyWidget.sectionFormat.rightMargin * documentEditor.zoomFactor) + (documentEditor.selection.end.paragraph.bodyWidget.sectionFormat.leftMargin * documentEditor.zoomFactor))));
        ...
        RulerHelper.prototype.resizeVRulerMargins = function (isRulerTopMargin, currentTopMargin, currentScrollTop, currentBottomMargin, ruler, mousePosition, documentEditor) {
            ...
            var rulerGeometry = this.getRulerGeometry(documentEditor);
            if (isRulerTopMargin) {
                rulerMarginDiv.style.height = (rulerGeometry.height - editor_helper_1.HelperMethods.convertPointToPixel((documentEditor.selection.end.paragraph.bodyWidget.sectionFormat.bottomMargin * documentEditor.zoomFactor) + mousePosition)).toString() + "px";
                ...
                rulerMarginDiv.style.height = (rulerGeometry.height - editor_helper_1.HelperMethods.convertPointToPixel((documentEditor.selection.end.paragraph.bodyWidget.sectionFormat.topMargin * documentEditor.zoomFactor) + (bottomMargin))).toString() + "px";
        ...
        RulerHelper.prototype.resizeRulerMargins = function (isRulerLeftMargin, currentLeftMargin, currentScrollLeft, currentRightMargin, ruler, mousePosition, isHorizontal, documentEditor) {
            ...
            if (!ej2_base_1.isNullOrUndefined(isRulerLeftMargin) && isRulerLeftMargin) {
                rulerMarginDiv.style.width = (rulerGeometry.width - editor_helper_1.HelperMethods.convertPointToPixel((documentEditor.selection.end.paragraph.bodyWidget.sectionFormat.rightMargin * documentEditor.zoomFactor) + mousePosition)).toString() + "px";
                ...
                rulerMarginDiv.style.width = (rulerGeometry.width - editor_helper_1.HelperMethods.convertPointToPixel((documentEditor.selection.end.paragraph.bodyWidget.sectionFormat.leftMargin * documentEditor.zoomFactor) + (rightMargin))).toString() + "px";
        ...
        RulerHelper.prototype.renderIndents = function (documentEditor, isHorizontal, rulerSize, rulerGeometry, locale) {
            ...
            if (!firstLineIndent) {
                var margin = ('left:' + (editor_helper_1.HelperMethods.convertPointToPixel(documentEditor.selection.end.paragraph.bodyWidget.sectionFormat.leftMargin) - 6) * documentEditor.zoomFactor + 'px;');
                ...
                var initialValue_1 = editor_helper_1.HelperMethods.getNumberFromString(firstLineIndent.style.left);
                var initialValue2 = editor_helper_1.HelperMethods.getNumberFromString(firstLineIndent.style.left);
                ...
                firstLineIndent.addEventListener("mousedown", function (e) {
                    ...
                    initialValue_1 = editor_helper_1.HelperMethods.getNumberFromString(firstLineIndent.style.left);
                    var rulerZeroPoint = editor_helper_1.HelperMethods.convertPointToPixel(1584 - documentEditor.selection.sectionFormat.leftMargin) * documentEditor.zoomFactor;
                    if (documentEditor.selection.paragraphFormat.bidi) {
                        rulerZeroPoint = editor_helper_1.HelperMethods.convertPointToPixel(1584 - documentEditor.selection.sectionFormat.leftMargin - (documentEditor.selection.sectionFormat.pageWidth - documentEditor.selection.sectionFormat.leftMargin - documentEditor.selection.sectionFormat.rightMargin)) * documentEditor.zoomFactor;
                    }
                    if (documentEditor.layoutType === 'Continuous') {
                        rulerZeroPoint = (documentEditor.hRuler.zeroPosition * documentEditor.zoomFactor) - 20;
                        if (documentEditor.selection.paragraphFormat.bidi) {
                ...
                document.addEventListener("mousemove", function (e) {
                    if (isDragging_1) {
                        ...
                        var rightIndentValue = editor_helper_1.HelperMethods.getNumberFromString(rightIndent_1.style.left);
                        if (documentEditor.layoutType === 'Pages') {
                            if (documentEditor.selection.paragraphFormat.bidi) {
                                rulerZeroPoint = editor_helper_1.HelperMethods.convertPointToPixel(1584 - documentEditor.selection.sectionFormat.leftMargin - (documentEditor.selection.sectionFormat.pageWidth - documentEditor.selection.sectionFormat.leftMargin - documentEditor.selection.sectionFormat.rightMargin)) * documentEditor.zoomFactor;
                                maxValue = rulerZeroPoint - 6 + (editor_helper_1.HelperMethods.convertPointToPixel(documentEditor.selection.sectionFormat.pageWidth) * documentEditor.zoomFactor);
                                minValue = rightIndentValue + editor_helper_1.HelperMethods.convertPointToPixel(42) * documentEditor.zoomFactor;
                            }
                            else {
                                rulerZeroPoint = editor_helper_1.HelperMethods.convertPointToPixel(1584 - documentEditor.selection.sectionFormat.leftMargin) * documentEditor.zoomFactor;
                                minValue = rulerZeroPoint - 6;
                                maxValue = rightIndentValue - editor_helper_1.HelperMethods.convertPointToPixel(42) * documentEditor.zoomFactor;
                            }
                        }
                        else if (documentEditor.layoutType === 'Continuous') {
                            if (_this.position.paragraph.paragraphFormat.bidi) {
                ...
                document.addEventListener("mouseup", function () {
                    if (isDragging_1) {
                        isDragging_1 = false;
                        var finalValue = editor_helper_1.HelperMethods.getNumberFromString(firstLineIndent.style.left);
            ...
            if (!hangingIndent) {
                var margin = ('left:' + (editor_helper_1.HelperMethods.convertPointToPixel(documentEditor.selection.end.paragraph.bodyWidget.sectionFormat.leftMargin) - 6) + 'px;');
                ...
                var initialValue_2 = editor_helper_1.HelperMethods.getNumberFromString(hangingIndent.style.left);
                var initialValue2 = editor_helper_1.HelperMethods.getNumberFromString(hangingIndent.style.left);
                var minLimit_1;
                var maxLimit_1;
                var leftIndent_1;
                ...
                hangingIndent.addEventListener("mousedown", function (e) {
                    ...
                    initialValue_2 = editor_helper_1.HelperMethods.getNumberFromString(hangingIndent.style.left);
                    var rightIndent = document.getElementById(documentEditor.element.id + '_rightIndent');
                    ...
                    if (documentEditor.layoutType === 'Pages') {
                        if (documentEditor.selection.paragraphFormat.bidi) {
                            rulerZeroPoint = editor_helper_1.HelperMethods.convertPointToPixel(1584 - documentEditor.selection.sectionFormat.leftMargin - (documentEditor.selection.sectionFormat.pageWidth - documentEditor.selection.sectionFormat.leftMargin - documentEditor.selection.sectionFormat.rightMargin)) * documentEditor.zoomFactor;
                            minLimit_1 = rightPosition + (editor_helper_1.HelperMethods.convertPointToPixel(42) * documentEditor.zoomFactor);
                            maxLimit_1 = rulerZeroPoint - 6 + (editor_helper_1.HelperMethods.convertPointToPixel(documentEditor.selection.sectionFormat.pageWidth) * documentEditor.zoomFactor);
                        }
                        else {
                            rulerZeroPoint = editor_helper_1.HelperMethods.convertPointToPixel(1584 - documentEditor.selection.sectionFormat.leftMargin) * documentEditor.zoomFactor;
                            minLimit_1 = rulerZeroPoint - 6;
                            maxLimit_1 = (rightPosition - editor_helper_1.HelperMethods.convertPointToPixel(42) * documentEditor.zoomFactor);
                        }
                    }
                    else if (documentEditor.layoutType === 'Continuous') {
                        if (_this.position.paragraph.paragraphFormat.bidi) {
                ...
                document.addEventListener("mouseup", function () {
                    if (isDragging_2) {
                        isDragging_2 = false;
                        var finalValue = editor_helper_1.HelperMethods.getNumberFromString(hangingIndent.style.left);
            ...
            if (!leftIndent) {
                ...
                var initialValue_3 = editor_helper_1.HelperMethods.getNumberFromString(leftIndent.style.left);
                var initialValue2 = editor_helper_1.HelperMethods.getNumberFromString(leftIndent.style.left);
                ...
                leftIndent.addEventListener("mousedown", function (e) {
                    ...
                    initialValue_3 = editor_helper_1.HelperMethods.getNumberFromString(leftIndent.style.left);
                    firstIndentInitialValue_1 = editor_helper_1.HelperMethods.getNumberFromString(firstLineIndent.style.left);
                    ...
                    if (documentEditor.layoutType === 'Pages') {
                        if (documentEditor.selection.paragraphFormat.bidi) {
                            rulerZeroPoint = editor_helper_1.HelperMethods.convertPointToPixel(1584 - documentEditor.selection.sectionFormat.leftMargin - (documentEditor.selection.sectionFormat.pageWidth - documentEditor.selection.sectionFormat.leftMargin - documentEditor.selection.sectionFormat.rightMargin)) * documentEditor.zoomFactor;
                            minLimit_2 = (rightPosition + editor_helper_1.HelperMethods.convertPointToPixel(42) * documentEditor.zoomFactor);
                            maxLimit_2 = rulerZeroPoint - 6 + (editor_helper_1.HelperMethods.convertPointToPixel(documentEditor.selection.sectionFormat.pageWidth) * documentEditor.zoomFactor);
                            isHangingIndent_1 = (editor_helper_1.HelperMethods.getNumberFromString(hangingIndent.style.left) - rightPosition) <= (editor_helper_1.HelperMethods.getNumberFromString(firstLineIndent.style.left) - rightPosition);
                        }
                        else {
                            rulerZeroPoint = editor_helper_1.HelperMethods.convertPointToPixel(1584 - documentEditor.selection.sectionFormat.leftMargin) * documentEditor.zoomFactor;
                            minLimit_2 = rulerZeroPoint - 6;
                            maxLimit_2 = (rightPosition - editor_helper_1.HelperMethods.convertPointToPixel(42) * documentEditor.zoomFactor);
                            isHangingIndent_1 = (rightPosition - editor_helper_1.HelperMethods.getNumberFromString(hangingIndent.style.left)) <= (rightPosition - editor_helper_1.HelperMethods.getNumberFromString(firstLineIndent.style.left));
                        }
                    }
                    else if (documentEditor.layoutType === 'Continuous') {
                        if (_this.position.paragraph.paragraphFormat.bidi) {
                ...
                document.addEventListener("mouseup", function () {
                    if (isDragging_3) {
                        isDragging_3 = false;
                        var finalValue = editor_helper_1.HelperMethods.getNumberFromString(leftIndent.style.left);
            ...
            var rightIndent = document.getElementById(documentEditor.element.id + '_rightIndent');
            if (!rightIndent) {
                var margin = ('left:' + (documentEditor.selection.end.paragraph.bodyWidget.page.boundingRectangle.width - editor_helper_1.HelperMethods.convertPointToPixel(documentEditor.selection.end.paragraph.bodyWidget.sectionFormat.rightMargin) - 6) + 'px;');
                ...
                var initialValue_4 = editor_helper_1.HelperMethods.getNumberFromString(rightIndent.style.left);
                var initialValue2 = editor_helper_1.HelperMethods.getNumberFromString(rightIndent.style.left);
                ...
                rightIndent.addEventListener("mousedown", function (e) {
                    ...
                    initialValue_4 = editor_helper_1.HelperMethods.getNumberFromString(rightIndent.style.left);
                    var rulerZeroPoint = editor_helper_1.HelperMethods.convertPointToPixel(1584 - documentEditor.selection.sectionFormat.leftMargin) * documentEditor.zoomFactor;
                    if (documentEditor.selection.paragraphFormat.bidi) {
                        rulerZeroPoint = editor_helper_1.HelperMethods.convertPointToPixel(1584 - documentEditor.selection.sectionFormat.leftMargin - (documentEditor.selection.sectionFormat.pageWidth - documentEditor.selection.sectionFormat.leftMargin - documentEditor.selection.sectionFormat.rightMargin)) * documentEditor.zoomFactor;
                    }
                ...
                document.addEventListener("mousemove", function (e) {
                    if (isDragging_4) {
                        ...
                        if (documentEditor.selection.paragraphFormat.bidi) {
                            ...
                            var nearestElement = (editor_helper_1.HelperMethods.getNumberFromString(leftIndent_2.style.left) - value) <= (editor_helper_1.HelperMethods.getNumberFromString(firstLineIndent_1.style.left) - value) ? leftIndent_2 : firstLineIndent_1;
                            var indentValue = editor_helper_1.HelperMethods.getNumberFromString(nearestElement.style.left);
                            maxValue = indentValue - (editor_helper_1.HelperMethods.convertPointToPixel(42) * documentEditor.zoomFactor);
                            minValue = rulerZeroPoint - 6;
                        }
                        else {
                            if (documentEditor.layoutType === 'Pages') {
                            ...
                            value = rulerZeroPoint + e.clientX - rightLineOffset_1 - hRuler.getBoundingClientRect().left;
                            var nearestElement = (value - editor_helper_1.HelperMethods.getNumberFromString(leftIndent_2.style.left)) <= (value - editor_helper_1.HelperMethods.getNumberFromString(firstLineIndent_1.style.left)) ? leftIndent_2 : firstLineIndent_1;
                            var indentValue = editor_helper_1.HelperMethods.getNumberFromString(nearestElement.style.left);
                            maxValue = rulerZeroPoint + (documentEditor.documentHelper.currentPage.boundingRectangle.width * documentEditor.zoomFactor) - 6;
                            minValue = indentValue + (editor_helper_1.HelperMethods.convertPointToPixel(42) * documentEditor.zoomFactor);
                        }
                        if (value < minValue) {
                            value = minValue;
                        }
                ...
                document.addEventListener("mouseup", function () {
                    if (isDragging_4) {
                        isDragging_4 = false;
                        var finalValue = editor_helper_1.HelperMethods.getNumberFromString(rightIndent.style.left);
                        if (documentEditor.selection.paragraphFormat.bidi) {
        ...
        RulerHelper.prototype.updateRuler = function (documentEditor, rerenderRuler) {
            ...
            var hOffset = 0;
            if (ej2_base_1.isNullOrUndefined(documentEditor.hRuler) && ej2_base_1.isNullOrUndefined(documentEditor.vRuler)) {
                return;
            }
            if (documentEditor.selection.isForward) {
                this.position = documentEditor.selection.start;
        ...
        RulerHelper.prototype.renderTableMarkers = function (documentEditor, ruler) {
            ...
            var _loop_1 = function (i) {
                ...
                document.addEventListener("mousemove", function (e) {
                    ...
                    if (documentEditor.isTableMarkerDragging) {
                        ...
                        if (documentEditor.selection.end.paragraph.associatedCell.ownerTable.tableFormat.bidi) {
                            ...
                            var rulerMarginDivWidth = (rulerGeometry.width - (editor_helper_1.HelperMethods.convertPointToPixel((documentEditor.selection.end.paragraph.bodyWidget.sectionFormat.rightMargin * documentEditor.zoomFactor) + (documentEditor.selection.end.paragraph.bodyWidget.sectionFormat.leftMargin * documentEditor.zoomFactor))));
                            rulerZeroPoint -= rulerMarginDivWidth;
                        }
                ...
                document.addEventListener("mouseup", function (e) {
                    ...
                    if (documentEditor.isTableMarkerDragging) {
                        var cursorPoint = new editor_helper_1.Point(e.clientX, e.clientY);
                        var dragValue = _this.position.paragraph.associatedCell.ownerTable.tableFormat.bidi ? (documentEditor.startXPosition - editor_helper_1.HelperMethods.convertPixelToPoint(e.clientX)) : (editor_helper_1.HelperMethods.convertPixelToPoint(e.clientX) - documentEditor.startXPosition);
        ...
        RulerHelper.prototype.updateRulerDimension = function (documentEditor, ruler, offset, rerenderRuler) {
            ...
            if (isHorizontal) {
                if (documentEditor.layoutType === 'Pages') {
                    ...
                    if (paraBidi || tableBidi) {
                        var rulerMarginDivWidth = (rulerGeometry.width - (editor_helper_1.HelperMethods.convertPointToPixel((documentEditor.selection.end.paragraph.bodyWidget.sectionFormat.rightMargin * documentEditor.zoomFactor))));
                        rulerObj.scrollLeft = (documentEditor.hRuler.zeroPosition * documentEditor.zoomFactor) - rulerMarginDivWidth;
                    }
                    else {
                        rulerObj.scrollLeft = (ruler.zeroPosition - editor_helper_1.HelperMethods.convertPointToPixel(documentEditor.selection.end.paragraph.bodyWidget.sectionFormat.leftMargin)) * documentEditor.zoomFactor;
                    }
                }
                else {
                    var paraBidi = this.position.paragraph.paragraphFormat.bidi;
                ...
                rulerObj.scrollTop = (ruler.zeroPosition - editor_helper_1.HelperMethods.convertPointToPixel(documentEditor.selection.end.paragraph.bodyWidget.sectionFormat.topMargin)) * documentEditor.zoomFactor;
            }
        };
        ...
        RulerHelper.prototype.getVerticalHeight = function (documentEditor) {
            var pageheight = editor_helper_1.HelperMethods.convertPixelToPoint(documentEditor.selection.end.paragraph.bodyWidget.page.boundingRectangle.height);
        ...
        RulerHelper.prototype.renderTab = function (documentEditor, rulerSize, tabStop, tabJustification, i, locale) {
                ...
                case 'Left':
                    ...
                    if (!leftTab) {
                        ...
                        if (!ej2_base_1.isNullOrUndefined(tabStop)) {
                            value = this.position.paragraph.paragraphFormat.bidi ? (editor_helper_1.HelperMethods.convertPointToPixel(1584 - tabStop.position)) : (editor_helper_1.HelperMethods.convertPointToPixel(1584 + tabStop.position));
            ...
            if (!ej2_base_1.isNullOrUndefined(tabStop)) {
                ...
                var tabStopOffset_1;
                var initialValue_5 = editor_helper_1.HelperMethods.getNumberFromString(tabStopElement_1.style.left);
                var initialValue2 = editor_helper_1.HelperMethods.getNumberFromString(tabStopElement_1.style.left);
                ...
                tabStopElement_1.addEventListener("mousedown", function (e) {
                    ...
                    initialValue_5 = editor_helper_1.HelperMethods.getNumberFromString(tabStopElement_1.style.left);
                ...
                document.addEventListener('mousemove', function (e) {
                    if (isDragging_5) {
                        ...
                        if (documentEditor.layoutType === 'Continuous') {
                            ...
                            rulerZeroPoint = editor_helper_1.HelperMethods.convertPointToPixel(1584 - documentEditor.selection.sectionFormat.leftMargin)
                                * documentEditor.zoomFactor;
                            if (_this.position.paragraph.bidi) {
                                rulerZeroPoint = editor_helper_1.HelperMethods.convertPointToPixel(1584 + documentEditor.selection.sectionFormat.rightMargin - documentEditor.selection.sectionFormat.pageWidth) * documentEditor.zoomFactor;
                            }
                        }
                ...
                document.addEventListener("mouseup", function () {
                    if (isDragging_5 && !ej2_base_1.isNullOrUndefined(currentTabStop_1)) {
                        if (!ej2_base_1.isNullOrUndefined(_this.currentTabStopElement) && _this.currentTabStopElement.style.display == 'none') {
                            ...
                            var finalValue = editor_helper_1.HelperMethods.getNumberFromString(tabStopElement_1.style.left);
                            initialValue_5 = finalValue;
                            documentEditor.editor.removeTabStops([currrentParagraph_1], [currentTabStop_1]);
                            finalValue = editor_helper_1.HelperMethods.convertPixelToPoint(finalValue / documentEditor.zoomFactor) - 1584;
