define(["require", "exports", "@syncfusion/ej2-base", "./page", "./layout", "./viewer", "../editor/editor-helper", "../../index", "../../index", "./document-canvas", "../../base/dictionary"], function (require, exports, ej2_base_1, page_1, layout_1, viewer_1, editor_helper_1, index_1, index_2, document_canvas_1, dictionary_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var Renderer = (function () {
        function Renderer(documentHelper) {
            this.commentMarkDictionary = new dictionary_1.Dictionary();
        ...
        Object.defineProperty(Renderer.prototype, "pageCanvas", {
            get: function () {
                if (this.isPrinting) {
                    if (ej2_base_1.isNullOrUndefined(this.pageCanvasIn)) {
                ...
                if (this.isExporting) {
                    if (ej2_base_1.isNullOrUndefined(this.exportPageCanvas)) {
                        this.exportPageCanvas = new document_canvas_1.DocumentCanvasElement();
                    }
                    return this.exportPageCanvas;
                }
                else {
                    return ej2_base_1.isNullOrUndefined(this.viewer) ? undefined : this.documentHelper.containerCanvas;
                }
            },
            enumerable: true,
            configurable: true
        ...
        Object.defineProperty(Renderer.prototype, "selectionCanvas", {
            get: function () {
                return ej2_base_1.isNullOrUndefined(this.viewer) ? undefined : this.documentHelper.selectionCanvas;
            },
            enumerable: true,
            configurable: true
        });
        ...
        Renderer.prototype.renderWidgets = function (page, left, top, width, height) {
            if (ej2_base_1.isNullOrUndefined(this.pageCanvas) || ej2_base_1.isNullOrUndefined(page)) {
                return;
            }
            this.pageContext.fillStyle = editor_helper_1.HelperMethods.getColor(this.documentHelper.backgroundColor);
        ...
        Renderer.prototype.renderHFWidgets = function (page, widget, width, isHeader) {
            ...
            if (isHeader) {
                ...
                if (ej2_base_1.isNullOrUndefined(page.footerWidgetIn.sectionFormat)) {
                    footerHeight = page.boundingRectangle.height -
                        Math.max(page.footerWidgetIn.height + footerDistance, editor_helper_1.HelperMethods.convertPointToPixel(page.footerWidgetIn.sectionFormat.bottomMargin));
                }
                else {
                    footerHeight = page.boundingRectangle.height -
                        Math.max(page.footerWidgetIn.height + footerDistance, editor_helper_1.HelperMethods.convertPointToPixel(page.footerWidgetIn.sectionFormat.bottomMargin));
        ...
        Renderer.prototype.renderHeaderSeparator = function (page, left, top, widget) {
            ...
            var l10n = new ej2_base_1.L10n('documenteditor', this.documentHelper.owner.defaultLocale);
            ...
            if (page.footerWidget) {
                ...
                var footerHeight = this.getScaledValue(page.boundingRectangle.height) -
                    this.getScaledValue(Math.max(page.footerWidgetIn.height + footerDistance, Math.abs(editor_helper_1.HelperMethods.convertPointToPixel(page.footerWidgetIn.sectionFormat.bottomMargin))));
                ...
                var index_3 = this.viewer.getHeaderFooter(page.footerWidget.headerFooterType);
                var headerFooterWidget_1;
                if (this.documentHelper.headersFooters[parseInt(sectionIndex_1.toString(), 10)]) {
                    headerFooterWidget_1 = this.documentHelper.headersFooters[parseInt(sectionIndex_1.toString(), 10)][parseInt(index_3.toString(), 10)];
                }
        ...
        Renderer.prototype.getHeaderFooterType = function (page, isHeader) {
            ...
            if (page.bodyWidgets[0].sectionFormat.differentFirstPage &&
                (ej2_base_1.isNullOrUndefined(page.previousPage) || page.sectionIndex !== page.previousPage.sectionIndex)) {
        ...
        Renderer.prototype.render = function (page, bodyWidget) {
            ...
            for (var i = 0; i < page.bodyWidgets.length; i++) {
                if (!ej2_base_1.isNullOrUndefined(page.bodyWidgets[i].floatingElements)) {
                    this.renderFloatingItems(page, page.bodyWidgets[i].floatingElements, 'Behind');
                }
            }
            var isClipped = false;
            if (!(this.viewer instanceof viewer_1.WebLayoutViewer) && bodyWidget.sectionFormat.columns.length > 1) {
                var colIndex = page.bodyWidgets.indexOf(bodyWidget);
                var xPos = void 0;
                var width = void 0;
                if (bodyWidget.columnIndex === 0) {
                    xPos = page.bodyWidgets[colIndex].x - editor_helper_1.HelperMethods.convertPointToPixel(page.bodyWidgets[colIndex].sectionFormat.leftMargin);
                    width = editor_helper_1.HelperMethods.convertPointToPixel(page.bodyWidgets[colIndex].sectionFormat.leftMargin) + bodyWidget.sectionFormat.columns[bodyWidget.columnIndex].width + (bodyWidget.sectionFormat.columns[bodyWidget.columnIndex].space / 2);
                }
                    ...
                    width = editor_helper_1.HelperMethods.convertPointToPixel(page.bodyWidgets[colIndex].sectionFormat.rightMargin) + bodyWidget.sectionFormat.columns[bodyWidget.columnIndex].width + (bodyWidget.sectionFormat.columns[bodyWidget.columnIndex - 1].space / 2);
                }
                else {
            ...
            for (var i = 0; i < bodyWidget.childWidgets.length; i++) {
                ...
                if (i === 0 && bodyWidget.childWidgets[0] instanceof page_1.TableWidget &&
            ...
            for (var i = 0; i < page.bodyWidgets.length; i++) {
                if (page.bodyWidgets[parseInt(i.toString(), 10)].sectionFormat.lineBetweenColumns === true) {
                    if (page.bodyWidgets[parseInt(i.toString(), 10)].columnIndex !== 0 && page.bodyWidgets.length > 1) {
                        ...
                        var footerDistance = editor_helper_1.HelperMethods.convertPointToPixel(page.bodyWidgets[0].sectionFormat.footerDistance);
                        var footerHeight = this.getScaledValue(page.boundingRectangle.height) -
                            this.getScaledValue(Math.max(page.footerWidgetIn.height + footerDistance, editor_helper_1.HelperMethods.convertPointToPixel(page.footerWidgetIn.sectionFormat.bottomMargin)));
                        footerHeight = Math.max((this.getScaledValue(page.boundingRectangle.height) - headerFooterHeight), footerHeight);
        ...
        Renderer.prototype.renderFloatingItems = function (page, floatingElements, wrappingType) {
            if (!ej2_base_1.isNullOrUndefined(floatingElements) && floatingElements.length > 0) {
                var overLappedShapeWidgets = new dictionary_1.Dictionary();
                floatingElements.sort(function (a, b) {
                    if (a instanceof page_1.TableWidget || b instanceof page_1.TableWidget) {
                        return 0;
                    }
                    else {
                ...
                for (var i = 0; i < floatingElements.length; i++) {
                    if (floatingElements[i] instanceof page_1.TableWidget) {
                        continue;
                    }
                    ...
                    if (!this.isOverLappedShapeWidget(shape) || overLappedShapeWidgets.containsKey(shape.zOrderPosition)) {
                        if (shape instanceof page_1.ImageElementBox) {
                            this.renderImageElementBox(shape, shape.x, shape.y, 0);
                        }
                        else if (shape instanceof page_1.ShapeElementBox) {
        ...
        Renderer.prototype.isOverLappedShapeWidget = function (floatingElement) {
            return ((floatingElement instanceof page_1.ImageElementBox
                ...
                || (floatingElement instanceof page_1.ShapeElementBox
                    && floatingElement.textWrappingStyle !== 'Inline'
                    && floatingElement.textWrappingStyle !== 'Behind'
                    && !(this.documentHelper.compatibilityMode !== 'Word2013'
                        && (floatingElement.isBelowText
        ...
        Renderer.prototype.renderShapeElementBox = function (shape, shapeLeft, shapeTop, page) {
            ...
            if (!ej2_base_1.isNullOrUndefined(shapeType)) {
                if (shape.lineFormat.line && shape.lineFormat.lineFormatType !== 'None') {
                    this.pageContext.lineWidth = shape.lineFormat.weight;
                    this.pageContext.strokeStyle = editor_helper_1.HelperMethods.getColor(shape.lineFormat.color);
            ...
            for (var i = 0; i < blocks.length; i++) {
                ...
                if (isZeroShapeHeight && shapeType !== 'StraightConnector') {
                    shape.height = editor_helper_1.HelperMethods.round((shape.height + blocks[i].height), 5);
                }
            }
        ...
        Renderer.prototype.renderLockRegionBorder = function (page, widget) {
            if (!widget.isInsideTable && widget instanceof page_1.BlockWidget && widget.locked) {
                ...
                var leftPosition = editor_helper_1.HelperMethods.convertPointToPixel(sectionFormat.leftMargin) - 5;
                var pageWidth = sectionFormat.pageWidth - sectionFormat.leftMargin - sectionFormat.rightMargin;
                pageWidth = editor_helper_1.HelperMethods.convertPointToPixel(pageWidth) + 10;
                if (this.viewer instanceof viewer_1.WebLayoutViewer) {
                ...
                if (ej2_base_1.isNullOrUndefined(previousWidget) || !previousWidget.locked || widget.lockedBy !== previousWidget.lockedBy) {
                ...
                if (ej2_base_1.isNullOrUndefined(nextWidget) || !nextWidget.locked || widget.lockedBy !== nextWidget.lockedBy) {
        ...
        Renderer.prototype.renderHeader = function (page, widget, header) {
            ...
            for (var i = 0; i <= header.rowIndex; i++) {
                ...
                page.viewer.updateClientAreaLocation(headerWidget, new page_1.Rect(page.viewer.clientArea.x, top, headerWidget.width, headerWidget.height));
        ...
        Renderer.prototype.renderParagraphWidget = function (page, paraWidget) {
            ...
            var paddingLeft = 0;
            if (!ej2_base_1.isNullOrUndefined(firstLine)) {
            ...
            if (!(paraWidget.containerWidget instanceof page_1.HeaderFooterWidget && paraWidget.containerWidget.isEmpty && !ej2_base_1.isNullOrUndefined(this.documentHelper.selection) && !ej2_base_1.isNullOrUndefined(this.documentHelper.selection.start.paragraph) && !this.documentHelper.selection.start.paragraph.isInHeaderFooter)) {
        ...
        Renderer.prototype.renderParagraphBorder = function (page, paragraphWidet) {
            ...
            if (!ej2_base_1.isNullOrUndefined(leftBorder) && leftBorder.lineStyle !== 'None') {
                startX = this.documentHelper.getParagraphLeftPosition(paragraphWidet) - editor_helper_1.HelperMethods.convertPointToPixel(leftBorder.space);
                endX = startX;
                ...
                if (topBorder.lineStyle !== 'None' && firstLine.isFirstLine() && !canRenderParagraphBorders.skipTopBorder) {
                    startY = paragraphWidet.y + this.getTopMargin(paragraphWidet) - (editor_helper_1.HelperMethods.convertPointToPixel(topBorder.lineWidth + topBorder.space));
                    endY = startY + paragraphWidet.height - (this.getTopMargin(paragraphWidet) - (editor_helper_1.HelperMethods.convertPointToPixel(topBorder.lineWidth + topBorder.space)));
                }
                else {
                ...
                if (bottomBorder.lineStyle !== 'None' && lastLine.isLastLine() && !canRenderParagraphBorders.skipBottomBorder) {
                    endY = (endY + editor_helper_1.HelperMethods.convertPointToPixel(bottomBorder.lineWidth + bottomBorder.space)) - this.getBottomMargin(paragraphWidet);
                }
                lineWidth = editor_helper_1.HelperMethods.convertPointToPixel(leftBorder.lineWidth);
                this.renderSingleBorder(leftBorder.color, startX, startY, endX, endY, lineWidth, leftBorder.lineStyle);
            }
            if (!ej2_base_1.isNullOrUndefined(topBorder) && topBorder.lineStyle !== 'None' && firstLine.isFirstLine() && !canRenderParagraphBorders.skipTopBorder) {
                ...
                if (leftBorder.lineStyle !== 'None') {
                    startX -= editor_helper_1.HelperMethods.convertPointToPixel(leftBorder.space);
                }
                if (rightBorder.lineStyle !== 'None') {
                    endX += editor_helper_1.HelperMethods.convertPointToPixel(rightBorder.space);
                }
                lineWidth = editor_helper_1.HelperMethods.convertPointToPixel(topBorder.lineWidth);
                this.renderSingleBorder(topBorder.color, startX, startY, endX, endY, lineWidth, topBorder.lineStyle);
            }
            if (!ej2_base_1.isNullOrUndefined(rightBorder) && rightBorder.lineStyle !== 'None') {
                startX = this.documentHelper.getParagraphLeftPosition(paragraphWidet) + this.getContainerWidth(paragraphWidet, page) + editor_helper_1.HelperMethods.convertPointToPixel(rightBorder.space);
                startY = endY;
                endX = startX;
                endY = startY + paragraphWidet.height;
                if (topBorder.lineStyle !== 'None' && firstLine.isFirstLine() && !canRenderParagraphBorders.skipTopBorder) {
                ...
                lineWidth = editor_helper_1.HelperMethods.convertPointToPixel(rightBorder.lineWidth);
                this.renderSingleBorder(rightBorder.color, startX, startY, endX, endY, lineWidth, rightBorder.lineStyle);
            }
            if (!ej2_base_1.isNullOrUndefined(bottomBorder) && bottomBorder.lineStyle !== 'None' && lastLine.isLastLine() && !canRenderParagraphBorders.skipBottomBorder) {
                startX = this.documentHelper.getParagraphLeftPosition(paragraphWidet);
                endX = startX + this.getContainerWidth(paragraphWidet, page);
                startY = (paragraphWidet.y + paragraphWidet.height + editor_helper_1.HelperMethods.convertPointToPixel(bottomBorder.lineWidth + bottomBorder.space)) - (this.getBottomMargin(paragraphWidet));
                endY = startY;
                if (leftBorder.lineStyle !== 'None') {
                    startX -= editor_helper_1.HelperMethods.convertPointToPixel(leftBorder.space);
                }
                ...
                lineWidth = editor_helper_1.HelperMethods.convertPointToPixel(bottomBorder.lineWidth);
        ...
        Renderer.prototype.getContainerWidth = function (paraWidget, page) {
            ...
            if (paraWidget.isInsideTable) {
                ...
                if (this.viewer instanceof viewer_1.WebLayoutViewer) {
                    var indent = editor_helper_1.HelperMethods.convertPointToPixel(paraWidget.leftIndent + paraWidget.rightIndent);
                    ...
                    if (section instanceof page_1.BodyWidget && section.sectionFormat.columns.length > 1) {
                        var colIndex = section.columnIndex;
                        return section.sectionFormat.columns[colIndex].width + editor_helper_1.HelperMethods.convertPointToPixel(hangingIndent - (paraWidget.rightIndent + paraWidget.leftIndent));
                    }
                    else {
                        var width = section.sectionFormat.pageWidth - section.sectionFormat.leftMargin - section.sectionFormat.rightMargin;
                        return editor_helper_1.HelperMethods.convertPointToPixel(width + hangingIndent - (paraWidget.rightIndent + paraWidget.leftIndent));
                    }
                }
            }
        };
        Renderer.prototype.getTopMargin = function (paragraph) {
            if (paragraph.isEmpty()) {
                ...
                var topMargin = 0;
                if (!ej2_base_1.isNullOrUndefined(widget.margin)) {
            ...
            for (var i = 0; i < footnote.bodyWidgets.length; i++) {
                ...
                for (var j = 0; j < bodyWidget.childWidgets.length; j++) {
                    ...
                    if (i === 0 && j === 0) {
                        ...
                        if (page.bodyWidgets.length > 1 && !ej2_base_1.isNullOrUndefined(bodyWidget.nextWidget) && !(bodyWidget.nextWidget.sectionFormat.breakCode === 'NoBreak')) {
                    ...
                    if (j === 0 && !ej2_base_1.isNullOrUndefined(footNoteReference) && widget.childWidgets[0].children[0] instanceof page_1.TextElementBox && !this.documentHelper.owner.editor.isFootNoteInsert) {
        ...
        Renderer.prototype.renderTableWidget = function (page, tableWidget) {
            ...
            for (var i = 0; i < tableWidget.childWidgets.length; i++) {
                ...
                if (widget.isRenderBookmarkEnd && this.documentHelper.owner.documentEditorSettings.showBookmarks) {
                    ...
                    var border = cellWidget.ownerTable.isBidiTable ? page_1.TableCellWidget.getCellLeftBorder(cellWidget) : page_1.TableCellWidget.getCellRightBorder(cellWidget);
                    var lineWidth = editor_helper_1.HelperMethods.convertPointToPixel(border.getLineWidth());
        ...
        Renderer.prototype.renderTableCellWidget = function (page, cellWidget) {
            ...
            if (cellWidget.isRenderEditRangeStart) {
                ...
                if (this.documentHelper.owner.documentEditorSettings.highlightEditableRanges) {
                    ...
                    var widgetInfo = !ej2_base_1.isNullOrUndefined(highlighters) ? highlighters.get(firstLine) : [];
                    var color = !ej2_base_1.isNullOrUndefined(widgetInfo) && !ej2_base_1.isNullOrUndefined(widgetInfo[0]) ? widgetInfo[0].color : "ffff00";
            ...
            if (cellWidget.isRenderEditRangeEnd) {
                ...
                if (this.documentHelper.owner.documentEditorSettings.highlightEditableRanges) {
                    var highlighters = this.documentHelper.selection.editRegionHighlighters;
                    var widgetInfo = !ej2_base_1.isNullOrUndefined(highlighters) ? highlighters.get(lastLine) : [];
                    var color = !ej2_base_1.isNullOrUndefined(widgetInfo) && !ej2_base_1.isNullOrUndefined(widgetInfo[0]) ? widgetInfo[0].color : "ffff00";
        ...
        Renderer.prototype.checkHeaderFooterLineWidget = function (widget, keys) {
            ...
            if (!ej2_base_1.isNullOrUndefined(headerFooter.parentHeaderFooter)) {
                headerFooter = headerFooter.parentHeaderFooter;
                for (var j = 0; j < keys.length; j++) {
                    var selectedWidget = keys[j];
                    if (selectedWidget instanceof page_1.LineWidget && widget instanceof page_1.LineWidget) {
                    ...
                    else if (selectedWidget instanceof page_1.TableCellWidget && widget instanceof page_1.TableCellWidget) {
                        var parentIndex = selectedWidget.getHierarchicalIndex('');
                        var currentLineIndex = widget.getHierarchicalIndex('');
        ...
        Renderer.prototype.renderEditRegionHighlight = function (page, lineWidget, top) {
            if (page.documentHelper.selection && !ej2_base_1.isNullOrUndefined(page.documentHelper.selection.editRegionHighlighters)) {
        ...
        Renderer.prototype.renderSearchHighlight = function (page, lineWidget, top) {
            if (this.documentHelper.owner.searchModule && !ej2_base_1.isNullOrUndefined(page.documentHelper.owner.searchModule.searchHighlighters)) {
        ...
        Renderer.prototype.renderLine = function (lineWidget, page, left, top) {
            ...
            if (lineWidget.isFirstLine() && !paraFormat.bidi) {
                left += editor_helper_1.HelperMethods.convertPointToPixel(paraFormat.firstLineIndent);
            }
            if (this.documentHelper && this.documentHelper.selection && !ej2_base_1.isNullOrUndefined(this.documentHelper.selection.formFieldHighlighters)
                ...
                if (this.documentHelper.owner.documentEditorSettings
                    ...
                    for (var i = 0; i < widgetInfo.length; i++) {
                        ...
                        if (isLastLine) {
                            height_1 = height_1 - editor_helper_1.HelperMethods.convertPointToPixel(this.documentHelper.layout.getAfterSpacing(lineWidget.paragraph));
                            if (lineWidget.paragraph.paragraphFormat.lineSpacing > 1) {
                                ...
                                if (!ej2_base_1.isNullOrUndefined(formField)) {
                                    ...
                                    if (lineWidget.paragraph.paragraphFormat.lineSpacingType === 'Multiple') {
                                        height_1 = height_1 - editor_helper_1.HelperMethods.convertPointToPixel(this.documentHelper.layout.getLineSpacing(lineWidget.paragraph, maxHeight, true));
                                    }
                                    else {
                                        top = top + editor_helper_1.HelperMethods.convertPointToPixel(lineWidget.paragraph.paragraphFormat.beforeSpacing);
            ...
            var bookmarks = [];
            if (!ej2_base_1.isNullOrUndefined(lineWidget.paragraph.associatedCell) && lineWidget.paragraph.associatedCell.isRenderBookmarkStart) {
            ...
            for (var i = 0; i < children.length; i++) {
                ...
                if (elementBox instanceof page_1.CommentCharacterElementBox || elementBox instanceof page_1.EditRangeStartElementBox) {
                    var pageGap = 0;
                    if (this.viewer instanceof viewer_1.PageLayoutViewer) {
                    ...
                    if (elementBox instanceof page_1.EditRangeStartElementBox && (this.documentHelper.owner.currentUser === elementBox.user || (elementBox.group === "Everyone" && elementBox.user === ""))) {
                        if (this.documentHelper.owner.documentEditorSettings.highlightEditableRanges && elementBox.columnFirst == -1) {
                            ...
                            var yTop = top;
                            var highlighters = this.documentHelper.selection.editRegionHighlighters;
                            var widgetInfo = !ej2_base_1.isNullOrUndefined(highlighters) ? highlighters.get(lineWidget) : [];
                            var color = !ej2_base_1.isNullOrUndefined(widgetInfo) && !ej2_base_1.isNullOrUndefined(widgetInfo[0]) ? widgetInfo[0].color : "ffff00";
                        ...
                        if (this.documentHelper.owner.enableLockAndEdit) {
                            ...
                            style += "color:" + color + ";";
                            var leftMargin = editor_helper_1.HelperMethods.convertPointToPixel(page.bodyWidgets[0].sectionFormat.leftMargin);
                    ...
                    else if (elementBox instanceof page_1.CommentCharacterElementBox &&
                        elementBox.commentType === 0 && this.documentHelper.owner.selectionModule) {
                        if (this.documentHelper.owner.enableComment) {
                            var rightMargin = editor_helper_1.HelperMethods.convertPointToPixel(page.bodyWidgets[0].sectionFormat.rightMargin);
                            var pageWidth = editor_helper_1.HelperMethods.convertPointToPixel(page.bodyWidgets[0].sectionFormat.pageWidth);
                            ...
                            style = style + 'left:' + leftPosition + 'top:' + topPosition;
                            if (commentIDList.indexOf(elementBox.commentId) === -1 && !ej2_base_1.isNullOrUndefined(elementBox.comment) && !elementBox.comment.isReply) {
                ...
                if (elementBox instanceof page_1.EditRangeEndElementBox && (this.documentHelper.owner.currentUser === elementBox.editRangeStart.user || (elementBox.editRangeStart.group === "Everyone" && elementBox.editRangeStart.user === ""))) {
                ...
                if (elementBox instanceof page_1.BookmarkElementBox && this.documentHelper.owner.documentEditorSettings.showBookmarks && this.documentHelper.getBookmarks().indexOf(elementBox.name) !== -1) {
                    var height = elementBox.line.height - elementBox.line.margin.bottom;
                    var xLeft = left;
                    var yTop = top;
                    if (elementBox.bookmarkType == 1) {
                        if (this.isBookmarkEndAtStart(elementBox) && ej2_base_1.isNullOrUndefined(elementBox.properties)) {
                            var previousParaElement = elementBox.paragraph;
                            var prevRenderableElement = void 0;
                            var isRenderablePresent = false;
                            while (!isRenderablePresent && !ej2_base_1.isNullOrUndefined(previousParaElement)) {
                            ...
                            if (!ej2_base_1.isNullOrUndefined(prevRenderableElement)) {
                        ...
                        if (!ej2_base_1.isNullOrUndefined(elementBox.properties)) {
                    ...
                    if (elementBox.bookmarkType == 1) {
                        if (!ej2_base_1.isNullOrUndefined(elementBox.reference)) {
                            if (ej2_base_1.isNullOrUndefined(elementBox.reference.properties)) {
                                ...
                                if (ej2_base_1.isNullOrUndefined(bookmarkEndCell)) {
                                    bookmarks.push({ x: xLeft, y: yTop, height: height, type: elementBox.bookmarkType });
                                }
                            }
                        }
                ...
                if (elementBox instanceof page_1.FieldElementBox || this.isFieldCode ||
                ...
                if (elementBox instanceof page_1.ListTextElementBox) {
                    this.renderListTextElementBox(elementBox, left, top, underlineY);
                }
                else if (elementBox instanceof page_1.ImageElementBox) {
                    left += elementBox.padding.left;
                    this.renderImageElementBox(elementBox, left, top, underlineY);
                }
                else if (elementBox instanceof page_1.ShapeElementBox) {
            ...
            if (this.documentHelper.owner.documentEditorSettings.showHiddenMarks && !this.isPrinting) {
                ...
                var l10n = new ej2_base_1.L10n('documenteditor', this.documentHelper.owner.defaultLocale);
                l10n.setLocale(this.documentHelper.owner.locale);
                this.pageContext.fillStyle = editor_helper_1.HelperMethods.getColor(currentCharFormat.fontColor);
                if ((children.length == 0 && !lineWidget.isEndsWithLineBreak && !ej2_base_1.isNullOrUndefined(lineWidget.paragraph)) || (lineWidget.paragraph.childWidgets.length === 1)) {
                ...
                if (currentCharFormat.revisions.length > 0) {
                    ...
                    this.pageContext.fillStyle = editor_helper_1.HelperMethods.getColor(color);
                }
                if (lineWidget.isEndsWithColumnBreak) {
                    ...
                    var textinfo = this.documentHelper.textHelper.getWidth(text, currentCharFormat, index_2.FontScriptType.English);
                    if (this.viewer instanceof viewer_1.PageLayoutViewer) {
                        if (lineWidget.paragraph.bidi) {
                ...
                else if (lineWidget.paragraph.isInsideTable && ej2_base_1.isNullOrUndefined(lineWidget.nextLine) && ej2_base_1.isNullOrUndefined(lineWidget.paragraph.nextWidget)) {
                    if (lineWidget.height != 0) {
                        text = String.fromCharCode(164);
                    }
                }
                else if (ej2_base_1.isNullOrUndefined(lineWidget.nextLine)) {
                    text = String.fromCharCode(182);
                }
                if (lineWidget.paragraph.containerWidget instanceof page_1.BodyWidget && !ej2_base_1.isNullOrUndefined(lineWidget.paragraph.nextRenderedWidget)) {
                ...
                if (text.length > 0) {
                    if (lineWidget.paragraph.bidi && !lineWidget.paragraph.isEmpty()) {
                        x -= this.documentHelper.textHelper.getWidth(text, currentCharFormat, index_2.FontScriptType.English);
                    }
        ...
        Renderer.prototype.isRenderable = function (element) {
            if (!(element instanceof page_1.BookmarkElementBox || element instanceof page_1.EditRangeStartElementBox || element instanceof page_1.EditRangeEndElementBox)) {
                return true;
            }
            return false;
        };
        ...
        Renderer.prototype.renderBookmark = function (x, y, height, type, restrictColor) {
            ...
            this.pageContext.stroke();
            this.pageContext.closePath();
            if (!ej2_base_1.isNullOrUndefined(restrictColor)) {
        ...
        Renderer.prototype.retriveCharacterformat = function (character, fontSizeFactor) {
            if (ej2_base_1.isNullOrUndefined(fontSizeFactor)) {
                fontSizeFactor = 1;
            }
            var font = '';
        ...
        Renderer.prototype.getUnderlineYPosition = function (lineWidget) {
            ...
            for (var i = 0; i < lineWidget.children.length; i++) {
                if (lineWidget.children[i] instanceof page_1.FieldElementBox ||
                    (lineWidget.children[i].width === 0 && lineWidget.children[i].height === 0)) {
                    continue;
                }
                if (lineWidget.children[i] instanceof page_1.ShapeElementBox) {
                    continue;
                }
                else {
                    if (height < lineWidget.children[i].height + lineWidget.children[i].margin.top) {
                        ...
                        lineHeight = (lineWidget.children[i] instanceof page_1.ImageElementBox) ? 0.9 : lineWidget.children[i].height / 20;
                    }
                }
            }
        ...
        Renderer.prototype.renderListTextElementBox = function (elementBox, left, top, underlineY) {
            ...
            if (highlightColor !== 'NoColor') {
                if (highlightColor.substring(0, 1) !== '#') {
                    this.pageContext.fillStyle = editor_helper_1.HelperMethods.getHighlightColorCode(highlightColor);
                }
                else {
                    this.pageContext.fillStyle = editor_helper_1.HelperMethods.getColor(highlightColor);
                }
            ...
            if (this.documentHelper.owner.documentEditorSettings.showHiddenMarks && !this.isPrinting) {
                if (elementBox instanceof page_1.ListTextElementBox && elementBox.text === "\t") {
            ...
            if (format.underline !== 'None' && !ej2_base_1.isNullOrUndefined(format.underline)) {
        ...
        Renderer.prototype.getDefaultFontColor = function (backColor) {
            if (editor_helper_1.HelperMethods.isVeryDark(backColor)) {
                return "#FFFFFF";
            }
            else {
                return "#000000";
        ...
        Renderer.prototype.renderTextElementBox = function (elementBox, left, top, underlineY) {
            ...
            if (containerWidget instanceof page_1.TableCellWidget) {
                isHeightType = (containerWidget.ownerRow.rowFormat.heightType === 'Exactly');
            }
            var topMargin = elementBox.margin.top;
            var leftMargin = elementBox.margin.left;
            if (isHeightType && containerWidget instanceof page_1.TableCellWidget) {
            ...
            if (format.highlightColor != "NoColor" && elementBox.text.trim() == "") {
                ...
                if (!ej2_base_1.isNullOrUndefined(firstLine) && firstLine instanceof page_1.LineWidget
                    && firstLine.children.length > 0 && elementBox === firstLine.children[0]) {
                    doHighLight = false;
                }
                if (!ej2_base_1.isNullOrUndefined(lastLine) && lastLine instanceof page_1.LineWidget
            ...
            if (format.highlightColor !== 'NoColor' && doHighLight) {
                if (format.highlightColor.substring(0, 1) !== '#') {
                    this.pageContext.fillStyle = editor_helper_1.HelperMethods.getHighlightColorCode(format.highlightColor);
                }
                else {
                    this.pageContext.fillStyle = editor_helper_1.HelperMethods.getColor(format.highlightColor);
                }
                this.pageContext.fillRect(Math.floor(this.getScaledValue(left + leftMargin, 1)), Math.floor(this.getScaledValue(top + topMargin, 2) - 1), Math.ceil(this.getScaledValue(elementBox.width) + 1), Math.ceil(this.getScaledValue(elementBox.height) + 1));
            }
            ...
            var text = elementBox.text;
            if (elementBox instanceof page_1.TabElementBox) {
                var tabElement = elementBox;
                if (tabElement.tabText === '' && !ej2_base_1.isNullOrUndefined(tabElement.tabLeader) && tabElement.tabLeader !== 'None') {
            ...
            if (((characterRange == index_1.CharacterRangeType.WordSplit) ||
                (((characterRange & index_1.CharacterRangeType.WordSplit) == index_1.CharacterRangeType.WordSplit) &&
                    ((characterRange & index_1.CharacterRangeType.RightToLeft) == index_1.CharacterRangeType.RightToLeft))) && format.bidi) {
                text = this.inverseCharacter(text);
            }
            var scaleFactor = format.scaling < 100 ? 1 : format.scaling / 100;
            if (this.documentHelper.owner.documentEditorSettings.showHiddenMarks && !this.isPrinting) {
                if ((elementBox instanceof page_1.TabElementBox || elementBox instanceof page_1.TextElementBox) && elementBox.text === "\t") {
                    this.tabMark(elementBox, format, left, top, leftMargin, topMargin);
                }
                if (text === '\r') {
                    text = String.fromCharCode(182);
            ...
            if (this.documentHelper.owner.isSpellCheck) {
                if (((this.documentHelper.owner.isSpellCheck && !this.spellChecker.removeUnderline) && (this.documentHelper.triggerSpellCheck || elementBox.canTrigger) && elementBox.text !== ' ' && !this.documentHelper.isScrollHandler && (ej2_base_1.isNullOrUndefined(elementBox.previousNode) || !(elementBox.previousNode instanceof page_1.FieldElementBox))
                    ...
                    if (errorDetails.errorFound && !this.isPrinting) {
                        color = '#FF0000';
                        var backgroundColor = (containerWidget instanceof page_1.TableCellWidget) ? containerWidget.cellFormat.shading.backgroundColor : this.documentHelper.backgroundColor;
                        for (var i = 0; i < errorDetails.elements.length; i++) {
                            ...
                            if (elementBox.ignoreOnceItems.indexOf(this.spellChecker.manageSpecialCharacters(currentElement.text, undefined, true)) === -1) {
                                if (isRTL) {
                                    this.renderWavyLine(currentElement, (ej2_base_1.isNullOrUndefined(currentElement.end)) ? left : currentElement.end.location.x, top, underlineY, color, 'Single', format.baselineAlignment, backgroundColor);
                                }
                                else {
                                    this.renderWavyLine(currentElement, (ej2_base_1.isNullOrUndefined(currentElement.start)) ? left : currentElement.start.location.x, top, underlineY, color, 'Single', format.baselineAlignment, backgroundColor);
                                }
                            }
                        }
                    }
            ...
            if (format.underline !== 'None' && !ej2_base_1.isNullOrUndefined(format.underline) || (!ej2_base_1.isNullOrUndefined(currentInfo) && (currentInfo.type === 'Insertion' || currentInfo.type === 'MoveTo'))) {
            ...
            if (format.strikethrough !== 'None' && !ej2_base_1.isNullOrUndefined(format.strikethrough) || (!ej2_base_1.isNullOrUndefined(currentInfo) && (currentInfo.type === 'Deletion' || currentInfo.type === 'MoveFrom'))) {
        ...
        Renderer.prototype.getBackgroundColorHeirachy = function (element) {
            ...
            else if (element.paragraph.containerWidget instanceof page_1.TextFrame
                && !ej2_base_1.isNullOrUndefined(element.paragraph.containerWidget.containerShape) && !ej2_base_1.isNullOrUndefined(element.paragraph.containerWidget.containerShape.fillFormat) && element.paragraph.containerWidget.containerShape.fillFormat.color === '#000000FF') {
        ...
        Renderer.prototype.renderWavyLine = function (elementBox, left, top, underlineY, color, underline, baselineAlignment, backgroundColor) {
            ...
            if (elementBox.text.length > 1) {
                ...
                var stepToCover = .7;
                var y = 0;
                if (baselineAlignment === 'Subscript' || elementBox instanceof page_1.ListTextElementBox) {
                ...
                var startingPoint = new editor_helper_1.Point(x1, y1);
                var endingPoint = new editor_helper_1.Point(x2, y1);
        ...
        Renderer.prototype.drawWavy = function (from, to, frequency, amplitude, step, color, height, backColor, negative) {
            this.pageContext.save();
            this.pageContext.fillStyle = (!ej2_base_1.isNullOrUndefined(backColor) ? backColor : this.documentHelper.backgroundColor);
        ...
        Renderer.prototype.getTrimmedWidth = function (elementBox) {
            ...
            if (elementBox instanceof page_1.TextElementBox && !(elementBox instanceof page_1.TabElementBox) && ej2_base_1.isNullOrUndefined(elementBox.nextNode)) {
                width = this.documentHelper.textHelper.getWidth(editor_helper_1.HelperMethods.trimEnd(elementBox.text), elementBox.characterFormat, elementBox.scriptType);
            }
            return width;
        };
        Renderer.prototype.renderUnderline = function (elementBox, left, top, underlineY, color, underline, baselineAlignment, revisionInfo) {
            ...
            var lineCount = 0;
            if (!ej2_base_1.isNullOrUndefined(revisionInfo)) {
        ...
        Renderer.prototype.renderImageElementBox = function (elementBox, left, top, underlineY) {
            ...
            var isHeightType = false;
            if (containerWid instanceof page_1.TableCellWidget) {
            ...
            if (elementBox.textWrappingStyle === 'Inline') {
                if (topMargin < 0 || elementBox.line.paragraph.width < elementBox.width) {
                    if (containerWid instanceof page_1.TableCellWidget) {
                        var leftIndent = 0;
                        if (containerWid.childWidgets[0] instanceof page_1.ParagraphWidget) {
            ...
            if (elementBox.isMetaFile && !ej2_base_1.isNullOrUndefined(elementBox.metaFileImageString)) {
                ...
                try {
                    ...
                    elementBox.element.onload = function () {
                        ...
                        if (!ej2_base_1.isNullOrUndefined(render_1.documentHelper) && lastLoaded !== elementBox.element.src) {
                    ...
                    if (!elementBox.isCrop) {
                        this.pageContext.drawImage(elementBox.element, imgX_1, imgY_1, width_3, height_2);
                    }
                    else {
                        this.pageContext.drawImage(elementBox.element, elementBox.cropX, elementBox.cropY, elementBox.cropWidth, elementBox.cropHeight, imgX_1, imgY_1, width_3, height_2);
                    }
                }
                catch (e) {
            ...
            if (!ej2_base_1.isNullOrUndefined(currentRevision) && (currentRevision.type === 'Deletion' || currentRevision.type === 'MoveFrom')) {
            ...
            if (!ej2_base_1.isNullOrUndefined(currentRevision) && (currentRevision.type === 'Insertion' || currentRevision.type === 'MoveTo')) {
        ...
        Renderer.prototype.renderTableOutline = function (tableWidget) {
            var layout = new layout_1.Layout(this.documentHelper);
            ...
            var lineWidth = 0;
            lineWidth = editor_helper_1.HelperMethods.convertPointToPixel(border.getLineWidth());
        ...
        Renderer.prototype.renderTableCellOutline = function (documentHelper, cellWidget) {
            ...
            if (!ej2_base_1.isNullOrUndefined(tableCell.ownerRow) && tableCell.ownerRow.rowFormat.heightType === 'Exactly') {
                height = editor_helper_1.HelperMethods.convertPointToPixel(tableCell.ownerRow.rowFormat.height) + cellTopMargin + cellBottomMargin;
            }
            else {
                if (!ej2_base_1.isNullOrUndefined(tableCell.ownerRow) && [tableCell.ownerRow].length <= 1) {
                    height = Math.max(editor_helper_1.HelperMethods.convertPointToPixel(tableCell.ownerRow.rowFormat.height), cellWidget.height) + cellTopMargin + cellBottomMargin;
                }
                else {
                    height = cellWidget.height + cellTopMargin + cellBottomMargin;
                }
            }
            var border = !isBidiTable ? page_1.TableCellWidget.getCellLeftBorder(tableCell) : page_1.TableCellWidget.getCellRightBorder(tableCell);
            var lineWidth = 0;
            lineWidth = editor_helper_1.HelperMethods.convertPointToPixel(border.getLineWidth());
            ...
            if (tableCell.index === 0 || tableCell.cellFormat.rowSpan === 1 || (tableCell.cellFormat.rowSpan > 1 && tableCell.columnIndex === 0)) {
                ...
                for (var i = 0; i < tableCell.ownerTable.childWidgets.length; i++) {
                    ...
                    if (cell && cell.columnIndex + cell.cellFormat.columnSpan - 1 === tableCell.columnIndex - 1) {
                        var border_1 = !isBidiTable ? page_1.TableCellWidget.getCellRightBorder(cell) : page_1.TableCellWidget.getCellLeftBorder(cell);
                        var lineWidthInt = editor_helper_1.HelperMethods.convertPointToPixel(border_1.getLineWidth());
            ...
            if (tableCell.updatedTopBorders && tableCell.updatedTopBorders.length > 1) {
                ...
                for (var a = 0; a < tableCell.updatedTopBorders.length; a++) {
                    ...
                    if (border.lineStyle !== 'None' && border.lineWidth < page_1.TableCellWidget.getCellTopBorder(tableCell).lineWidth) {
                        border.lineWidth = page_1.TableCellWidget.getCellTopBorder(tableCell).lineWidth;
                    }
                ...
                border = page_1.TableCellWidget.getCellTopBorder(tableCell);
                lineWidth = editor_helper_1.HelperMethods.convertPointToPixel(border.getLineWidth());
                var width = 0;
            ...
            if ((tableCell.ownerTable.tableFormat.cellSpacing > 0 || isLastCell) && (isBidiTable || tableCell.columnIndex + tableCell.cellFormat.columnSpan === tableCell.ownerTable.tableHolder.columns.length || !isAffectedByRowSpan)) {
                border = isBidiTable ? page_1.TableCellWidget.getCellLeftBorder(tableCell) : page_1.TableCellWidget.getCellRightBorder(tableCell);
                lineWidth = editor_helper_1.HelperMethods.convertPointToPixel(border.getLineWidth());
            ...
            if (!ej2_base_1.isNullOrUndefined(nextRow)) {
                ...
                if (nextRowWidget instanceof page_1.TableRowWidget) {
                    if (cellWidget.containerWidget instanceof page_1.TableRowWidget && cellWidget.containerWidget.containerWidget instanceof page_1.TableWidget) {
            ...
            if (tableCell.ownerTable.tableFormat.cellSpacing > 0 || tableCell.ownerRow.rowIndex === tableCell.ownerTable.childWidgets.length - 1
                ...
                if (!ej2_base_1.isNullOrUndefined(bottomBorder) && bottomBorder.lineStyle === 'Cleared') {
                    border = page_1.TableCellWidget.getCellBottomBorder(tableCell);
                }
                else {
                    border = (tableCell.cellFormat.rowSpan > 1 && tableCell.ownerRow.rowIndex + tableCell.cellFormat.rowSpan === tableCell.ownerTable.childWidgets.length) ?
                        ...
                        : page_1.TableCellWidget.getCellBottomBorder(tableCell);
                }
                lineWidth = editor_helper_1.HelperMethods.convertPointToPixel(border.getLineWidth());
        ...
        Renderer.prototype.renderCellBackground = function (height, cellWidget, leftMargin, rightMargin, lineWidth) {
            ...
            this.pageContext.beginPath();
            if (bgColor !== 'empty') {
                this.pageContext.fillStyle = editor_helper_1.HelperMethods.getColor(bgColor);
            ...
            if (cellFormat.shading.hasValue('foregroundColor') && cellFormat.shading.textureStyle !== 'TextureNone') {
                this.pageContext.beginPath();
                this.pageContext.fillStyle = this.drawTextureStyle(cellFormat.shading.textureStyle, editor_helper_1.HelperMethods.getColor(cellFormat.shading.foregroundColor), editor_helper_1.HelperMethods.getColor(cellFormat.shading.backgroundColor), cellFormat.shading.foregroundColor === 'empty', cellFormat.shading.backgroundColor === 'empty');
                this.pageContext.fillRect(this.getScaledValue(left, 1), this.getScaledValue(top, 2), this.getScaledValue(width), this.getScaledValue(height));
                this.pageContext.closePath();
            }
        };
        ...
        Renderer.prototype.getForeColor = function (foreColor, backColor, percent, isForeColorEmpty, isBackColorEmpty) {
            ...
            var g = 0;
            var b = 0;
            var foreColorRgb = editor_helper_1.HelperMethods.convertHexToRgb(foreColor);
            var backColorRgb = editor_helper_1.HelperMethods.convertHexToRgb(backColor);
            ...
            return ('#' + editor_helper_1.HelperMethods.convertRgbToHex(r) + editor_helper_1.HelperMethods.convertRgbToHex(g) + editor_helper_1.HelperMethods.convertRgbToHex(b));
        };
        ...
        Renderer.prototype.renderSingleBorder = function (color, startX, startY, endX, endY, lineWidth, lineStyle) {
            ...
            this.pageContext.strokeStyle = editor_helper_1.HelperMethods.getColor(color);
        ...
        Renderer.prototype.getRevisionType = function (revisionInfo, checkInsert) {
            ...
            for (var i = 0; i < revisionInfo.length; i++) {
                ...
                if (checkInsert && (revisionInfo[i].type === 'Insertion' || revisionInfo[i].type === 'MoveTo')) {
                    type = revisionInfo[i];
                    this.pageContext.fillStyle = editor_helper_1.HelperMethods.getColor(type.color);
        ...
        Renderer.prototype.getFormfieldInLine = function (line) {
            for (var i = 0; i < line.children.length; i++) {
                if (line.children[i] instanceof page_1.FieldElementBox && !ej2_base_1.isNullOrUndefined(line.children[i].formFieldData)) {
